namespace AWS
{
    ...
    public class Main
    {
        string marketplaceId, merchantId, CompanyId, accessKeyId, secretAccessKey, inboxPath, outboxPath, OrignalInName, InName, OutName, lcXMLFileName, Aria4Con, AriaDbfs;
        ...
        public void ReadSettings()
        {
            if (File.Exists(lcXMLFileName))
            {
                ...
                AriaDbfs = xmldoc.SelectSingleNode(@"//*/row[Name='lcRpDataD']")["Value"].InnerText.Trim();
