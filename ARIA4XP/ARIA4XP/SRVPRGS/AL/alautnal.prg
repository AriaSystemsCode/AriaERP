...
*:E302558,1 MMT 10/21/2008 CONVERT PROGRAM to work from request handler[T20080413.0001]
...
*PARAMETERS lcRequestID, loxmlfilterfilepointer
PARAMETERS lcRequestID, loxmlfilterfilepointer, ClientID
...
goxmlallocatefilepointer = .T.
goxmlpickticketfilepointer = .T.

*PRIVATE oAriaEnvironment
*oAriaEnvironment = CREATEOBJECT("ariamain.AriaEnvironment", loAgent.GetRequest(lcrequestid, ClientID).Context.CompanyName)

*MMT
*oAriaEnvironment.User_ID =OAriaapplication.User_ID
oAriaEnvironment.User_ID = loAgent.GetRequest(lcRequestID, ClientID).Context.UserName
*MMT
...
*lcExpr = gfOpGrid('ALAUTNAL',.T.,.F.,.F.,.T.,.T.)
...
IF ISNULL(goxmlallocatefilepointer) = .F. && .gfModalGen("TRM44007B00006","DIALOG") = 1
  ...
  *IF This is not an incompleted session
  ...
  lnPrepRec = 0
  && Varible to hold the current count to be done for the thermometer
  loProgress.Percent     = 0
  loProgress.DESCRIPTION = 'Preparing data files'
  *T20100512.0026 Hassan 2010 05 23 [BEGIN]
  ...
  *SCAN Loop to scan the temp. Order lines file
  SCAN
    ...
    *loProgress.Percent = (lnPrepRec/lnRecCount)
    *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
  ...
  *loProgress.Description = 'Releasing...Order/Style : '
  IF TYPE('loFormSet_oPross') = 'O'
  ...
  SCAN FOR lnSel = 1 .AND. TOTPIK > 0 .AND. nProcNo < 14
    ...
    loProgress.DESCRIPTION = ORDER + '/' + lcRelStyle
    IF MOD(lnCurent,CEILING(lnRecCount/10)) = 0
      loProgress.Percent = IIF((lnCurent/lnRecCount)>1,1,(lnCurent/lnRecCount))
      *T20100512.0026 Hassan 2010 05 23 [BEGIN]
      *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
      loAgent.UpdateObjectProgress(lcRequestID, loProgress, ClientID)
      *T20100512.0026 Hassan 2010 05 23 [END]
...
IF lnParm <> 3
  ...
  *SCAN Loop to scan the temp. Order lines file
  SCAN
    lnPrepRec = lnPrepRec + 1
    REPLACE nProcNo WITH 0
    IF MOD(lnPrepRec,CEILING(lnRecCount/10)) = 0
      loProgress.Percent = IIF((lnPrepRec/lnRecCount)>1,1,(lnPrepRec/lnRecCount))
      loProgress.DESCRIPTION = 'Preparing data files'
      *T20100512.0026 Hassan 2010 05 23 [BEGIN]
      *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
      loAgent.UpdateObjectProgress(lcRequestID, loProgress, ClientID)
...
CASE loFormSet_lcrpscpmod = " "
  ...
  *osa
  loProgress.Percent     = 0
  loProgress.DESCRIPTION = IIF(loFormSet_llexclude,LANG_AutoAlloc_ExcludingOrder,LANG_AutoAlloc_SelectingOrder)
  *T20100512.0026 Hassan 2010 05 23 [BEGIN]
  *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
  loAgent.UpdateObjectProgress(lcRequestID, loProgress, ClientID)
  *T20100512.0026 Hassan 2010 05 23 [END]
  ...
  SCAN FOR &lcForCond2
    IF loFormSet_llexclude
      ...
      loProgress.DESCRIPTION = 'Excluding order '
      IF MOD(lnProssCurt,CEILING(lnTotRec/10)) = 0
        loProgress.Percent = IIF((lnProssCurt/lnTotRec)>1,1,(lnProssCurt/lnTotRec))
        *T20100512.0026 Hassan 2010 05 23 [BEGIN]
        *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
        loAgent.UpdateObjectProgress(lcRequestID, loProgress, ClientID)
        *T20100512.0026 Hassan 2010 05 23 [END]
    ...
    ELSE  && Scope mode
      ...
      loProgress.DESCRIPTION = 'Selecting order '
      IF MOD(lnProssCurt,CEILING(lnTotRec/10)) = 0
        loProgress.Percent = IIF((lnProssCurt/lnTotRec)> 1 ,1,(lnProssCurt/lnTotRec))
        *T20100512.0026 Hassan 2010 05 23 [BEGIN]
        *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
...
SCAN
  ...
  *loProgress.Percent = (lnPrepRec/lnRecCount) * 0.9
  *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
...
*loProgress.Description = 'Assigning piktkt number for...Order/Style : '
IF TYPE('loFormSet_oPross') = 'O'
...
loProgress.Percent     = 0
loProgress.DESCRIPTION = LANG_AutoAlloc_LableAssign
*T20100512.0026 Hassan 2010 05 23 [BEGIN]
*loAgent.UpdateObjectProgress(lcRequestID, loProgress)
loAgent.UpdateObjectProgress(lcRequestID, loProgress, ClientID)
*T20100512.0026 Hassan 2010 05 23 [END]
...
SCAN FOR lnSel = 1 .AND. TOTPIK > 0 .AND. nProcNo < 4
  ...
  *IF the first step for this record
  ...
  loProgress.DESCRIPTION = ORDER + '/' + STYLE
  IF MOD(lnCurent,CEILING(lnTotRec/10)) = 0
    loProgress.Percent = IIF((lnCurent/lnTotRec) >1,1,(lnCurent/lnTotRec) )
    *T20100512.0026 Hassan 2010 05 23 [BEGIN]
    *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
    loAgent.UpdateObjectProgress(lcRequestID, loProgress, ClientID)
    *T20100512.0026 Hassan 2010 05 23 [END]
...
*loProgress.Description = IIF(loFormSet_llExclude,'Excluding order ','Selecting order ')
IF TYPE('loFormSet_oPross') = 'O'
  loFormSet_oPross.lblFirstLabel.CAPTION = IIF(loFormSet_llexclude,LANG_AutoAlloc_ExcludingOrder,LANG_AutoAlloc_SelectingOrder)
  loFormSet_oPross.TotalProgress = lnTotRec
  *HBG 1/24/2005 Modify code to apply the new interface [Begin]
...
SCAN REST WHILE STYLE+DTOS(COMPLETE)+cordtype+ORDER+STORE+STR(LINENO,6) = STYLE.STYLE ;
  ...
  IF loFormSet_llexclude
    ...
    loProgress.DESCRIPTION = 'Excluding Style '+ STYLE
    IF MOD(lnProssCurt,CEILING(lnTotRec/10)) = 0
      loProgress.Percent = IIF((lnProssCurt/lnTotRec)>1,1,(lnProssCurt/lnTotRec))
      *T20100512.0026 Hassan 2010 05 23 [BEGIN]
      *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
  ...
  ELSE  && Scope mode
    ...
    loProgress.DESCRIPTION = 'Selecting Style '+ STYLE
    IF MOD(lnProssCurt,CEILING(lnTotRec/10)) = 0
      loProgress.Percent = IIF((lnProssCurt/lnTotRec)> 1,1,(lnProssCurt/lnTotRec))
      *T20100512.0026 Hassan 2010 05 23 [BEGIN]
      *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
...
loProgress.Percent     = 0
loProgress.DESCRIPTION = IIF(loFormSet_llexclude,LANG_AutoAlloc_Excluding + lcWaitStr ,LANG_AutoAlloc_Selecting + lcWaitStr)
*T20100512.0026 Hassan 2010 05 23 [BEGIN]
*loAgent.UpdateObjectProgress(lcRequestID, loProgress)
loAgent.UpdateObjectProgress(lcRequestID, loProgress, ClientID)
*T20100512.0026 Hassan 2010 05 23 [END]
...
*loProgress.Description =  IIF(loFormSet_llExclude,'Excluding order '+ lcWaitStr ,'Selecting '+ lcWaitStr)
    ...
    *criteria filter expression
    SCAN REST WHILE cordtype+ORDER+STR(LINENO,6) = "O"+ORDHDR.ORDER ;
      ...
      IF loFormSet_llexclude
        ...
        *loFormSet_oPross.CurrentProgress(lnProssCurt )
        *osa
        loProgress.DESCRIPTION =   'Excluding order '+ lcWaitStr + &lcWaitStr
        IF MOD(lnProssCurt ,CEILING(lnTotRec/10)) = 0
          loProgress.Percent = IIF((lnProssCurt /lnTotRec)>1,1,(lnProssCurt /lnTotRec))
          loAgent.UpdateObjectProgress(lcRequestID, loProgress)
        ENDIF
      ...
      ELSE  && Scope mode
        ...
        loProgress.DESCRIPTION =   'Selecting '+ lcWaitStr + &lcWaitStr
        IF MOD(lnProssCurt ,CEILING(lnTotRec/10)) = 0
          loProgress.Percent = IIF((lnProssCurt /lnTotRec) >1,1, (lnProssCurt /lnTotRec) )
          *T20100512.0026 Hassan 2010 05 23 [BEGIN]
          *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
...
loProgress.Percent     = 0
loProgress.DESCRIPTION = lcWaitMsg + LANG_AutoAlloc_WaitMsgPO
*T20100512.0026 Hassan 2010 05 23 [BEGIN]
*loAgent.UpdateObjectProgress(lcRequestID, loProgress)
loAgent.UpdateObjectProgress(lcRequestID, loProgress, ClientID)
*T20100512.0026 Hassan 2010 05 23 [END]
...
SCAN &lcScanExpr FOR &lcForCond1
  ...
  loProgress.DESCRIPTION =   lcWaitMsg +' purchase order '
  IF MOD(lnProssCurt ,CEILING(lnTotRec/10)) = 0
    loProgress.Percent = IIF((lnProssCurt /lnTotRec)>1,1,(lnProssCurt /lnTotRec))
    *T20100512.0026 Hassan 2010 05 23 [BEGIN]
    *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
...
loProgress.Percent     = 0
loProgress.DESCRIPTION = lcWaitMsg + LANG_AutoAlloc_WaitMsgCT
*T20100512.0026 Hassan 2010 05 23 [BEGIN]
*loAgent.UpdateObjectProgress(lcRequestID, loProgress)
loAgent.UpdateObjectProgress(lcRequestID, loProgress, ClientID)
*T20100512.0026 Hassan 2010 05 23 [END]
...
*osa
loProgress.DESCRIPTION = LANG_AutoAlloc_ProgrsOrdNum + ORDER
IF MOD(lnCurent,CEILING(lnTotRec/10)) = 0
  loProgress.Percent = IIF((lnCurent/lnTotRec)>1,1,(lnCurent/lnTotRec))
  *T20100512.0026 Hassan 2010 05 23 [BEGIN]
  *loAgent.UpdateObjectProgress(lcRequestID, loProgress)
