...
ELSE  
  lfSetColumnsProp('4','cTrnStat= "A"','Approved',70)
ENDIF 
...
WITH loFormSet.Ariaform1
  ...
  IF loFormSet.llDumyPost
    .pbApprov.Caption = IIF(glTrnsHd.nTrnIndic = 0,'Inclu\<de','\<Exclude')
  ELSE
    .pbApprov.Caption = IIF(glTrnsHd.cTrnStat = 'A','\<Disapprove','\<Approve')
  ENDIF
