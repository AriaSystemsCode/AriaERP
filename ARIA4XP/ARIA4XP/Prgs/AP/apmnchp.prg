...
*! E303342,1 HES 01/05/2012 Disable the OG while working except from the scope button [T20121123.0002]
...
WITH loFormSet.Ariaform1.grdAPINVHDR
  ...
  *=lfAddColumn(@lnI,oGrid,'lfGetPayMeth(Thisformset)',LANG_APMNCHP_Pay_Meth   )  &&"  Pay.  Meth  "  
  =lfAddColumn(@lnI,oGrid,'Thisformset.lfGetPAYPayMeth()',LANG_APMNCHP_Pay_Meth   )  &&"  Pay.  Meth  "
