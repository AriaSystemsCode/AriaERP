...
IF (loFld.Value <> loFld.OldValue OR EMPTY(loFld.Value)) AND ;
  ...
  gfModalGen("TRM04028B00000","DIALOG",LANG_APRCRIN_lcTFirstInv+'|'+LANG_APRCRIN_lcTLastInv) > 0) .OR. ;
...
IF (loFld.Value <> loFld.OldValue .OR. EMPTY(loFld.Value)) .AND. ;
   ...
   gfModalGen("TRM04028B00000","DIALOG",lcTDate+'|'+LANG_APRCRIN_lcTFirstInv) > 0) .OR.;
  (loNext.Value > loLast.Value .AND.;
   gfModalGen("TRM04028B00000","DIALOG",LANG_APRCRIN_lcTLastInv+'|'+LANG_APRCRIN_lcTNextInv) > 0) .OR.;
  !lfvDtMsg(oAriaApplication.PrntCompanyID))
...
IF loFld.Value <> loFld.OldValue .AND.;
  ( (loFld.Value < 1 .AND.;
      gfModalGen("TRM04072B00000","DIALOG",;
                  LANG_APRCRIN_lcTFirstNum+'|'+LANG_APRCRIN_lcTZero) > 0) ) 
...
IF loFld.Value <> loFld.OldValue .AND.;
   ((loFld.Value < 1 .AND. ;
     gfModalGen("TRM04072B00000","DIALOG",LANG_APRCRIN_lcTNextNum+'|'+LANG_APRCRIN_lcTZero) > 0) .OR.;
     loFld.Parent.txtFirstInvNo.Value > loFld.Value .AND.;
     gfModalGen("TRM04072B00000","DIALOG",LANG_APRCRIN_lcTNextNum+'|'+LOWER(LANG_APRCRIN_lcTFirstNum)) > 0)
...
IF loFld.Value <> loFld.OldValue .AND.;
  (loFld.Value > 0 .AND. loFld.Value > loFormSet.NINVAMTAP .AND.;
   ...
   LANG_APRCRIN_lcT1099Am + '|' + LANG_APRCRIN_lcTAprPay) > 0 ;
...
lnRet = 1
IF loFld.Value <> loFld.OldValue .AND.;
   ((loFld.Value < 1 .AND. gfModalGen("TRM04072B00000","DIALOG",LANG_APRCRIN_lcTDur+'|'+LANG_APRCRIN_lcTZero) > 0))
  loFld.Value = loFld.OldValue
  *_CUROBJ = *_CUROBJ
  lnRet = 0
ENDIF
