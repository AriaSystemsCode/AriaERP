...
*:************************************************************************
*: Modifications:
*!* E303164,1 HES Use global message [PW Project]
      ...
      *!* E303164,1 Use global message [End  ]
        SCAN FOR !EMPTY(CBUNDLE)
          ...
          IF FOUND()
            ...
            IF !(lcOrgKey == lcKey)
              *!* E303164,1 Use global message [Start]
*!*	              MESSAGEBOX("The following size has bundles in process, can't delete processed bundles, LOT# " +ALLTRIM(CLOTNO)+ ", Item# " +ALLTRIM(lcItem)+ ", Size: " + SUBSTR(ALLTRIM(lcLotSize),2) +", this bundle skipped from generation.",16+512,_SCREEN.CAPTION)
