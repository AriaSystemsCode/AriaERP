...
PRIVATE lnConnHand,lcSqlInsert,lcSqlUpdate,lcFile_Name,loFormSet,lcErrorMsg
...
lcErr = ON('ERROR')
ON ERROR llDumy = lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+lcFile_Name+;
                             IIF(EMPTY(lcErrorMsg),LANG_CONVERT_RECNO+ALLTRIM(STR(RECNO())),lcErrorMsg)+;
                             ' '+MESSAGE()+')',loFormSet)
*E038137,1 [End]
...
IF !gfOpenFile(oAriaApplication.DataDir+'BOM','BOM','SH')
  =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'BOMHEADR'+LANG_CONVERT_NOTOPEN+'BOM'+;
              LANG_CONVERT_FILE2,oFormSet)
  ...
  IF m.ccstshttyp + m.ccstsht_id + m.citmmajor <> PADR(lcCstShtTyp + lcCstSht_ID + lcItmMajor,26)
    IF !EMPTY(lcCstShtTyp + lcCstSht_ID + lcItmMajor)
      ...
      IF !lfUpdA4Files(lcBomHeadr,"BOMHEADR","BOMHEADR","CINVTYPE+CITMMAJOR+CCSTSHTTYP+CCSTSHT_ID",;
                       LANG_CONVERT_STYMAJOR+m.citmmajor+LANG_CONVERT_TYPE+m.ccstshttyp,oFormSet)
        RETURN .F.
      ENDIF
    ENDIF
    SELECT BOM
...
IF FILE(oAriaApplication.DataDir+'POSHDR'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'POSHDR','POSHDR','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSHDR'+LANG_CONVERT_NOTOPEN+'POSHDR'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'CUTTKTH'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'CUTTKTH','CUTTKTH','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSHDR'+LANG_CONVERT_NOTOPEN+'CUTTKTH'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'POFHDR'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'POFHDR','POFHDR','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSHDR'+LANG_CONVERT_NOTOPEN+'POFHDR'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'MMFGORDH'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MMFGORDH','MMFGORDH','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSHDR'+LANG_CONVERT_NOTOPEN+'MMFGORDH'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'MARWHDR'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MARWHDR','MARWHDR','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSHDR'+LANG_CONVERT_NOTOPEN+'MARWHDR'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseCutTktH AND FILE(oAriaApplication.DataDir+'CUTTKTL'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'CUTTKTL','CUTTKTL','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSHDR'+LANG_CONVERT_NOTOPEN+'CUTTKTL'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUsePosHdr AND FILE(oAriaApplication.DataDir+'POSLN'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'POSLN','POSLN','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSHDR'+LANG_CONVERT_NOTOPEN+'POSLN'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUsePosHdr
  ...
  SCAN
    ...
    *B038828,1 AMH [End]
    ...
    IF !lfUpdA4Files(lcPosHdr,"POSHDR","POSHDR","CBUSDOCU+CSTYTYPE+PO",LANG_CONVERT_WORKORD+m.po+;
                     LANG_CONVERT_TYPE+m.cbusdocu+m.cstytype,oFormSet)
      RETURN .F.
    ENDIF
  ENDSCAN
ENDIF
...
IF FILE(oAriaApplication.DataDir+'POSLN'+'.DBF')
  ...
  *E038125,1 AMH [End]
    ...
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'POSLN'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'CUTTKTL'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'CUTTKTL','CUTLIN','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'CUTTKTL'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'POFLN'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'POFLN','POFLN','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'POFLN'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'MMFGORDD'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MMFGORDD','MMFGORDDLN','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'MMFGORDD'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'MARWLIN'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MARWLIN','MARWLIN','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'MARWLIN'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'MATSHPDT'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MATSHPDT','MATLN','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'MATSHPDT'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF (llUseMMfgOrdD OR llUseMaRwLin) AND FILE(oAriaApplication.DataDir+'MATINVJL'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MATINVJL','MATINVJL','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'MATINVJL'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseCutTktL AND FILE(oAriaApplication.DataDir+'CUTTKTH'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'CUTTKTH','CUTTKTH','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'CUTTKTH'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUsePosLn AND FILE(oAriaApplication.DataDir+'POSHDR'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'POSHDR','POSHDR','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'POSHDR'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF (llUsePofLn OR llUseMatShpDt) AND FILE(oAriaApplication.DataDir+'POFHDR'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'POFHDR','POFHDR','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'POFHDR'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseMMfgOrdD AND FILE(oAriaApplication.DataDir+'MMFGORDH'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MMFGORDH','MMFGORDH','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'MMFGORDH'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseMaRwLin AND FILE(oAriaApplication.DataDir+'MARWHDR'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MARWHDR','MARWHDR','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'MARWHDR'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF (llUsePosLn OR llUseCutTktL OR llUsePofLn OR llUseMMfgOrdD OR llUseMaRwLin OR llUseMatShpDt) AND FILE(oAriaApplication.DataDir+'BOM'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'BOM','BOM','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'POSLN'+LANG_CONVERT_NOTOPEN+'BOM'+;
                LANG_CONVERT_FILE2,oFormSet)
  ...
  *! B609148,1 MMT 02/15/2010 Some Lines in POSLN Table are not converted to SQL[End]
  SCAN
    ...
    *IF !lfUpdA4Files(lcPosLn,"POSLN","POSLN","CBUSDOCU+CSTYTYPE+PO+CINVTYPE+STYLE+STR(LINENO,6)+TRANCD",LANG_CONVERT_WORKORD+m.po+;
    ...
    IF !lfUpdA4Files(lcPosLn,"POSLN","POSREC","CBUSDOCU+CSTYTYPE+PO+CRSESSION+SHIPNO+CINVTYPE+STYLE+STR(LINENO,6)+TRANCD+CSTYGRADE+CWARECODE",LANG_CONVERT_WORKORD+m.po+;
                     LANG_CONVERT_TYPE+m.cbusdocu+m.cstytype+LANG_CONVERT_LINENO+STR(m.lineno,6),oFormSet)
    *E038125,1 AMH [End]
...
IF FILE(oAriaApplication.DataDir+'SHPMTHDR'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'SHPMTHDR','SHPMTHDR','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'SHPMTHDR'+LANG_CONVERT_NOTOPEN+'SHPMTHDR'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'MATSHPHD'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MATSHPHD','MATSHPHD','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'SHPMTHDR'+LANG_CONVERT_NOTOPEN+'MATSHPHD'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseFabric AND FILE(oAriaApplication.DataDir+'FABDYE'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'FABDYE','FABDYE','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEM'+LANG_CONVERT_NOTOPEN+'FABDYE'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseFabric AND FILE(oAriaApplication.DataDir+'POFLN'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'POFLN','POFLNF','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEM'+LANG_CONVERT_NOTOPEN+'POFLN'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseFabric AND FILE(oAriaApplication.DataDir+'MMFGORDD'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MMFGORDD','MMFGORDD','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEM'+LANG_CONVERT_NOTOPEN+'MMFGORDD'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseFabric AND FILE(oAriaApplication.DataDir+'MMFGORDH'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MMFGORDH','MMFGORDD','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEM'+LANG_CONVERT_NOTOPEN+'MMFGORDH'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF FILE(oAriaApplication.DataDir+'FABDYE'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'FABDYE','FABDYE','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEMLOC'+LANG_CONVERT_NOTOPEN+'FABDYE'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseFabDye AND FILE(oAriaApplication.DataDir+'POFLN'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'POFLN','POFLNF','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEMLOC'+LANG_CONVERT_NOTOPEN+'POFLN'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseFabDye AND FILE(oAriaApplication.DataDir+'MMFGORDD'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MMFGORDD','MMFGORDD','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEMLOC'+LANG_CONVERT_NOTOPEN+'MMFGORDD'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseFabDye AND FILE(oAriaApplication.DataDir+'MMFGORDH'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MMFGORDH','MMFGORDH','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEMLOC'+LANG_CONVERT_NOTOPEN+'MMFGORDH'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseStyDye
  ...
  SCAN
    ...
    ***--- [End]
    ...
    IF !lfUpdA4Files(lcItemLoc,"ITEMLOC","STYDYE","CINVTYPE+STYLE+CWARECODE+DYELOT",LANG_CONVERT_ITEM+m.cinvtype+;
                     m.style+LANG_CONVERT_WARECODE+m.cwarecode+LANG_CONVERT_DYELOT+m.dyelot,oFormSet)
      RETURN .F.
    ENDIF
  ENDSCAN
ENDIF
...
IF FILE(oAriaApplication.DataDir+'FINVTADJ'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'FINVTADJ','FINVTADJ','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEMADJ'+LANG_CONVERT_NOTOPEN+'FINVTADJ'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseInvtAdj
  ...
  SCAN
    ...
    ***--- [End]
    ...
    IF !lfUpdA4Files(lcItemAdj,"ITEMADJ","ITEMADJ","CSESSION+CINVTYPE+STYLE+CFROMWARE+DYELOT",LANG_CONVERT_ITEM+m.cinvtype+;
                     m.style+LANG_CONVERT_WARECODE+m.cfromware+LANG_CONVERT_DYELOT+m.dyelot,oFormSet)
      RETURN .F.
    ENDIF
  ENDSCAN
ENDIF
...
IF llUseFInvtAdj
  ...
  SCAN
    ...
    *--Retreive Data from ITEMADJ file.
    ...
    IF !lfUpdA4Files(lcItemAdj,"ITEMADJ","ITEMADJ","CSESSION+CINVTYPE+STYLE+CFROMWARE+DYELOT+STR(LINENO,6)",LANG_CONVERT_ITEM+m.cinvtype+;
                     m.style+LANG_CONVERT_WARECODE+m.cfromware+LANG_CONVERT_DYELOT+m.dyelot,oFormSet)
      RETURN .F.
    ENDIF
  ENDSCAN
...
IF FILE(oAriaApplication.DataDir+'MATINVJL'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MATINVJL','MATINVJL','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEMJRNL'+LANG_CONVERT_NOTOPEN+'MATINVJL'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseMatInvJl AND FILE(oAriaApplication.DataDir+'POFLN'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'POFLN','POFREC','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEMJRNL'+LANG_CONVERT_NOTOPEN+'POFLN'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseMatInvJl AND FILE(oAriaApplication.DataDir+'MMFGORDD'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'MMFGORDD','MFGREC','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'ITEMJRNL'+LANG_CONVERT_NOTOPEN+'MFGREC'+;
                LANG_CONVERT_FILE2,oFormSet)
...
IF llUseStyInvJl
  ...
  SCAN
    ...
    ***--- [End]
    ...
    IF !lfUpdA4Files(lcItemJrnl,"ITEMJRNL","STYINVJL","CINVTYPE+STYLE+CWARECODE+CSESSION+DTOS(DTRDATE)+CTRCODE+STR(LINENO,6)",LANG_CONVERT_ITEM+m.cinvtype+;
                     m.style+LANG_CONVERT_WARECODE+m.cwarecode+LANG_CONVERT_DYELOT+m.cdyelot,oFormSet)
      RETURN .F.
    ENDIF
  ENDSCAN
ENDIF
...
IF llUseMatInvJl
  ...
  SCAN
    ...
    *--Retreive Data from ITEMJRNL file.
    ...
    IF !lfUpdA4Files(lcItemJrnl,"ITEMJRNL","STYDATE","CINVTYPE+STYLE+CWARECODE+DTOS(DTRDATE)+CSESSION+CIRTYPE+CTRCODE+STR(LINENO,6)+CTRTYPE+STR(NLINENO,6)",LANG_CONVERT_ITEM+m.cinvtype+;
                     m.style+LANG_CONVERT_WARECODE+m.cwarecode+LANG_CONVERT_DYELOT+m.cdyelot,oFormSet)
      RETURN .F.
    ENDIF
  ENDSCAN
...
IF llUseIcSegVal
  ...
  SCAN
    ...
    ***--- [End]
    ...
    IF !lfUpdA4Files(lcIcSegVal,"ICSEGVAL","SEGVAL","CINVTYPE+CISEGNO+CISEGVAL",LANG_CONVERT_SEGMENT+m.cinvtype+;
...
IF FILE(oAriaApplication.DataDir+'BOMLINE'+'.DBF')
  IF !gfOpenFile(oAriaApplication.DataDir+'BOMLINE','','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'BOMLINE'+LANG_CONVERT_NOTOPEN+'BOMLINE'+;
                LANG_CONVERT_FILE2,oFormSet)
    RETURN .F.
  ELSE
    llUseBomLine = .T.
...
SCAN
  ...
  *: B608646,1 MMT 08/07/2008 Convert Fill Currency fields in BOM and Bomline Tables[End]
  ...
  IF !lfUpdA4Files(lcBomLine,"BOMLINE","BOMLINEU","CIMTYP+CTYPE+CTKTNO+SHIPNO+STR(LINENO,6)+CBOMTYP+CINVTYPE+STYLE+CINVTYPC+ITEM+MFGCODE+CRSESSION+CSTYGRADE+STR(NLINENO,6)",;
                   LANG_CONVERT_RECNO+ALLTRIM(STR(RECNO())),oFormSet)
    RETURN .F.
  ENDIF
ENDSCAN
...
IF !gfOpenFile(oAriaApplication.DataDir+'BOM','BOMITEM','SH')
  =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'UOM'+LANG_CONVERT_NOTOPEN+'BOM'+;
              LANG_CONVERT_FILE2,oFormSet)
...
IF !USED('CODES')
  IF !gfOpenFile(oAriaApplication.DataDir+'CODES','CCODE_NO','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+ALLTRIM(SYCNVLIB.cFile)+LANG_CONVERT_NOTOPEN+'CODES'+;
                LANG_CONVERT_FILE2,oFormSet)
    RETURN SPACE(6)
  ELSE
    llOpenCodes = .T.
...
IF !USED('FABRIC')
  IF !gfOpenFile(oAriaApplication.DataDir+'FABRIC','FABRIC','SH')
    =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+ALLTRIM(SYCNVLIB.cFile)+LANG_CONVERT_NOTOPEN+'FABRIC'+;
                LANG_CONVERT_FILE2,oFormSet)
    RETURN SPACE(6)
  ENDIF
  llOpenFabric = .T.
...
IF !gfOpenFile(oAriaApplication.DataDir+'FORCAST','FORCASTW','SH')
  =lfUpdError(LANG_CONVERT_MODULE+SYCNVMDL.CAPP_ID+LANG_CONVERT_FILE+'FORCASTH'+LANG_CONVERT_NOTOPEN+'FORCAST'+;
              LANG_CONVERT_FILE2,oFormSet)
...
SCAN
  ...
  IF STR(m.nYear,4)+STR(m.nWeek,2) <> STR(lnYear,4)+STR(lnWeek,2)
    ...
    IF !lfUpdA4Files(lcForCastH,"FORCASTH","FORCASTH","STR(nYear,4)+STR(nWeek,2)",;
                     LANG_CONVERT_WEEK+STR(m.nWeek,2)+LANG_CONVERT_YEAR+STR(m.nYear,4),oFormSet)
      RETURN .F.
    ENDIF
  ENDIF
ENDSCAN
