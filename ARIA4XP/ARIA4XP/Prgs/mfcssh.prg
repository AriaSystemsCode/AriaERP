...
DO CASE 
  CASE lcTranType = 'M'
    ...
    lcBrowFlds = "PO        :H='"+LANG_MFCSSH_CTHEADER+"' ,"+;
                 "STYLE     :H='"+lcMjrHdr            +"' ,"+;
                 "STATUS    :H='"+LANG_MFCSSH_STATUS  +"' ,"+;
                 "ENTERED   :H='"+LANG_MFCSSH_ENTERED +"' ,"+;
                 "COMPLETE  :H='"+LANG_MFCSSH_COMPDATE+"' ,"+;
                 "SEASON    :H='"+LANG_MFCSSH_SEASON  +"' ,"+;
                 "CDIVISION :H='"+LANG_MFCSSH_DIVISION+"' ,"+;
                 "NSTYORDER :H='"+LANG_MFCSSH_BUDGET  +"' ,"+;
                 "RECEIVE   :H='"+LANG_MFCSSH_RECEIVE +"' ,"+;
                 "DAMAGE    :H='"+LANG_MFCSSH_DAMAGED +"' ,"+;
                 "OPEN      :H='"+LANG_MFCSSH_OPEN    +"' ,"+;
                 "CANCEL    :H='"+LANG_MFCSSH_CANCELED+"'"
  CASE lcTranType = 'I'
    lcTktText  = LANG_MFCSSH_PO
    lcBusDocu  = 'P'
    lcStyType  = 'P'
    lcBrowTitl = LANG_MFCSSH_POORDERS
    lcBrowFlds = "PO        :H='"+LANG_MFCSSH_ORDHDR  +"' ,"+;
                 "STATUS    :H='"+LANG_MFCSSH_STATUS  +"' ,"+;
                 "VENDOR    :H='"+LANG_MFCSSH_VENDOR  +"' ,"+;
                 "COMPLETE  :H='"+LANG_MFCSSH_COMPDATE+"' ,"+;
                 "NSTYORDER :H='"+LANG_MFCSSH_BUDGET  +"' ,"+;
                 "POTOTAL   :H='"+LANG_MFCSSH_TOTCOST +"' ,"+;
                 "RECEIVE   :H='"+LANG_MFCSSH_RECEIVE +"' ,"+;
                 "OPEN      :H='"+LANG_MFCSSH_OPEN    +"'"
  CASE lcTranType = 'D'
  ...
  CASE lcTranType = 'T'
    ...
    lcBrowFlds = "PO        :H='"+LANG_MFCSSH_ORDHDR  +"' ,"+;
                 "STYLE     :H='"+LANG_MFCSSH_FABRIC  +"' ,"+;
                 "CWARECODE :H='"+LANG_MFCSSH_WAREHOUS+"' ,"+;
                 "STATUS    :H='"+LANG_MFCSSH_STATUS  +"' ,"+;
                 "ENTERED   :H='"+LANG_MFCSSH_ENTERED +"' ,"+;
                 "COMPLETE  :H='"+LANG_MFCSSH_COMPDATE+"'"
ENDCASE
...
WITH loFormSet.ariaForm1.pgfCstSht.Page2.grdLots
  ...
  IF loFormSet.rbSummary = 1
    ...
    .Column9.ControlSource = "IIF("+loFormSet.lcOprDet+".TranCd='1','"+LANG_MFCSSH_BUDGET+"',"+;
                             "IIF("+loFormSet.lcOprDet+".TranCd='2','"+LANG_MFCSSH_RECEIVE+"',"+;
                             "IIF("+loFormSet.lcOprDet+".TranCd='3','"+LANG_MFCSSH_DAMAGED+"','"+;
                             LANG_MFCSSH_CANCELED+"')))"
    ...
    SCAN
      ...
      *N000587,1 WAM 12/01/2007 (End)
      ...
      IF !SEEK(cInvType+Style+STR(LineNo,6)+cBomTyp+'2',loFormSet.lcDetFile)
        ...
        (tmpBomLine.cInvType,tmpBomLine.Style,tmpBomLine.LineNo,tmpBomLine.cBomTyp,'2','***** '+LANG_MFCSSH_TOTAL+' :')
      ENDIF
      SELECT (loFormSet.lcDetFile)
...
IF loFormSet.lcTranType = 'I'
  =lfRecCost(loFormSet.lcTranType,EVALUATE(loFormSet.lcPosHdr+'.PO'),IIF(EVALUATE(loFormSet.lcPosHdr+'.Status')<>'H',loFormSet.lcBOMLINE,loFormSet.lcDetFile),IIF(EVALUATE(loFormSet.lcPosHdr+'.Status')<>'H',loFormSet.lcCTKTBOM,loFormSet.lcTktSheet),loFormSet)
ENDIF
...
*!*	  DO CASE
*!*	    CASE EVALUATE(loFormSet.lcTktSheet+'.cCatgTyp')='P'
*!*	      REPLACE ('nFCost'+lcType) WITH EVALUATE('nFCost'+lcType+' - '+loFormSet.lcTktSheet+'.Est_Cost/(1 '+loFormSet.lcPExSign+' '+loFormSet.lcPOSHDR+'.nPriceRat '+loFormSet.lcPUntSin+' '+loFormSet.lcPOSHDR+'.nCurrUnit)')
*!*	    CASE INLIST(EVALUATE(loFormSet.lcTktSheet+'.cCatgTyp'),'S','T','F')
*!*	      REPLACE ('nFCost'+lcType) WITH EVALUATE('nFCost'+lcType+' - '+loFormSet.lcTktSheet+'.Est_Cost')
*!*	    OTHERWISE
*!*	      REPLACE ('nFCost'+lcType) WITH EVALUATE('nFCost'+lcType+' - '+loFormSet.lcTktSheet+'.Est_Cost/(1 '+loFormSet.lcDExSign+' '+loFormSet.lcPOSHDR+'.nDutyRat '+loFormSet.lcDUntSin+' '+loFormSet.lcPOSHDR+'.nDCurUnit)')
*!*	  ENDCASE
  REPLACE ('nFCost'+lcType) WITH laFrgnCost [VAL(lcType)]
  *N000587,1 WAM 12/01/2007 (End)
ENDIF
...
IF _TALLY > 0
  ...
  lcBrFields = ;
       "cItem =IIF(cCatgTyp='M',gfCodDes(MfgCode,'MfgCode'),Item) :20 :H='"+LANG_MFCSSH_ITEM+"':R,"+;
       IIF(loFormSet.llUseDyelot,"Dyelot :H='"+loFormSet.AriaForm1.pgfCstSht.Page1.grdCstSht.Column2.Header1.Caption+"':R,","")+;
       "Uom       :H='"+LANG_MFCSSH_UOM+"':R ,"+;
       "UntQty    :H='"+LANG_MFCSSH_UNITS+"':R,"+;
       "UntCost   :H='"+LANG_MFCSSH_COST+"':R,"+;
       "Req_Qty   :H='"+LANG_MFCSSH_REQUIRED+"':R,"+;
       "Issue_Qty :H='"+LANG_MFCSSH_ISSUED+"':R,"+;
       "Used_Qty  :H='"+LANG_MFCSSH_USED+"':R"
  ...
  IF gfBrows('','ITEM','laTempData',lcFile_Ttl,.F.)
    ...
    SCAN FOR cBomTyp+cInvTypC+Item+MfgCode = m.Typ+m.cInvType+m.Item+m.MfgCode .AND. lVoid
      ...
      IF !SEEK(cInvType+Style+STR(LineNo,6)+cBomTyp+'2',loFormSet.lcDetFile)
        ...
        (cInvType,Style,LineNo,cBomTyp,cShowType,Item) VALUES ;
        (EVALUATE(loFormSet.lcBomLine+'.cInvType'),EVALUATE(loFormSet.lcBomLine+'.Style'),;
         EVALUATE(loFormSet.lcBomLine+'.LineNo'),EVALUATE(loFormSet.lcBomLine+'.cBomTyp'),'2','***** '+LANG_MFCSSH_TOTAL+' :')
      ENDIF
      SELECT (loFormSet.lcDetFile)
...
*!*	          REPLACE ('nFCost'+lcType) WITH EVALUATE('nFCost'+lcType+' + '+loFormSet.lcCTKTBOM+'.Est_Cost/(1 '+loFormSet.lcPExSign+' '+loFormSet.lcPOSHDR+'.nPriceRat '+loFormSet.lcPUntSin+' '+loFormSet.lcPOSHDR+'.nCurrUnit)')
...
*!*	        OTHERWISE
*!*	          REPLACE ('nFCost'+lcType) WITH EVALUATE('nFCost'+lcType+' + '+loFormSet.lcCTKTBOM+'.Est_Cost/(1 '+loFormSet.lcDExSign+' '+loFormSet.lcPOSHDR+'.nDutyRat '+loFormSet.lcDUntSin+' '+loFormSet.lcPOSHDR+'.nDCurUnit)')
*!*	      ENDCASE
      REPLACE ('nFCost'+lcType) WITH laFrgnCost [VAL(lcType)]
      *N000587,1 WAM 12/01/2007 (End)
    ENDIF
  ...
  CASE INLIST(m.cCatgTyp,'M','P','D')
    ...
    ELSE
      IF m.cCatGTyp $ 'PD'
        ...
        *E300725,1 Button : 00000
        *E300725,1 Ok
        =gfModalGen('TRM38091B00000','ALERT',IIF(m.cCatGTyp='D',LANG_MFCSSH_ISSUE+'|'+LANG_MFCSSH_DUTY+'|'+;
                    LANG_MFCSSH_DUTY,LANG_MFCSSH_ISSUE+'|'+LANG_MFCSSH_PURCHASE+'|'+LANG_MFCSSH_PURCHASE))
      ELSE
...
*!*      *C200255,1 (Begin)
    ...
    *B131716,1 WSH 04/27/2006 [End]
    ...
    IF INLIST(loParentForm.laSetups[11,2],'L','F','I')
      ...
      IF FOUND()
        lcBrFields = "cWareCode:H='"+LANG_MFCSSH_WAREHOUS+"',dTranDate:H='"+LANG_MFCSSH_DATE+"',nTotQty:H='"+;
                     LANG_MFCSSH_QUNTITY+"',nUnitCst:H='"+LANG_MFCSSH_COST+"',nTotCst:H='"+LANG_MFCSSH_AMOUNT+;
                     "',cApInvNo:H='"+LANG_MFCSSH_INVOICE+"'"
        *--- DOC.
  ...
  CASE INLIST(m.cCatgTyp,'M','P','D')
    ...
    ELSE
      IF m.cCatGTyp $ 'PD'
        ...
        *E300725,1 Button : 00000
        *E300725,1 Ok
        =gfModalGen('TRM38091B00000','ALERT',IIF(m.cCatGTyp='D',LANG_MFCSSH_RETURNSML+'|'+LANG_MFCSSH_DUTY+'|'+;
                    LANG_MFCSSH_DUTY,LANG_MFCSSH_RETURNSML+'|'+LANG_MFCSSH_PURCHASE+'|'+LANG_MFCSSH_PURCHASE))
      ELSE
        *E300725,1 Message : 38092
        *E300725,1 This MFG code has been setup to be applied from the A/P.
        *E300725,1 Button : 00000
...
IF !FOUND()
  ...
  *C200080,1 AMM Consider the dye order case
  =gfModalGen('TRM38065B00000','ALERT',IIF(loFormSet.lcTranType='M',STRTRAN(LOWER(LANG_MFCSSH_CUTTKT),'#'),;
                                           IIF(loFormSet.lcTranType $ 'ID',IIF(EMPTY(loFormSet.lcDyePO),;
                                               STRTRAN(LOWER(LANG_MFCSSH_PO),'#'),STRTRAN(LOWER(LANG_MFCSSH_DYEORD),'#')),;
                                               IIF(loFormSet.lcTranType='N',STRTRAN(LOWER(LANG_MFCSSH_NPO),'#'),;
                                                   STRTRAN(LOWER(LANG_MFCSSH_ORDHDR),'#')))))
  RETURN
ENDIF
...
IF INLIST(loFormSet.lcTranType,'M','T')
  ...
  *B125713,1 AMH [End]
  ...
  IF !llFound
    ...
    *=gfModalGen('TRM38031B00000','ALERT',ALLTRIM(loFormSet.lcMjrHdr)+': '+ALLTRIM(loFormSet.lcPosHdr+'.Style')+'|'+;
                                         IIF(loFormSet.lcTranType='M',STRTRAN(LOWER(LANG_MFCSSH_CUTTKT),'#'),;
                                         STRTRAN(LOWER(LANG_MFCSSH_ORDHDR),'#')))
    =gfModalGen('TRM38031B00000','ALERT',ALLTRIM(loFormSet.lcMjrHdr)+': '+ALLTRIM(EVALUATE(loFormSet.lcPosHdr+'.Style'))+'|'+;
                                         IIF(loFormSet.lcTranType='M',STRTRAN(LOWER(LANG_MFCSSH_CUTTKT),'#'),;
                                         STRTRAN(LOWER(LANG_MFCSSH_ORDHDR),'#')))
    ...
    IF !llFound
      ...
      *E300725,1 Ok
      =gfModalGen('TRM38031B00000','ALERT',ALLTRIM(loFormSet.lcMjrHdr)+': '+ALLTRIM(SUBSTR(Style,1,LEN(loFormSet.lcMjrMsk)))+'|'+;
                                           IIF(!EMPTY(loFormSet.lcDyePO),STRTRAN(LOWER(LANG_MFCSSH_DYEORD),'#'),;
                                               IIF(loFormSet.lcTranType='N',STRTRAN(LOWER(LANG_MFCSSH_NPO),'#'),;
                                                   STRTRAN(LOWER(LANG_MFCSSH_PO),'#'))))
      RETURN
    ENDIF
  ...
  IF !llContinue OR lnRecDetNo = RECCOUNT(loFormSet.lcDetFile)
    ...
    *B125713,1 AMH [End]
      ...
      =gfModalGen('TRM38031B00000','ALERT',ALLTRIM(loFormSet.lcMjrHdr)+': '+;
            ALLTRIM(lcItem)+'|'+IIF(loFormSet.lcTranType='M',STRTRAN(LOWER(LANG_MFCSSH_CUTTKT),'#'),;
                                    IIF(loFormSet.lcTranType $ 'ID',IIF(EMPTY(loFormSet.lcDyePO),;
                                        STRTRAN(LOWER(LANG_MFCSSH_PO),'#'),STRTRAN(LOWER(LANG_MFCSSH_DYEORD),'#')),;
                                        IIF(loFormSet.lcTranType='N',STRTRAN(LOWER(LANG_MFCSSH_NPO),'#'),;
                                            STRTRAN(LOWER(LANG_MFCSSH_ORDHDR),'#')))))
...
IF EOF()
  IF llContinue
    ...
    *E300725,1 Button : 00000
    *E300725,1 Ok
    =gfModalGen('TRM38066B00000','ALERT',IIF(loFormSet.lcTranType='M',STRTRAN(LOWER(LANG_MFCSSH_CUTTKT),'#'),;
                                             IIF(loFormSet.lcTranType $ 'ID',IIF(EMPTY(loFormSet.lcDyePO),;
                                                 STRTRAN(LOWER(LANG_MFCSSH_PO),'#'),STRTRAN(LOWER(LANG_MFCSSH_DYEORD),'#')),;
                                                 IIF(loFormSet.lcTranType='N',STRTRAN(LOWER(LANG_MFCSSH_NPO),'#'),;
                                                     STRTRAN(LOWER(LANG_MFCSSH_ORDHDR),'#')))))
...
IF EVALUATE(loFormSet.lcPosHdr+'.Status') = 'S'
  ...
  *E300725,1 Button : 00000
  *E300725,1 Ok
  =gfModalGen('TRM38059B00000','ALERT',IIF(loFormSet.lcTranType='M',STRTRAN(LOWER(LANG_MFCSSH_CUTTKT),'#'),;
                                           IIF(loFormSet.lcTranType $ 'ID',IIF(EMPTY(loFormSet.lcDyePO),;
                                               STRTRAN(LOWER(LANG_MFCSSH_PO),'#'),STRTRAN(LOWER(LANG_MFCSSH_DYEORD),'#')),;
                                               IIF(loFormSet.lcTranType='N',STRTRAN(LOWER(LANG_MFCSSH_NPO),'#'),;
                                                   STRTRAN(LOWER(LANG_MFCSSH_ORDHDR),'#')))))
...
IF EVALUATE(loFormSet.lcPosHdr+'.Receive') > 0 OR llChkRecev
  ...
  *E300725,1 Button : 00000
  *E300725,1 Ok
  =gfModalGen('TRM38060B00000','ALERT',IIF(loFormSet.lcTranType='M',STRTRAN(LOWER(LANG_MFCSSH_CUTTKT),'#'),;
                                           IIF(loFormSet.lcTranType $ 'ID',IIF(EMPTY(loFormSet.lcDyePO),;
                                               STRTRAN(LOWER(LANG_MFCSSH_PO),'#'),STRTRAN(LOWER(LANG_MFCSSH_DYEORD),'#')),;
                                               IIF(loFormSet.lcTranType='N',STRTRAN(LOWER(LANG_MFCSSH_NPO),'#'),;
                                                   STRTRAN(LOWER(LANG_MFCSSH_ORDHDR),'#')))))
...
IF !EOF()
  ...
  *E300725,1 Button : 38002
  *E300725,1 Proceed  Cancel
  IF gfModalGen('TRM38058B38002','ALERT',IIF(loFormSet.lcTranType='M',STRTRAN(LOWER(LANG_MFCSSH_CUTTKT),'#'),;
                                           IIF(loFormSet.lcTranType $ 'ID',IIF(EMPTY(loFormSet.lcDyePO),;
                                               STRTRAN(LOWER(LANG_MFCSSH_PO),'#'),STRTRAN(LOWER(LANG_MFCSSH_DYEORD),'#')),;
                                               IIF(loFormSet.lcTranType='N',STRTRAN(LOWER(LANG_MFCSSH_NPO),'#'),;
                                                   STRTRAN(LOWER(LANG_MFCSSH_ORDHDR),'#')))))=2
    RETURN .F.
  ENDIF  
ENDIF
...
IF !EOF()
  ...
  *E300725,1 Button : 38002
  *E300725,1 Proceed  Cancel
  IF gfModalGen('QRM38033B38002','ALERT',IIF(loFormSet.lcTranType='M',STRTRAN(LOWER(LANG_MFCSSH_CUTTKT),'#'),;
                                           IIF(loFormSet.lcTranType $ 'ID',IIF(EMPTY(loFormSet.lcDyePO),;
                                               STRTRAN(LOWER(LANG_MFCSSH_PO),'#'),STRTRAN(LOWER(LANG_MFCSSH_DYEORD),'#')),;
                                               IIF(loFormSet.lcTranType='N',STRTRAN(LOWER(LANG_MFCSSH_NPO),'#'),;
                                                   STRTRAN(LOWER(LANG_MFCSSH_ORDHDR),'#')))))=2
...
lcBrFields = "Item:H='"+loParentForm.lcItmHdr+"':19,cDyelot:H='"+LANG_MFCSSH_DYELOT+"':10,"+;
             "nQty1:H='"+LANG_MFCSSH_QUNTITY+"1':6,nQty2:H='"+LANG_MFCSSH_QUNTITY+"2':6,"+;
             "nQty3:H='"+LANG_MFCSSH_QUNTITY+"3':6,nQty4:H='"+LANG_MFCSSH_QUNTITY+"4':6,"+;
             "nQty5:H='"+LANG_MFCSSH_QUNTITY+"5':6,nQty6:H='"+LANG_MFCSSH_QUNTITY+"6':6,"+;
             "nQty7:H='"+LANG_MFCSSH_QUNTITY+"7':6,nQty8:H='"+LANG_MFCSSH_QUNTITY+"8':6,"+;
             "nTotQty:H='"+LANG_MFCSSH_TOTAL+" "+LANG_MFCSSH_QUNTITY+"':7"
...
WITH loFormSet.AriaForm1
  ...
  .cmdInvert.Enabled   = .T.
  .cmdOk.Enabled       = .T.
  .lblQuantity.Caption = IIF(puTrnType=2,LANG_MFCSSH_RECEIVE,;
                         IIF(puTrnType=3,LANG_MFCSSH_DAMAGED,LANG_MFCSSH_CANCELED))
ENDWITH
...
SCAN FOR ctype = '1' AND !lVoid
  ...
  *N000587,1 WAM 12/01/2007 (End)
  ...
  IF !SEEK(cInvType+Style+STR(LineNo,6)+cBomTyp+'2',loFormSet.lcDetFile)
    ...
    (cInvType,Style,LineNo,cBomTyp,cShowType,Item) VALUES ;
    (EVALUATE(loFormSet.lcBomLine+'.cInvType'),EVALUATE(loFormSet.lcBomLine+'.Style'),EVALUATE(loFormSet.lcBomLine+'.LineNo'),;
     EVALUATE(loFormSet.lcBomLine+'.cBomTyp'),'2','***** '+LANG_MFCSSH_TOTAL+' :')
  ENDIF
  SELECT (loFormSet.lcDetFile)
  *N000587,1 WAM 12/01/2007 Get foreign and equivalent cost from PO cost sheet lines
  *REPLACE ItemQty  WITH ItemQty + EVALUATE(loFormSet.lcBomLine+'.ItemQty'),;
...
*! B608402,1 SSH 11/29/2007 Fix some error in while adding cost elment 6,7
  ...
  SELECT GLDIST
  APPEND FROM (oAriaApplication.WorkDir+loFormSet.lcGlDTemp)
  SELECT (loFormSet.lcGlDTemp)
  ZAP
    ...
    *-- Get the variable part of the error message
    DO CASE
      ...
      CASE cIMTyp = 'N'
        lcMssgText = LANG_MFCSSH_NLORDERS
    ENDCASE
    lcMssgText = lcMssgText + ' ' + LANG_MFCSSH_NO + ' ' + cTKtNo    + ', ' + LANG_MFCSSH_RECVSESS +;
                              ' ' + LANG_MFCSSH_NO + ' ' + cRSession + ', ' + LANG_MFCSSH_LINE     +;
                              ' ' + LANG_MFCSSH_NO + ' ' + ALLTRIM(cLineNo)
...
loFormSet.ariaForm1.Caption = LANG_MFCSSH_MFISSLT+IIF(!EMPTY(lcOprCode) .AND. !EMPTY(lcLotNo),;
                              LANG_MFCSSH_FOR+' '+LANG_MFCSSH_LOT+': '+lcLotNo+' '+;
                              LANG_MFCSSH_OPERAT+': '+ALLTRIM(gfCodDes(lcOprCode,'MfgCode')),'')
loFormSet.lcOprCode = lcOprCode
loFormSet.lcLotNo   = lcLotNo
...
loFormSet.ariaForm1.Caption = LANG_MFCSSH_OPERAT+': '+ALLTRIM(gfCodDes(lcOprCode,'MfgCode'))+' '+;
                              LANG_MFCSSH_LOT  +' : '+lcLotNo
