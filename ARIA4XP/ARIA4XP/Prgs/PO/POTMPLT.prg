...
lcBrFields = "CTEMPLATE :H='"+LANG_BROW_FIELD_TITLE+"',"+;
             "CTMPLTDSC :H='"+LANG_BROW_DESC_TITLE+"'"

PRIVATE lcFile_ttl,lcWinTitl
=Ariabrow('',LANG_BROW_TITLE,gnbrfsrow1, gnbrfscol1,gnbrfsrow2, gnbrfscol2, '','',;
             lcFieldsNam,'laTemp')
...
IF llValue
  ...
  LOCATE 
  IF !EOF()
    lnResp = gfModalGen('INM00000B00006',.F.,.F.,.F.,LANG_TEMP_CODE_MSG + ALLTRIM(TempDef.CTEMPLATE)+;
