...
*B610496,1 SAB 09/04/2013 Fix IC Rebalance Issue in ticket # T20120316.0004 [T20120316.0004]
...
ELSE                                   && Issue transaction
  ...
  ENDIF
  *B610496,1 SAB 09/04/2013 Fix IC Rebalance Issue in ticket # T20120316.0004 [T20120316.0004][Start]
  **B609957,1 MMT 06/11/2012 Fix rounding problem in gfstycrl.prg while updating nstkval  field in style file[Start]
  ...
  *B610662,1 TMI 02/02/2014 18:49 [Start] update the lnStkVal in case of FIFO/LIFO based on the actal stock value 
  ...
  ELSE
    *B610662,1 TMI 02/02/2014 18:50 [End  ] 
    ...
    lnStkVal = Round(TotStk * IIF(lnprvstk=0,lnAveCost,ROUND(lnstkval/lnprvstk,3)),2)
  
    *B610662,1 TMI 02/02/2014 18:50 [Start] 
  ENDIF 
  *B610662,1 TMI 02/02/2014 18:50 [End  ] 

  *B610496,1 SAB 09/04/2013 Fix IC Rebalance Issue in ticket # T20120316.0004 [T20120316.0004][End]
ENDIF
