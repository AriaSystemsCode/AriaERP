...
IF lcMajorOrNon $ 'NI'
  ...
  *!*	                 [OTS=(TOTWIP+TOTSTK-TOTORD):12:H="]+LANG_OTS+[",Fabric:15:h="]+LANG_FABRIC+[",]
  lcBrFields = lcBrFields+;
    [OTS=(TOTWIP+TOTSTK-TOTORD):12:H="]+LANG_OTS+[",cprifabric:15:h="]+LANG_FABRIC+[",]
...
ELSE
  ...
  *!*	                 [Style_A.Fabric:12:h="]+LANG_FABRIC+[",Style_A.CSTYGRADE:H="]+LANG_GRADE+[", lcRoyDesc=gfCodDes(STYLE_A.ROYALTY,'ROYALTY') :15 :H="]+LANG_ROYAL+[" , STYLE_A.PATTERN :H="]+LANG_PATRN+[", STYLE_A.STATUS :H="]+LANG_STATUS+[",]
  lcBrFields = lcBrFields+;
    [Style_A.cprifabric:12:h="]+LANG_FABRIC+[",Style_A.CSTYGRADE:H="]+LANG_GRADE+[", lcRoyDesc=gfCodDes(STYLE_A.ROYALTY,'ROYALTY') :15 :H="]+LANG_ROYAL+[" , STYLE_A.PATTERN :H="]+LANG_PATRN+[", STYLE_A.STATUS :H="]+LANG_STATUS+[",]
  *B609825,1 MMT 02/09/2012 Browse cprifabric instead of fabric in style browse[T20120117.0008][End]
  lcBrFields = lcBrFields + ;
...
CASE '*' $ XCLR AND '*' $ XSEASON
  ...
  *!*	                 [totord :14 :H="]+LANG_ORDER+[",Fabric :19 :H="]+LANG_FABRIC+["]
  lcBrFields = [STYLE :30 :H=ALLTRIM(lcClrTtl),DESC :45:H="]+LANG_DESC+[",]+;
    [pricea :H="]+LANG_PRICEA+[",totWip :14 :H="]+LANG_WIP+[",totstk :14 :H="]+LANG_STOCK+[",]+;
    [totord :14 :H="]+LANG_ORDER+[",cprifabric :19 :H="]+LANG_FABRIC+["]
  *B609825,1 MMT 02/09/2012 Browse cprifabric instead of fabric in style browse[T20120117.0008][End]
CASE '*' $ XCLR
  *B609825,1 MMT 02/09/2012 Browse cprifabric instead of fabric in style browse[T20120117.0008][Start]
  *!*	    lcBrFields = [STYLE :30 :H=ALLTRIM(lcClrTtl),DESC :45:H="]+LANG_DESC+[",]+;
...
=ARIABROW(''             ,LANG_BrowTitl    ,gnbrhsrow1, gnbrhscol1, gnbrhsrow2, gnbrhscol2,''         ,'Fi\<nd;Or\<der by;\<Descending;Fi\<lter;;\!\?\<Ok',.F.,.F.,.F.,.F.,.F.,.F.,.F.,.F.,.F.,.F.,.F.,"" ,.F.,.F.,"OTS")  
...
IF !BETWEEN(LEN(strMail),2,4)  && (.Com, .Org, or .eg)
