...
namespace net.authorize.sample
{
    ...
    class SampleCode
    {
        ...
        private static void RunMethod(String methodName)
        {
            ...
            const string transactionId = "40011008188";
            ...
            const string customerProfileId = "1503676305";
            const string customerPaymentProfileId = "1502985870";
            const string shippingAddressId = "1503073109";
            decimal amount = 12.34m;
            const string subscriptionId = "1223213";
            const short day = 45;
            const string emailId = "wael.a@ariany.com";
            ...
            switch (methodName)
            {
                ...
                case "CreateSubscriptionFromCustomerProfile":
                    CreateSubscriptionFromCustomerProfile.Run(apiLoginId, transactionKey, day, customerProfileId, customerPaymentProfileId, shippingAddressId);
                    break;
