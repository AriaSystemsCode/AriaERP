...
***********************************************************************************************
#INCLUDE R:\ARIA4XP\REPORTS\MA\MAMATLCK.H
...
*WAIT WINDOW LANG_LOCKDATE
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_LOCKDATE,oAriaApplication.GetHeaderText("LANG_LOCKDATE",AHEADERFILE))
...
DO CASE
  CASE MDINVNTH.TYPE = 'L'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*RETURN "'"+LANG_LOCKED+"'"
RETURN "'"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_LOCKED,oAriaApplication.GetHeaderText("LANG_LOCKED",AHEADERFILE))+"'"
*N000682,1 11/20/2012 MMT Globlization changes[End]

  CASE MDINVNTH.TYPE = 'M'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*RETURN "'"+LANG_MARKDOWN+"'"
RETURN "'"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MARKDOWN,oAriaApplication.GetHeaderText("LANG_MARKDOWN",AHEADERFILE))+"'"
*N000682,1 11/20/2012 MMT Globlization changes[End]

  CASE MDINVNTH.TYPE = 'P'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*RETURN "'"+LANG_POSTED+"'"
RETURN "'"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POSTED,oAriaApplication.GetHeaderText("LANG_POSTED",AHEADERFILE))+"'"
*N000682,1 11/20/2012 MMT Globlization changes[End]
