...
#INCLUDE R:\ARIA4XP\REPORTS\MA\mastkjl.H
...
*WAIT WINDOW LANG_COLLECTDATA+STYLE NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_COLLECTDATA,oAriaApplication.GetHeaderText("LANG_COLLECTDATA",AHEADERFILE))+STYLE NOWAIT
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*= lFogMover(@laRpSorInv,@laRpTarInv,LANG_SELECTINV,.T.,'')  && call mover function.
= lFogMover(@laRpSorInv,@laRpTarInv,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_SELECTINV,oAriaApplication.GetHeaderText("LANG_SELECTINV",AHEADERFILE)),.T.,'')  && call mover function.
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	ENDIF
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*STORE LANG_ADJUSTMENT TO laRpSorInv[1],laRpTarInv[1]
STORE IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ADJUSTMENT,oAriaApplication.GetHeaderText("LANG_ADJUSTMENT",AHEADERFILE)) TO laRpSorInv[1],laRpTarInv[1]
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*STORE LANG_PHYSICAL  TO laRpSorInv[2],laRpTarInv[2]
STORE IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_PHYSICAL,oAriaApplication.GetHeaderText("LANG_PHYSICAL",AHEADERFILE))  TO laRpSorInv[2],laRpTarInv[2]
*N000682,1 11/20/2012 MMT Globlization changes[End]

IF lnArrayLen = 3
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*STORE LANG_TRANSFER TO laRpSorInv[3],laRpTarInv[3]
STORE IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_TRANSFER,oAriaApplication.GetHeaderText("LANG_TRANSFER",AHEADERFILE)) TO laRpSorInv[3],laRpTarInv[3]
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[2,2]= LANG_REPORTTTL
loOgScroll.laCRParams[2,2]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_REPORTTTL,oAriaApplication.GetHeaderText("LANG_REPORTTTL",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
