...
****************************************************************************
*! Modification: 
*! E304061 , 1 HMS ,  - Aria 5 - Adding SKU Description to Pack/SKU Report [T20180802.0012]
*:**************************************************************************
...
*REPLACE Sku WITH LANG_PREPACK
REPLACE Sku WITH IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_PREPACK,oAriaApplication.GetHeaderText("LANG_PREPACK",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    *N000682,1 MMT 02/11/2013 Globalization changes[End]
  ENDIF
*E304061 , 1 HMS ,  - Aria 5 - Adding SKU Description to Pack/SKU Report [T20180802.0012][begin]
  =gfSeek('S'+Spck_lin.Account+IIF(llExtendedSizeScale ,SUBSTR(Spck_lin.Style,1,lnColLen +lnColPos-1),Spck_lin.Style),'SPCK_HDR','SKU_STYLE') 
  REPLACE DESC WITH SPCK_HDR.DESC
*E304061 , 1 HMS ,  - Aria 5 - Adding SKU Description to Pack/SKU Report [T20180802.0012][END]
ENDIF
...
ELSE
  ...
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcSPackID = LANG_PACKID +' : ' + &lcTempFile..PACK_ID
lcSPackID = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_PACKID,oAriaApplication.GetHeaderText("LANG_PACKID",AHEADERFILE)) +' : ' + &lcTempFile..PACK_ID
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
AFIELDS(laFileStr)
*E304061 , 1 HMS ,  - Aria 5 - Adding SKU Description to Pack/SKU Report [T20180802.0012][begin]
DIMENSION laFileStr[ALEN(laFileStr,1)+1,ALEN(laFileStr,2)]
laFileStr[ALEN(laFileStr,1),1] = 'DESC'
laFileStr[ALEN(laFileStr,1),2] = 'C'
laFileStr[ALEN(laFileStr,1),3] = 20
laFileStr[ALEN(laFileStr,1),4] = 0
For lnI = 7 To 16
  Store '' To laFileStr[ALEN(laFileStr,1),lnI]
Endfor
Store 0 To laFileStr[ALEN(laFileStr,1),17],laFileStr[ALEN(laFileStr,1),18]
*E304061 , 1 HMS ,  - Aria 5 - Adding SKU Description to Pack/SKU Report [T20180802.0012][End]
