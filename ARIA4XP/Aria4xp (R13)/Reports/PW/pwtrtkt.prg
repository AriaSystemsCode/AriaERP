...
#include  r:\aria4xp\reports\pw\pwtrtkt.h
...
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  *WAIT WINDOW 'Selected ' + ALLTRIM(STR(RECCOUNT(lcPWCursor))) + ' Records.' NOWAIT
  WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Selected,oAriaApplication.GetHeaderText("LANG_Selected",AHEADERFILE)) + ALLTRIM(STR(RECCOUNT(lcPWCursor))) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Records,oAriaApplication.GetHeaderText("LANG_Records",AHEADERFILE)) NOWAIT
  * N000682 ,1 Thabet Handle globalization issues [END]
  ...
  *WAIT WINDOW 'Creating temp. Tracking Tickets file.' NOWAIT
  WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Creating,oAriaApplication.GetHeaderText("LANG_Creating",AHEADERFILE)) NOWAIT
  *N000682 ,1 Thabet Handle globalization issues [END]
