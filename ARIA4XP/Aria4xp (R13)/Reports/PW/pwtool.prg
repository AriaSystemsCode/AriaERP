...
#include  r:\aria4xp\reports\pw\pwtool.h
...
*  loOgScroll.laCRParams[1,2] = 'Tools Report'
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = LANG_Tools_Report
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Tools_Report,oAriaApplication.GetHeaderText("LANG_Tools_Report",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*  WAIT WINDOW 'Selected ' + ALLTRIM(STR(RECCOUNT(lcToolCursor))) + ' Records.' NOWAIT
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_Select + ALLTRIM(STR(RECCOUNT(lcToolCursor))) + LANG_Record  NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Select,oAriaApplication.GetHeaderText("LANG_Select",AHEADERFILE)) + ALLTRIM(STR(RECCOUNT(lcToolCursor))) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Record,oAriaApplication.GetHeaderText("LANG_Record",AHEADERFILE))  NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*  WAIT WINDOW 'Creating temp. Tool file.' NOWAIT
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_Creating_temp NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Creating_temp,oAriaApplication.GetHeaderText("LANG_Creating_temp",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*  WAIT WINDOW 'Creating temp. Tool Unit file.' NOWAIT
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_Creating_temp_Tool NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Creating_temp_Tool,oAriaApplication.GetHeaderText("LANG_Creating_temp_Tool",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
