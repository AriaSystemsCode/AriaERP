...
#Include R:\Aria4xp\Reports\AL\alstyf2.h
...
ELSE
  ...
  *loOGScroll.laCRParams[1,2] = LANG_ALLOCATION_REPORT_BY_STYLE
  loOGScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ALLOCATION_REPORT_BY_STYLE,oAriaApplication.GetHeaderText("LANG_ALLOCATION_REPORT_BY_STYLE",AHEADERFILE))
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*STORE LANG_OPEN     TO laRpSource[1] , laRpTarget[1]
STORE IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_OPEN,oAriaApplication.GetHeaderText("LANG_OPEN",AHEADERFILE))     TO laRpSource[1] , laRpTarget[1]
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*STORE LANG_RELEASED TO laRpSource[2] , laRpTarget[2]
STORE IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_RELEASED,oAriaApplication.GetHeaderText("LANG_RELEASED",AHEADERFILE)) TO laRpSource[2] , laRpTarget[2]
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*STORE LANG_PULLED   TO laRpSource[3] , laRpTarget[3]
STORE IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_PULLED,oAriaApplication.GetHeaderText("LANG_PULLED",AHEADERFILE))   TO laRpSource[3] , laRpTarget[3]
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*STORE LANG_HOLD   TO laRpSource[4] , laRpTarget[4]
STORE IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_HOLD,oAriaApplication.GetHeaderText("LANG_HOLD",AHEADERFILE))   TO laRpSource[4] , laRpTarget[4]
*N000682,1 11/20/2012 MMT Globlization changes[End]


*N000682,1 11/20/2012 MMT Globlization changes[Start]
*STORE Lang_Complete TO laRpSource[5] , laRpTarget[5]
STORE IIF(oAriaApplication.oActivelang.cLang_ID = "EN",Lang_Complete,oAriaApplication.GetHeaderText("Lang_Complete",AHEADERFILE)) TO laRpSource[5] , laRpTarget[5]
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
* N000862 ,1 Thabet Handle globalization issues [Start]
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*= LFOGMover(@laRpSource,@laRpTarget,Lang_Select_Pick_Ticket,.T.,'')  && call mover function.
= LFOGMover(@laRpSource,@laRpTarget,;
            IIF(oAriaApplication.oActivelang.cLang_ID = "EN",Lang_Select_Pick_Ticket,oAriaApplication.GetHeaderText("Lang_Select_Pick_Ticket",AHEADERFILE)),.T.,'')  && call mover function.
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  FOR lnI = 1 TO ALEN(laRpTarget,1)
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
    lcRpStatus = lcRpStatus + IIF(laRpTarget[lnI] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_OPEN,oAriaApplication.GetHeaderText("LANG_OPEN",AHEADERFILE)),'O',;
                              IIF(laRpTarget[lnI] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_RELEASED,oAriaApplication.GetHeaderText("LANG_RELEASED",AHEADERFILE)),'X',;
                              IIF(laRpTarget[lnI] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_PULLED,oAriaApplication.GetHeaderText("LANG_PULLED",AHEADERFILE)),'P' , ;
