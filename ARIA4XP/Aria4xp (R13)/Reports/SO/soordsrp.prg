...
*:B607862,1 MMT 12/05/2006 Fix bug of error after no record message and preview again. (T20060915.0016)
*:B608306,1 NNA 10/04/2007 fix bug that Contract or Edi orders (Type C and T) appear in the Order status Reports
*:B608497,1 MHM 03/28/2008 Increase width of the Cust Po.
*:B609417,1 MMT 10/03/2010 Order status report is picking wrong selling price{T20100916.0034}
*:B609620,1 MAE 06/14/2011 Fix the Order Browse customer shipping address 1
*:E303491,1 MMT 07/16/2014 Add TotCost column to the excel of order status report[T20140619.0010]
*:B610867,1 MMT 10/01/2014 Order Status report reads style total cost incorrectly[T20140929.0008]
*:E303607,1 MMT 10/12/2015 Add rep1 field to Order Status report excel[T20150918.0002]
***************************************************************************
...
*B608306,1 NNA 10/04/2007 (Begin) Exclude the Contract and Edi orders
*lcFilter =lcFilter + " Where  Ordhdr.status $'OH' "
...
*lcFields=lcFields+" ORDHDR.ENTERED, LEFT(ORDLINE.STYLE,lnLnthSty) AS STYLE ,SUM(ORDLINE.TOTQTY) AS TOTQTY, ORDLINE.PRICE "
...
*:E303607,1 MMT 10/12/2015 Add rep1 field to Order Status report excel[T20150918.0002][Start]
lcFields=lcFields+", ORdhdr.Rep1" 
*:E303607,1 MMT 10/12/2015 Add rep1 field to Order Status report excel[T20150918.0002][End]
...
IF RECCOUNT() = 0 .OR. EOF()
  *B607862,1 12/05/2006 MMT fix bug of error after no record message and preview again[start]
  llDonprnt = .T.
  *B607862,1 12/05/2006 MMT fix bug of error after no record message and preview again[End]
...
*B608306,1 NNA 10/04/2007 (Begin) use Temp. file exclusive.
...
*:B610867,1 MMT 10/01/2014 Order Status report reads style total cost incorrectly[T20140929.0008][Start]
*!*	m.STYDESC = IIF(SEEK(STYLE,'STYLE'), STYLE.DESC,'   ')
*!*	*:E303491,1 MMT 07/16/2014 Add TotCost column to the excel of order status report[T20140619.0010][Start]
*!*	m.TOTCOST = IIF(SEEK(STYLE,'STYLE'), STYLE.TOTCOST,0)
m.STYDESC = IIF(SEEK(STYLE,'STYLE','STYLE'), STYLE.DESC,'   ')
m.TOTCOST = IIF(SEEK(STYLE,'STYLE','STYLE'), STYLE.TOTCOST,0)
*:B610867,1 MMT 10/01/2014 Order Status report reads style total cost incorrectly[T20140929.0008][End]
*:E303491,1 MMT 07/16/2014 Add TotCost column to the excel of order status report[T20140619.0010][End]
*:B608497,1 MHM 03/28/2008 Increase width of the Cust Po.
...
loOgScroll.lcOGLastForm ='SOORDSRP'
...
*:E303607,1 MMT 10/12/2015 Add rep1 field to Order Status report excel[T20150918.0002][Start]
*DIMENSION laTempStru[22,18] ,laTemplINE[1,18],laTempHDR[1,18]
...
*! Developer : MAE - Mahmoud Abd El-Aziz
*! Date      : 06/14/2011
