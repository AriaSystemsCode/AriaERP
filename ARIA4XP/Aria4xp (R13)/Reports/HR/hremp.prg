...
*:***************************************************************************
#INCLUDE r:\aria4xp\reports\hr\hremp.h
IF llOgFltCh
...
* N000682 ,1 Thabet Handle globalization issues [Start]
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = LANG_Employee_Report
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Employee_Report,oAriaApplication.GetHeaderText("LANG_Employee_Report",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*  WAIT WINDOW 'Selected ' + ALLTRIM(STR(RECCOUNT(lcEmployeeCursor))) + ' Records.' NOWAIT
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_Selected + ALLTRIM(STR(RECCOUNT(lcEmployeeCursor))) + LANG_Records NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Selected,oAriaApplication.GetHeaderText("LANG_Selected",AHEADERFILE)) + ALLTRIM(STR(RECCOUNT(lcEmployeeCursor))) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Records,oAriaApplication.GetHeaderText("LANG_Records",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*  WAIT WINDOW 'Creating temp. Qulification file.' NOWAIT
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_Creating_temp_Qulification NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Creating_temp_Qulification,oAriaApplication.GetHeaderText("LANG_Creating_temp_Qulification",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
