...
*:***************************************************************************
#INCLUDE r:\aria4xp\reports\hr\hrshift.h
IF llOgFltCh
...
* N000682 ,1 Thabet Handle globalization issues [END]
  ...
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = LANG_Shift_Report
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Shift_Report,oAriaApplication.GetHeaderText("LANG_Shift_Report",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
 ...
 * N000682 ,1 Thabet Handle globalization issues [Start]
  ...
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_Selected + ALLTRIM(STR(RECCOUNT(lcShiftCursor))) + LANG_Records NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Selected,oAriaApplication.GetHeaderText("LANG_Selected",AHEADERFILE)) + ALLTRIM(STR(RECCOUNT(lcShiftCursor))) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Records,oAriaApplication.GetHeaderText("LANG_Records",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*  WAIT WINDOW 'Creating temp. Department file.' NOWAIT
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_Creating_temp_Department NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Creating_temp_Department,oAriaApplication.GetHeaderText("LANG_Creating_temp_Department",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
