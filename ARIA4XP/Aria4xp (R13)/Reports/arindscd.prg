...
#INCLUDE r:\aria4xp\reports\arindscd.h
...
*= lfOGMover(@laSource,@laTarget,LANG_USERS,.T.,'lfvUsers()')
= lfOGMover(@laSource,@laTarget,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_USERS,oAriaApplication.GetHeaderText("LANG_USERS",AHEADERFILE)),.T.,'lfvUsers()')
...
IF llNoData
  ...
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_NO_OPENED_ACTIVITIES TIMEOUT 2
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_NO_OPENED_ACTIVITIES,oAriaApplication.GetHeaderText("LANG_NO_OPENED_ACTIVITIES",AHEADERFILE)) TIMEOUT 2
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF ALEN(latarget) > 4 then
    ...
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*= gfModalGen('TRB00000','F',' ',' ',LANG_YOU_CANT)
= gfModalGen('TRB00000','F',' ',' ',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_YOU_CANT,oAriaApplication.GetHeaderText("LANG_YOU_CANT",AHEADERFILE)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcTitle = LANG_DUEDATERANGE
lcTitle = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DUEDATERANGE,oAriaApplication.GetHeaderText("LANG_DUEDATERANGE",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcTitle = LANG_COMPLETEDATERANGE
lcTitle = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_COMPLETEDATERANGE,oAriaApplication.GetHeaderText("LANG_COMPLETEDATERANGE",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
 ...
 *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_FROM_VALUE  NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FROM_VALUE,oAriaApplication.GetHeaderText("LANG_FROM_VALUE",AHEADERFILE))  NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
