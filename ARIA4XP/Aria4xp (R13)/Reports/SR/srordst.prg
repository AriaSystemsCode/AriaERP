...
#include r:\aria4xp\reports\SR\srordst.h
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = Lang_Salesrep_Statistics
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",Lang_Salesrep_Statistics,oAriaApplication.GetHeaderText("Lang_Salesrep_Statistics",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  SCAN FOR IIF(llUseCurr,SEEK(cCurrCode,lcCurFile),.T.)
    ...
    IF !FOUND()
      ...
      SCAN
        ...
        * N000862 ,1 Thabet Handle globalization issues [Start]
        *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW Lang_Processing_salesrep + XSALESREP +'...' NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",Lang_Processing_salesrep,oAriaApplication.GetHeaderText("Lang_Processing_salesrep",AHEADERFILE)) + XSALESREP +'...' NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
