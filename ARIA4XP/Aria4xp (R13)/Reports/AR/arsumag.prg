...
*: N000562
*:************************************************************************
#INCLUDE R:\Aria4xp\reports\ar\arsumag.H
...
*loOgScroll.laCRParams[1,2]= LANG_SUMMAGE
loOgScroll.laCRParams[1,2]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_SUMMAGE,oAriaApplication.GetHeaderText("LANG_SUMMAGE",AHEADERFILE))
