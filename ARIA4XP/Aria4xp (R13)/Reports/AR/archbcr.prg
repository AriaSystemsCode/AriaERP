...
*:************************************************************************
#INCLUDE R:\Aria4xp\reports\ar\archbcr.H
IF llOgFltCh
llDonprnt=.F.
lcFilter=' .T. '
...
*loOgScroll.laCRParams[1,2]= LANG_REPORT_NAME
loOgScroll.laCRParams[1,2]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_REPORT_NAME,oAriaApplication.GetHeaderText("LANG_REPORT_NAME",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]


loOgScroll.laCRParams[2,1] =  'LAYOUT'
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[2,2]= IIF(lcRpDS='S',LANG_SUMMARY,LANG_DETAIL)
loOgScroll.laCRParams[2,2]= IIF(lcRpDS='S',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_SUMMARY,oAriaApplication.GetHeaderText("LANG_SUMMARY",AHEADERFILE)),IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DETAIL,oAriaApplication.GetHeaderText("LANG_DETAIL",AHEADERFILE)))
*N000682,1 11/20/2012 MMT Globlization changes[End]


loOgScroll.laCRParams[3,1] =  'SORTBY'
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[3,2]= IIF(LCRPSRTCD='C',LANG_CUSTOMER,IIF(LCRPSRTCD='T',LANG_TRANS,LANG_DATE))
loOgScroll.laCRParams[3,2]= IIF(LCRPSRTCD='C',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_CUSTOMER,oAriaApplication.GetHeaderText("LANG_CUSTOMER",AHEADERFILE)),IIF(LCRPSRTCD='T',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_TRANS,oAriaApplication.GetHeaderText("LANG_TRANS",AHEADERFILE)),IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DATE,oAriaApplication.GetHeaderText("LANG_DATE",AHEADERFILE))))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF CTYPE='C'
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW Lang_SELECTING_OPEN_CREDITS NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",Lang_SELECTING_OPEN_CREDITS,oAriaApplication.GetHeaderText("Lang_SELECTING_OPEN_CREDITS",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
ELSE
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW Lang_SELECTING_CHARGE_BACKS NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",Lang_SELECTING_CHARGE_BACKS,oAriaApplication.GetHeaderText("Lang_SELECTING_CHARGE_BACKS",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
