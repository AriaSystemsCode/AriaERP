...
lcDatPrd =IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ARHIST_PERTO,oAriaApplication.GetHeaderText("LANG_ARHIST_PERTO",AHEADERFILE)) + SUBSTR(loOGScroll.laOGFxFlt[lnDatapos,6],lnSepPos+1,20)
...
lcDatPrd =IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ARHIST_PER,oAriaApplication.GetHeaderText("LANG_ARHIST_PER",AHEADERFILE)) + SUBSTR(loOGScroll.laOGFxFlt[lnDatapos,6],1,lnSepPos-1) + " - "+SUBSTR(loOGScroll.laOGFxFlt[lnDatapos,6],lnSepPos+1,20)
*N000682,1 11/20/2012 MMT Globlization changes[End]
