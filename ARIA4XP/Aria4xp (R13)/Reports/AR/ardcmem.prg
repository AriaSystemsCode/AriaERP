...
*: B610854,1 MMT 09/14/2014 Credit/Debit Memo report prints customer shipping address while it should print the billing address[T20140910.0024]
*:**********************************************************************
...
lcMessage = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ArDcmem_DebOnAcc,oAriaApplication.GetHeaderText("LANG_ArDcmem_DebOnAcc",AHEADERFILE))
...
lcMessage = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ArDcmem_Debit,oAriaApplication.GetHeaderText("LANG_ArDcmem_Debit",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
lcMessage = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ArDcmem_Credit,oAriaApplication.GetHeaderText("LANG_ArDcmem_Credit",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
lcMessage = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ArDcmem_DCOnAcc,oAriaApplication.GetHeaderText("LANG_ArDcmem_DCOnAcc",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ArDcmem_Slctd,oAriaApplication.GetHeaderText("LANG_ArDcmem_Slctd",AHEADERFILE)) + ALLTRIM(STR(RECCOUNT(lcWorkFile))) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ArDcmem_RecIn,oAriaApplication.GetHeaderText("LANG_ArDcmem_RecIn",AHEADERFILE)) + ALLTRIM(STR(lnInterval,6,2)) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ArDcmem_Sec,oAriaApplication.GetHeaderText("LANG_ArDcmem_Sec",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*	  laCompAdd[6] = LANG_ArDcmem_Phone + TRANSFORM(lcCompPhon , lcPhonPict)
	  *: B610854,1 MMT 09/14/2014 Credit/Debit Memo report prints customer shipping address while it should print the billing address[Start]
	  *laCompAdd[6] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ArDcmem_Phone,oAriaApplication.GetHeaderText("LANG_ArDcmem_Phone",AHEADERFILE)) + TRANSFORM(lcCompPhon , lcPhonPict)	  
	  laCompAdd[6] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ArDcmem_Phone,oAriaApplication.GetHeaderText("LANG_ArDcmem_Phone",AHEADERFILE)) + TRANSFORM(lcCompPhon ,  '@R ' + lcPhonPict)
	  *: B610854,1 MMT 09/14/2014 Credit/Debit Memo report prints customer shipping address while it should print the billing address[End]
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	  laCustAdd[5] = gfGetAdr('CUSTOMER' , '' , '' , '' , 5 )
  laCustAdd[1] = gfGetAdr('CUSTOMER' , '' , '' , '' , 1 ,'2')
  laCustAdd[2] = gfGetAdr('CUSTOMER' , '' , '' , '' , 2 ,'2')
  laCustAdd[3] = gfGetAdr('CUSTOMER' , '' , '' , '' , 3 ,'2')
  laCustAdd[4] = gfGetAdr('CUSTOMER' , '' , '' , '' , 4 ,'2')
  laCustAdd[5] = gfGetAdr('CUSTOMER' , '' , '' , '' , 5 ,'2')
  *: B610854,1 MMT 09/14/2014 Credit/Debit Memo report prints customer shipping address while it should print the billing address[End]
