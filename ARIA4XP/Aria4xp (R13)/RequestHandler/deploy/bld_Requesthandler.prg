...
EXE_FILE		  =		  	"Requesthandler"
DCOM_ProgId       =			"Requesthandler.RequesthandlerServer"
DCOM_UserId		  =			"Interactive User"

*** Server Update Urls - fix these to point at your production Server/Virtual
HTTP_UPLOADURL    =         "http://localhost/Requesthandler/UploadExe.wc"
HTTP_UPDATEURL 	  =         "http://localhost/Requesthandler/UpdateExe.wc"

*** for ISAPI use this url
* HTTP_UPLOADURL    =         "http://localhost/Requesthandler/wc.wc?wwmaint~FileUpload"
