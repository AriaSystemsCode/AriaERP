...
DO CASE
	...
	CASE lcSourceVarType=="C" AND NOT EMPTY(lvSource)
		DO CASE
		    CASE lcSourceFileExt=="txt"
		        lcHTMLClass="_HTMLText"
...
_oHTML= NEWOBJECT('_htmltext',lcHTMLVCX)
*_oHTML= NEWOBJECT('_htmltext','c:\sparia4xp\srvclss\sy\_html.vcx')
