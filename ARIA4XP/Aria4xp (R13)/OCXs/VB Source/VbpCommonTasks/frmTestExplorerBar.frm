...
Private Sub vbalExplorerBarCtl1_BarRightClick(bar As vbalExplorerBarLib.cExplorerBar)
...
Private Sub vbalExplorerBarCtl1_Highlight(bar As vbalExplorerBarLib.cExplorerBar, itm As vbalExplorerBarLib.cExplorerBarItem)
...
Private Sub vbalExplorerBarCtl1_ItemClick(itm As vbalExplorerBarLib.cExplorerBarItem)
   logEvent "ItemClick: " & itm.Key & " (" & itm.Text & ")"
End Sub

Private Sub vbalExplorerBarCtl1_ItemRightClick(itm As vbalExplorerBarLib.cExplorerBarItem)
