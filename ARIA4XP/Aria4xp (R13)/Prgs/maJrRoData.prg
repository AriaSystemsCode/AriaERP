...
*! B611238,1 MMT 12/28/2016 Material Inventory Locking screen does not zero out Rolls[T20161129.0003]
*:**************************************************************************
...
*! B611238,1 MMT 12/28/2016 Material Inventory Locking screen does not zero out Rolls[T20161129.0003][Start]
IF lcTrType$'28' AND laAdjQty[9] = 0 AND laOldStk[9] <> 0
   lnTotApply = -1 * laOldStk[9]
ENDIF
*! B611238,1 MMT 12/28/2016 Material Inventory Locking screen does not zero out Rolls[T20161129.0003][End]
...
IF (laAdjQty[9] < 0 OR (lcTrType$'28' AND laAdjQty[9] = 0)) AND llTrkRolls .AND. ITEM.ltrkrolls
*! B611238,1 MMT 12/28/2016 Material Inventory Locking screen does not zero out Rolls[T20161129.0003][End]
  SELECT (lcTmpRoll)
  PRIVATE lcTag
  lcTag = ORDER()
