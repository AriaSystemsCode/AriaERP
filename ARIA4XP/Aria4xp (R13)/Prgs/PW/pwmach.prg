...
SCAN
  ...
  GATHER MEMVAR MEMO
ENDSCAN
* E303299,1 Disable the fields if the calendar line related to a parent default calendar [Start]
=gfSeek(PEWCNTR.CPLANT_ID ,'PEPLANT')
=gfSeek(STR(PEPLANT.NCALID,10),'SCCALDTL')     
...
WITH loFormSet.Ariaform1.Ariapageframe1.Ariapage2.Calendar1
  ...
  ENDIF
ENDWITH    
* E303299,1 Disable the fields if the calendar line related to a parent default calendar [End  ]
