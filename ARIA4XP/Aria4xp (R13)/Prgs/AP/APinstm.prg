...
#INCLUDE R:\Aria4xp\PRgs\AP\APinstm.h
...
IF oAriaApplication.oActivelang.cLang_ID <> "EN"
  lcVENTrnsFH =  loFormSet.geta27fldheader('CVENDCODE')
  lcINVTrnsFH =  loFormSet.geta27fldheader('CINVNO')
  IF !EMPTY(lcINVTrnsFH) AND !EMPTY(lcVENTrnsFH)
    loFormSet.lcTKeyCode  = lcVENTrnsFH + '\' + lcINVTrnsFH  + ' : '
  ENDIF
ENDIF                        
*N000682,1 MMT 12/09/2012 Globalization changes[END]
*- initializations
    ...
    ELSE
      ...
      ELSE
        ...
        *=gfModalGen("TRM04042B00000","DIALOG","invoices|"+ALLTRIM(oVnd.Value))        
        =gfModalGen("TRM04042B00000","DIALOG",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_INVOICES,loformset.GetHeaderText("LANG_INVOICES",loformset.HeaderAlias))+"|"+ALLTRIM(oVnd.Value))
        *N000682,1 MMT 12/09/2012 Globalization changes[END]
      ENDIF
    ENDIF
...
*!B609890,1 SAB 04/17/2012 Fix Data Validation Problems [T20120304.0004][End]
  ...
  *=gfModalGen("TRM04072B00000","DIALOG",'The duration|zero')  
  =gfModalGen("TRM04072B00000","DIALOG",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DURATION,loformset.GetHeaderText("LANG_DURATION",loformset.HeaderAlias))+'|'+;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ZERO,loformset.GetHeaderText("LANG_ZERO",loformset.HeaderAlias)))
  *N000682,1 MMT 12/09/2012 Globalization changes[END]
  *laData[5] = lnOldVal
...
IF EMPTY(loFld.Value)
  ...
  *=gfModalGen("TRM04066B00000","DIALOG",'first installment date')  
  ...
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FIRSTINSTDATE,loformset.GetHeaderText("LANG_FIRSTINSTDATE",loformset.HeaderAlias)))
  *N000682,1 MMT 12/09/2012 Globalization changes[END]
  *laData[8] = ldOldVal
  loFld.Value = loFld.OldValue
  *_CUROBJ   = *_CUROBJ
...
IF EMPTY(loFld.Value)
  ...
  *=gfModalGen("TRM04066B00000","DIALOG",'next installment date')
  =gfModalGen("TRM04066B00000","DIALOG",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_NEXTINSTDATE,loformset.GetHeaderText("LANG_NEXTINSTDATE",loformset.HeaderAlias)))
  *N000682,1 MMT 12/09/2012 Globalization changes[END]
  *laData[9] = ldOldVal
  loFld.Value = loFld.OldValue
  *_CUROBJ   = *_CUROBJ
ELSE
  ...
  *!B609890,1 SAB 04/17/2012 Fix Data Validation Problems [T20120304.0004][End]
    ...
    *=gfModalGen("TRM04028B00000","DIALOG",'next installment|start installment')    
    ...
    IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_NEXTINST,loformset.GetHeaderText("LANG_NEXTINST",loformset.HeaderAlias))+'|'+;
    IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_STARTINST,loformset.GetHeaderText("LANG_STARTINST",loformset.HeaderAlias)))
    *N000682,1 MMT 12/09/2012 Globalization changes[END]
    *laData[9] = ldOldVal
    loFld.Value = loFld.OldValue
    *_CUROBJ   = *_CUROBJ
...
*!*	  'Installment '+IIF(o4.Value = 'P','percent','amount')+'|zero')
  =gfModalGen("TRM04072B00000","DIALOG",;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_INSTALL,loformset.GetHeaderText("LANG_INSTALL",loformset.HeaderAlias))+' '+IIF(o4.Value = 'P',;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_PERCENT,loformset.GetHeaderText("LANG_PERCENT",loformset.HeaderAlias)),;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_AMOUNT,loformset.GetHeaderText("LANG_AMOUNT",loformset.HeaderAlias)))+'|'+;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ZERO,loformset.GetHeaderText("LANG_ZERO",loformset.HeaderAlias)))
  *N000682,1 MMT 12/09/2012 Globalization changes[END]
  *laData[10]  = lnOldVal
  loFld.Value = loFld.OldValue
  ...
  ELSE
    ...
    *IF ( o10.Value * APINVHDR.nInvAmnt / 100 ) >  ;
       ( APINVHDR.nInvAmnt - (APINVHDR.NINVDISTK + ;
                              APINVHDR.NINVPAID + ;
                              APINVHDR.NINVADJ ))
    IF TYPE('o10.Value') == 'N' AND ((o10.Value * APINVHDR.nInvAmnt / 100 ) > (APINVHDR.nInvAmnt - (APINVHDR.NINVDISTK + APINVHDR.NINVPAID + APINVHDR.NINVADJ)))
    *!B609890,1 SAB 04/17/2012 Fix Data Validation Problems [T20120304.0004][End]
      ...
      *=gfModalGen("TRM04015B00000","DIALOG",'The installment|invoice')      
      ...
      IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_S_INSTALL,loformset.GetHeaderText("LANG_S_INSTALL",loformset.HeaderAlias))+'|'+;
      IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_S_INVOICE,loformset.GetHeaderText("LANG_S_INVOICE",loformset.HeaderAlias)))
      *N000682,1 MMT 12/09/2012 Globalization changes[END]
      *laData[10]  = lnOldVal
      o10.Value = o10.OldValue
      *_CUROBJ     = *_CUROBJ
...
ELSE
  ...
  *!B609890,1 SAB 04/17/2012 Fix Data Validation Problems [T20120304.0004][End]
    ...
    *N000682,1 MMT 12/09/2012 Globalization changes[Start]
    *=gfModalGen("TRM04015B00000","DIALOG",'The installment|invoice')    
    =gfModalGen("TRM04015B00000","DIALOG",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_S_INSTALL,loformset.GetHeaderText("LANG_S_INSTALL",loformset.HeaderAlias))+'|'+;
      IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_S_INVOICE,loformset.GetHeaderText("LANG_S_INVOICE",loformset.HeaderAlias)))
    *N000682,1 MMT 12/09/2012 Globalization changes[END]
    *laData[10]  = lnOldVal
    o10.Value = o10.OldValue
...
*!B609890,1 SAB 04/17/2012 Fix Data Validation Problems [T20120304.0004][End]
  ...
  *=gfModalGen("TRM04072B00000","DIALOG",'1099 Amount|zero')  
  =gfModalGen("TRM04072B00000","DIALOG",;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_1099AMOUNT,loformset.GetHeaderText("LANG_1099AMOUNT",loformset.HeaderAlias))+'|'+;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ZERO,loformset.GetHeaderText("LANG_ZERO",loformset.HeaderAlias)))
  *N000682,1 MMT 12/09/2012 Globalization changes[END]
  *laData[11]  = lnOldVal
  loFld.Value = loFld.OldValue
...
IF loFld.Value > o10.Value
  ...
  *=gfModalGen("TRM04015B00000","DIALOG",'The 1099|installment')  
  =gfModalGen("TRM04015B00000","DIALOG",;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_THE1099,loformset.GetHeaderText("LANG_THE1099",loformset.HeaderAlias))+'|'+;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_INSTALL,loformset.GetHeaderText("LANG_INSTALL",loformset.HeaderAlias)))
  *N000682,1 MMT 12/09/2012 Globalization changes[END]
  *laData[11]  = lnOldVal
  loFld.Value = loFld.OldValue
  *_CUROBJ     = *_CUROBJ
...
IF APINVHDR.cVenPMeth = 'H' AND EMPTY(STRTRAN(STRTRAN(o14.Value,'-'),'0'))
  ...
  *=gfModalGen("TRM04066B00000","DIALOG",'cash account')  
  =gfModalGen("TRM04066B00000","DIALOG",;
  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_CASHACC,loformset.GetHeaderText("LANG_CASHACC",loformset.HeaderAlias)))
  *N000682,1 MMT 12/09/2012 Globalization changes[END]
  llcSave = .F.
  ...
  *IF EMPTY(laData[12])
  IF EMPTY(o12.Value)
    ...
    *=gfModalGen("TRM04066B00000","DIALOG","the bank code")    
    =gfModalGen("TRM04066B00000","DIALOG",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_BANKCODE,loformset.GetHeaderText("LANG_BANKCODE",loformset.HeaderAlias)))
    *N000682,1 MMT 12/09/2012 Globalization changes[END]
    llcSave = .F.
  ...
  *IF !SEEK(laData[12],'APBANKS')
  IF !SEEK(o12.Value,'APBANKS')
    ...
    *=gfModalGen("TRM0400200000","DIALOG",'Bank code ' + ALLTRIM(o12.Value))    
    =gfModalGen("TRM0400200000","DIALOG",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_S_BANKCODE,loformset.GetHeaderText("LANG_S_BANKCODE",loformset.HeaderAlias))+;
    ' ' + ALLTRIM(o12.Value))
    *N000682,1 MMT 12/09/2012 Globalization changes[END]    
    llcSave = .F.
    *_CUROBJ = OBJNUM(laData[12])
  ...
  *IF !SEEK(laData[12]+ladata[13],'APCHECKS')
  IF !SEEK(o12.Value+o13.Value,'APCHECKS')
    ...
    *=gfModalGen("TRM04077B00000","DIALOG",'Checking')    
    =gfModalGen("TRM04077B00000","DIALOG",;
    IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_CHECKING,loformset.GetHeaderText("LANG_CHECKING",loformset.HeaderAlias)))
    *N000682,1 MMT 12/09/2012 Globalization changes[END]    
    llcSave = .F.
  ...
  *IF EMPTY(STRTRAN(laData[14],'-',' '))
  IF EMPTY(STRTRAN(o14.Value,'-',' '))
    ...
    *=gfModalGen("INM04066B00000","DIALOG",'G/L account')    
    =gfModalGen("INM04066B00000","DIALOG",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GLACCOUNT,loformset.GetHeaderText("LANG_GLACCOUNT",loformset.HeaderAlias)))
    *N000682,1 MMT 12/09/2012 Globalization changes[END]    
    llcSave = .F.
    *_CUROBJ = OBJNUM(laData[14])
    =lfReadInv(loFormSet)
    ...
    *IF llApGlLink .AND. ! SEEK(ALLTRIM(laData[14]),'lcLinkChar')
    IF loFormSet.ap1.llApGlLink .AND. ! SEEK(ALLTRIM(o14.Value),'lcLinkChar')
      ...
      *=gfModalGen("INM04002B00000","DIALOG","G/L account|"+ALLTRIM(o14.Value))      
      =gfModalGen("INM04002B00000","DIALOG",;
      IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GLACCOUNT,loformset.GetHeaderText("LANG_GLACCOUNT",loformset.HeaderAlias))+"|"+ALLTRIM(o14.Value))
      *N000682,1 MMT 12/09/2012 Globalization changes[END]    
      llcSave = .F.
      *_CUROBJ = OBJNUM(laData[14])
      =lfReadInv(loFormSet)
