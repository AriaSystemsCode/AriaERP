...
WITH loFormSet
  ...
  .cBrowseFilter          = ""
  .BrowseTitle            = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_INTERNATIONALS,loFormSet.GetHeaderText("LANG_INTERNATIONALS",loFormSet.HeaderAlias))
...
DO CASE
  CASE loFormSet.ActiveMode = 'S'  && Select Mode
    loFormSet.laData[3]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Part_1,loFormSet.GetHeaderText("LANG_Part_1",loFormSet.HeaderAlias))
    loFormSet.laData[4]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Part_2,loFormSet.GetHeaderText("LANG_Part_2",loFormSet.HeaderAlias))
    loFormSet.laData[5]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Part_3,loFormSet.GetHeaderText("LANG_Part_3",loFormSet.HeaderAlias))
    loFormSet.laData[6]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Part_4,loFormSet.GetHeaderText("LANG_Part_4",loFormSet.HeaderAlias))
    loFormSet.laData[7]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Part_5,loFormSet.GetHeaderText("LANG_Part_5",loFormSet.HeaderAlias))
    loFormSet.laData[8]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Part_6,loFormSet.GetHeaderText("LANG_Part_6",loFormSet.HeaderAlias))
...
CASE loFld.InputMask == '99'
  lcMsg =  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_RANGE_IS_1_30,loFormSet.GetHeaderText("LANG_RANGE_IS_1_30",loFormSet.HeaderAlias))
  lnLow = 1
  lnMax = 30
CASE loFld.InputMask == '9'
  lcMsg =  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_RANGE_IS_1_5,loFormSet.GetHeaderText("LANG_RANGE_IS_1_5",loFormSet.HeaderAlias))
  lnLow = 1
  lnMax = 5
ENDCASE 
...
IF FOUND() OR loFormSet.laData[1] = 'USA' OR loFormSet.laData[1] = 'ENG'
  ...
  *LANG_MSG2 'This Code is currently used by one or more company(s).'
  lcMsg1 = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MSG1,loFormSet.GetHeaderText("LANG_MSG1",loFormSet.HeaderAlias))
  lcMsg2 = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MSG2,loFormSet.GetHeaderText("LANG_MSG2",loFormSet.HeaderAlias))
  =gfModalGen('INM00242B00000','ALERT',IIF(loFormSet.laData[1]='USA' OR loFormSet.laData[1] = 'ENG',lcMsg1,lcMsg2))
    SELECT sycInt
    RETURN .F.
ELSE
  lcSavAlias=SELECT(0)
...
lcCentOn  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_CENT_ON,loFormSet.GetHeaderText("LANG_CENT_ON",loFormSet.HeaderAlias))
lcCentOff = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_CENT_OFF,loFormSet.GetHeaderText("LANG_CENT_OFF",loFormSet.HeaderAlias))
lcCent     = IIF(SET("CENTURY")="ON",lcCentOn ,lcCentOff )
