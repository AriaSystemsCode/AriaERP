...
*B610484,1 TMI 08/22/2013 allow to be called from the smClose.prg [T20130802.0008] 
*B610691,1 TMI 03/09/2014 make sure that the periods are changed according to the new choosen # of periods [T20140210.0048] 
*B610872,1 MMT 10/08/2014 Fiscal year screen gives error when selects company has parent company[T20141003.0010]
*:************************************************************************

*N000682,1 04/16/2013 HES Globlization changes[Start]
#INCLUDE R:\ARIA4XP\PRGS\SM\SMFSYER.H
...
*!*	  .puComp.DisplayValue = "Select Company"
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*.puComp.DisplayValue = LANG_Select_Company
.puComp.DisplayValue = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Select_Company,loFormSet.GetHeaderText("LANG_Select_Company",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF !EMPTY(loFormSet.pcComp_ID)
  ...
  *B610447,1 TMI 07/21/2013 [Start] 
  *IF SEEK(loFormSet.lcComp_ID,"SYCCOMP")
  IF SEEK(loFormSet.lcComp_ID,"SYCCOMP",'CCOMP_ID')    
...
*!*	  loFormSet.Ariaform1.puComp.DisplayValue = "Select Company"
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.Ariaform1.puComp.DisplayValue = LANG_Select_Company
loFormSet.Ariaform1.puComp.DisplayValue = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Select_Company,loFormSet.GetHeaderText("LANG_Select_Company",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*B610484,1 TMI 08/22/2013 [Start] select the View  when the screen is called from Year closing process
IF TYPE('llCloseYer')='L'
  loFormset.Ariaform1.pbHoliDay.Visible = .F.
  SELECT fishd
  GO bottom
  SKIP -1
...
ELSE   
  ...
  *B610484,1 TMI 08/26/2013 [Start] close 
ENDIF
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laTStat[1,1] = LANG_National
loFormSet.laTStat[1,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_National,loFormSet.GetHeaderText("LANG_National",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laTStat[2,1] = LANG_State
loFormSet.laTStat[2,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_State,loFormSet.GetHeaderText("LANG_State",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laTStat[3,1] = LANG_Company
loFormSet.laTStat[3,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Company,loFormSet.GetHeaderText("LANG_Company",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laTStat[4,1] = LANG_Local
loFormSet.laTStat[4,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Local,loFormSet.GetHeaderText("LANG_Local",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]


*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laTYears[1] = LANG_Previous
loFormSet.laTYears[1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Previous,loFormSet.GetHeaderText("LANG_Previous",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laTYears[2] = LANG_Current
loFormSet.laTYears[2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Current,loFormSet.GetHeaderText("LANG_Current",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laTYears[3] = LANG_Next
loFormSet.laTYears[3] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Next,loFormSet.GetHeaderText("LANG_Next",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laTYears[4] = LANG_History
loFormSet.laTYears[4] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_History,loFormSet.GetHeaderText("LANG_History",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.AddProperty('puComp'     , LANG_Select_Company     )
loFormSet.AddProperty('puComp'     , IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Select_Company,loFormSet.GetHeaderText("LANG_Select_Company",loFormSet.HeaderAlias))     )
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF loFormSet.llComIdFlg
  ...
  *B610447,1 TMI 21/07/2013 [Start] 
  *IF SEEK(loFormSet.lcComp_ID,"SYCCOMP")
  IF SEEK(loFormSet.lcComp_ID,"SYCCOMP",'CCOMP_ID')
    *B610447,1 TMI 21/07/2013 [End  ] 
    loFormSet.puComp = SYCCOMP.cComp_Id+" "+SYCCOMP.cCom_Name
    loFormSet.Ariaform1.Refresh()
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*IF loFld.DisplayValue == LANG_Select_Company OR loFld.Value == loFld.OldValue
IF loFld.DisplayValue == IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Select_Company,loFormSet.GetHeaderText("LANG_Select_Company",loFormSet.HeaderAlias)) OR loFld.Value == loFld.OldValue
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF !EMPTY(loFormSet.lcComp_Id)
  *B610872,1 MMT 10/08/2014 Fiscal year screen gives error when selects company has parent company[T20141003.0010][Start]
  SELECT SYCCOMP
  lcOldFilter = SET("Filter") 
  SET FILTER TO 
  *B610872,1 MMT 10/08/2014 Fiscal year screen gives error when selects company has parent company[T20141003.0010][End]
...
gcWorkDir = oAriaApplication.WorkDir
*B610447,1 TMI 07/21/2013 [Start] 
loFormSet.laData[2] = loFld.Value
*B610447,1 TMI 07/21/2013 [End  ] 
IF !EMPTY(loFormSet.laData[2])
  IF EMPTY(loFormSet.lcComp_ID)
...
*!*	          loFormSet.laData[8] = 'Fis. year '+loFormSet.laData[2]
          *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laData[8] = LANG_Fis_year+loFormSet.laData[2]
loFormSet.laData[8] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Fis_year,loFormSet.GetHeaderText("LANG_Fis_year",loFormSet.HeaderAlias))+loFormSet.laData[2]
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	              DTOC(loFormSet.laData[6]) +'-' +DTOC(loFormSet.laData[7]) + ')'
          loFormSet.laData[9] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Fiscal_year,loFormSet.GetHeaderText("LANG_Fiscal_year",loFormSet.HeaderAlias))+loFormSet.laData[2]+ SPACE(1) + '(' + ;
              DTOC(loFormSet.laData[6]) +'-' +DTOC(loFormSet.laData[7]) + ')'
          *N000682,1 04/17/2013 RAS Globalization[End  ]
...
*B610447,1 TMI 07/21/2013 [Start] disable company combobox in case of modal show
if !EMPTY(loFormSet.pcComp_ID)
  loFormset.Ariaform1.puComp.Enabled = .F.
endif 
*B610447,1 TMI 07/21/2013 [End  ] 
...
*B610691,1 TMI 03/09/2014 20:29 [Start] check value is changed 
...
IF loFld.Value == loFld.OldValue
  RETURN 
ENDIF 
*B610691,1 TMI 03/09/2014 20:29 [End  ] 
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.lcFldNm  = LANG_No_of_periods
loFormSet.lcFldNm  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_No_of_periods,loFormSet.GetHeaderText("LANG_No_of_periods",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.lcFldNm = LANG_Start_date
loFormSet.lcFldNm = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Start_date,loFormSet.GetHeaderText("LANG_Start_date",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.lcYer   = ALLTRIM(loFormSet.laData[2]) + LANG_or + ALLTRIM(STR(VAL(loFormSet.laData[2])-1))
loFormSet.lcYer   = ALLTRIM(loFormSet.laData[2]) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_or,loFormSet.GetHeaderText("LANG_or",loFormSet.HeaderAlias)) + ALLTRIM(STR(VAL(loFormSet.laData[2])-1))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.lcFldNm = LANG_End_date
loFormSet.lcFldNm = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_End_date,loFormSet.GetHeaderText("LANG_End_date",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*B610691,1 TMI 03/09/2014 22:37 [Start] 
LOCAL lnSlct
lnSlct = SELECT(0)
llCSave = .T.
*B610691,1 TMI 03/09/2014 22:37 [End  ] 
...
IF loFormSet.ActiveMode = 'A'             && Add mode
  ...
  DO WHILE  !loFormSet.llAcptPrd
    ...
    *** <  Ok  > - <  Cancel  > ***
    ...
    ENDIF
  ENDDO
  *B610691,1 TMI 03/09/2014 21:48 [Start] case of 'E'
ELSE
  
  SELECT (loFormSet.lc_TempPR)
  LOCATE
  SCAN 
    IF EMPTY(CFSPPRDID ) OR EMPTY(CFSPPDESC ) OR EMPTY(DFSPPBGDT ) OR EMPTY(DFSPPENDT )       
      =gfModalGen('INM00000B00000',.F.,.F.,.F.,'Missing periods data, can not save.')
      llCSave = .F.
      EXIT 
    ENDIF 
  ENDSCAN 
  *B610691,1 TMI 03/09/2014 21:48 [End  ] 
...
*!*	                "Save all the holidays for the current year...")
    =gfTmp2Mast('FSHLD',lc_TempHd,;
IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Save_all_the_holidays_for_the_current_year,loFormSet.GetHeaderText("LANG_Save_all_the_holidays_for_the_current_year",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
ELSE
  ...
  *B610691,1 TMI 03/09/2014 22:46 [Start] 
  lcSvDelStat = SET("Deleted")
  SET DELETED OFF 
  *B610691,1 TMI 03/09/2014 22:46 [End  ] 
...
*!*	                "Save periods for "+loFormSet.Ariaform1.lcFisDes.Value+" year..")
   *B610691,1 TMI 03/09/2014 22:54 [Start] 
   SELECT (loFormSet.lc_TempPr)
   SCAN FOR cSTATUS = 'D'
     lnRec = nrecno
     SELECT fsprd
     ...
     DELETE 
   ENDSCAN 
   *B610691,1 TMI 03/09/2014 22:47 [Start] 
   SET DELETED &lcSvDelStat
   SELECT (loFormSet.lc_TempPr)
   BLANK FOR DELETED()
   *B610691,1 TMI 03/09/2014 22:47 [End  ] 

    
    =gfTmp2Mast('FSPRD',loFormSet.lc_TempPr,;
IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Save_periods_for,loFormSet.GetHeaderText("LANG_Save_periods_for",loFormSet.HeaderAlias))+loFormSet.Ariaform1.lcFisDes.Value+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_year,loFormSet.GetHeaderText("LANG_year",loFormSet.HeaderAlias)) )
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF !SEEK(loBranFormSet.Ariaform1.lcComID.Value,'SYCCOMP','CCOMP_ID') OR loBranFormSet.Ariaform1.lcComID.Value = loFormSet.lcComp_ID = loBranFormSet.Ariaform1.lcComID.Value
  *B610447,1 TMI 07/21/2013 [End  ] 
  SELECT syccomp
...
*!*	    lcBrFields  = "cComp_id :H='Company ID',cFisfyear :H='Fiscal Year',cFisystat :H='Fiscal State'"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcBrFields  = "cComp_id :H=LANG_Company_ID,cFisfyear :H=LANG_Fiscal_year,cFisystat :H=LANG_Fiscal_State"
lcBrFields  = "cComp_id :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Company_ID,loFormSet.GetHeaderText("LANG_Company_ID",loFormSet.HeaderAlias))+"',cFisfyear :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Fiscal_year,loFormSet.GetHeaderText("LANG_Fiscal_year",loFormSet.HeaderAlias))+"',cFisystat :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Fiscal_State,loFormSet.GetHeaderText("LANG_Fiscal_State",loFormSet.HeaderAlias))+"'"
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	    lcFile_ttl  = "Fiscal Year Information"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcFile_ttl  = LANG_Fiscal_Year_Information
lcFile_ttl  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Fiscal_Year_Information,loFormSet.GetHeaderText("LANG_Fiscal_Year_Information",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF SEEK(loBranFormSet.Ariaform1.lcComID.Value,"SYCCOMP",'CCOMP_ID')
  *B610447,1 TMI 07/21/2013 [End  ] 
...
=SEEK(loFormSet.lcComp_ID,'syccomp','CCOMP_ID')  
*B610447,1 TMI 07/21/2013 [End  ] 
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*laYears[1] = LANG_Previous
laYears[1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Previous,loFormSet.GetHeaderText("LANG_Previous",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*laYears[2] = LANG_Current
laYears[2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Current,loFormSet.GetHeaderText("LANG_Current",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*laYears[3] = LANG_Next
laYears[3] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Next,loFormSet.GetHeaderText("LANG_Next",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	            DTOC(ldBegin) +'-' +DTOC(ldEnd) + ')'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laData[8] = LANG_Fis_year + ALLTRIM(STR(lnYear))
loFormSet.laData[8] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Fis_year,loFormSet.GetHeaderText("LANG_Fis_year",loFormSet.HeaderAlias)) + ALLTRIM(STR(lnYear))
*N000682,1 11/20/2012 MMT Globlization changes[End]


    loFormSet.laData[9] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Fiscal_year,loFormSet.GetHeaderText("LANG_Fiscal_year",loFormSet.HeaderAlias))+ALLTRIM(STR(lnYear))+ SPACE(1) + '(' + ;
                DTOC(ldBegin) +'-' +DTOC(ldEnd) + ')'
  *N000682,1 04/17/2013 RAS Globalization[End  ]
  ELSE
  ...
  APPEND BLANK
    lcScFields = loFormSet.lcScFields
    GATHER FROM loFormSet.laData FIELDS &lcScFields MEMO
  *B610447,1 TMI 07/22/2013 [Start] 
  *=gfAdd_Info()
  =gfAdd_Info(alias())
...
*!*	              "Save periods for "+laYears[lnCount]+" year...")
 =gfTmp2Mast('FSPRD',lcPrdTpFil,;
IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Save_periods_for,loFormSet.GetHeaderText("LANG_Save_periods_for",loFormSet.HeaderAlias))+laYears[lnCount]+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_year,loFormSet.GetHeaderText("LANG_year",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*  .Caption = 'Holidays'
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*.Caption =LANG_SMFSYER_HOLIDAYS
.Caption =IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_SMFSYER_HOLIDAYS,loFormSet.GetHeaderText("LANG_SMFSYER_HOLIDAYS",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	  lcMsg = 'this is just a version to allow the smcminf.prg to work, the smfsyer screen should be developed separately'
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcMsg = LANG_this_is_just_a_version_to_allow_the_smcminf_prg
lcMsg = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_this_is_just_a_version_to_allow_the_smcminf_prg,loFormSet.GetHeaderText("LANG_this_is_just_a_version_to_allow_the_smcminf_prg",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	  laMonth[12] = 'December  '
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[1]  = LANG_January
laMonth[1]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_January,loFormSet.GetHeaderText("LANG_January",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[2]  = LANG_February
laMonth[2]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_February,loFormSet.GetHeaderText("LANG_February",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[3]  = LANG_March
laMonth[3]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_March,loFormSet.GetHeaderText("LANG_March",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[4]  = LANG_April
laMonth[4]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_April,loFormSet.GetHeaderText("LANG_April",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[5]  = LANG_May
laMonth[5]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_May,loFormSet.GetHeaderText("LANG_May",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[6]  = LANG_June
laMonth[6]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_June,loFormSet.GetHeaderText("LANG_June",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[7]  = LANG_July
laMonth[7]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_July,loFormSet.GetHeaderText("LANG_July",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[8]  = LANG_August
laMonth[8]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_August,loFormSet.GetHeaderText("LANG_August",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[9]  = LANG_September
laMonth[9]  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_September,loFormSet.GetHeaderText("LANG_September",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[10] = LANG_October
laMonth[10] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_October,loFormSet.GetHeaderText("LANG_October",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[11] = LANG_November
laMonth[11] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_November,loFormSet.GetHeaderText("LANG_November",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laMonth[12] = LANG_December
laMonth[12] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_December,loFormSet.GetHeaderText("LANG_December",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	            DFISENDAT WITH  DATE(YEAR(DATE())+i,12,31)
    REPLACE CFISFYEAR WITH STR(YEAR(DATE())+i,4) ,;
            CFISYSTAT WITH SUBSTR(lcStat,i+2,1) ,;
            CFISNOPRD WITH '12' ,;
            CFISLHEAD WITH  ' '+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Fiscal_year,loFormSet.GetHeaderText("LANG_Fiscal_year",loFormSet.HeaderAlias))+ STR(YEAR(DATE())+i,4),;
            CFISSHEAD WITH  CFISLHEAD ,;
            CFISNONWD WITH  '67     ',;
            DFISBGDAT WITH  DATE(YEAR(DATE())+i,1,1) ,;
            DFISENDAT WITH  DATE(YEAR(DATE())+i,12,31)
