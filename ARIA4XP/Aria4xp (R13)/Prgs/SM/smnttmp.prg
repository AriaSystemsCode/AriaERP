...
#INCLUDE R:\ARIA4XP\PRGS\SM\smnttmp.H
...
*loFormSet.lcBrow_Ttl = IIF(loFormSet.lcKeyType = 'T',LANG_Templates,LANG_GP_Letter)
loFormSet.lcBrow_Ttl = IIF(loFormSet.lcKeyType = 'T',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Templates,loFormSet.GetHeaderText("LANG_Templates",loFormSet.HeaderAlias)),IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GP_Letter,loFormSet.GetHeaderText("LANG_GP_Letter",loFormSet.HeaderAlias)))
...
*!*	    loFormSet.lcWindTitl = 'Notepad Templates'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.lcWindTitl = LANG_Notepad_Templates
loFormSet.lcWindTitl = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Notepad_Templates,loFormSet.GetHeaderText("LANG_Notepad_Templates",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	    loFormSet.lcWindTitl = 'Customer General Purpose Letters'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.lcWindTitl = LANG_customer_GPL
loFormSet.lcWindTitl = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_customer_GPL,loFormSet.GetHeaderText("LANG_customer_GPL",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	    loFormSet.lcWindTitl = 'Vendor General Purpose Letters'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.lcWindTitl = LANG_Vendor_GPL
loFormSet.lcWindTitl = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Vendor_GPL,loFormSet.GetHeaderText("LANG_Vendor_GPL",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lfSetColumnsProp('1',"&lcNotTmpFl..Key",LANG_Template     ,200 ,oGrd)
lfSetColumnsProp('1',"&lcNotTmpFl..Key",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Template,loFormSet.GetHeaderText("LANG_Template",loFormSet.HeaderAlias))     ,200 ,oGrd)
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lfSetColumnsProp('2',"&lcNotTmpFl..cDesc",LANG_Description,300 ,oGrd)
lfSetColumnsProp('2',"&lcNotTmpFl..cDesc",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Description,loFormSet.GetHeaderText("LANG_Description",loFormSet.HeaderAlias)),300 ,oGrd)
*N000682,1 11/20/2012 MMT Globlization changes[End]
