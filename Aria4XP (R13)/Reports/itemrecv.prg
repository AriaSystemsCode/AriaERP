...
*: B611069,1 MMT 10/26/2015 PO receipt log gives error while 2nd preview when style selected[T20151016.0005]
*:***************************************************************************
...
IF llStyle OR llStyGr OR llComp
  ...
  *--Craete the SQl Style Temp Cursor
  ...
  ENDIF
ENDIF
*: B611069,1 MMT 10/26/2015 PO receipt log gives error while 2nd preview when style selected[T20151016.0005][Start]
*!*	IF TYPE("lcOptStyle") = 'C' AND USED(lcOptStyle)
*!*	  USE IN (lcOptStyle)
*!*	ENDIF
*: B611069,1 MMT 10/26/2015 PO receipt log gives error while 2nd preview when style selected[T20151016.0005][End]
IF USED(lcTempSty)
  USE IN (lcTempSty)
ENDIF
