...
lcSeason   = lcStyMajor + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_AutoAlloc_Season,oAriaApplication.GetHeaderText("LANG_AutoAlloc_Season",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcDivision = lcStyMajor + LANG_AutoAlloc_Division
lcDivision = lcStyMajor + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_AutoAlloc_Division,oAriaApplication.GetHeaderText("LANG_AutoAlloc_Division",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcStyGroup = lcStyMajor + LANG_AutoAlloc_Group
lcStyGroup = lcStyMajor + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_AutoAlloc_Group,oAriaApplication.GetHeaderText("LANG_AutoAlloc_Group",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcFabTlt   = lcStyMajor + LANG_AutoAlloc_FabricCode
lcFabTlt   = lcStyMajor + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_AutoAlloc_FabricCode,oAriaApplication.GetHeaderText("LANG_AutoAlloc_FabricCode",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcPatTlt   = lcStyMajor + LANG_AutoAlloc_Pattern
lcPatTlt   = lcStyMajor + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_AutoAlloc_Pattern,oAriaApplication.GetHeaderText("LANG_AutoAlloc_Pattern",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
lcColorTlt = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_AUTOALLOC_COLROTITL1,oAriaApplication.GetHeaderText("LANG_AUTOALLOC_COLROTITL1",AHEADERFILE)) + ALLTRIM(lcNonMajTl) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_AUTOALLOC_COLROTITL2,oAriaApplication.GetHeaderText("LANG_AUTOALLOC_COLROTITL2",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
