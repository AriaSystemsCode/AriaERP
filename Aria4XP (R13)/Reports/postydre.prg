...
*! E303643,1 AEG 02/04/2016 Add available date to PO order detail report[T20150116.0001]
*! E303660,1 MMT 04/12/2016 Add Season Code to Field list exported to Excel in PO detail report[T20160303.0014]
*! B611155,1 MMT 06/16/2016 Purchase order detail report does not filter by line location[T20160608.0017]
*! B611515,1 HMS 1-22-2018  Style Purchase Order Detail Report - using Availab... (Sharon Young, Inc) [T20180117.0010 ][Begin]
*! B611572,1 HMS 5/20/2018  Aria 5 - Duplicate Quantities (Active Apparel Inc.)[T20180501.0012]
*! B612593,1 MMT 07/05/2022 Complete date is printed correctly in Form B and D[T20220628.0001]
*:*******************************************************************************************************
#INclude r:\aria4xp\reports\postydre.h
...
*        lcSQLFabric = loOgScroll.gfSQLTempName('','Fabric C(19)',lcTemp,'Style') && SQL Temp File
  ...
  *E303643,1 AEG 02/04/2016 Add available date to PO order detail report[T20151118.0004][Start]
  * Get Available Filter
  
  * B611515 , HMS, 1-22-2018  Style Purchase Order Detail Report - using Availab... (Sharon Young, Inc) [T20180117.0010 ][Begin]
    *lcCurName = lfCheckFilter(1, 'POSHDR.AVAILABLE')
     lcCurName = lfCheckFilter(1, 'POSHDR.available')
  * B611515 , HMS, 1-22-2018  Style Purchase Order Detail Report - using Availab... (Sharon Young, Inc) [T20180117.0010 ][End]
  IF !EMPTY(lcCurName)
    lcCon = lcCurName
    lcCon = STRTRAN(lcCon,"|","' and '")
    lcWhereCon = lcWhereCon + " AND POSHDR.available Between '" + lcCon + "'"
  ENDIF
   *E303643,1 AEG 02/04/2016 Add available date to PO order detail report[T20151118.0004][End]
 ...
 *E303643,1 AEG 02/04/2016 Add available date to PO order detail report[T20151118.0004][End]
  ...
  *! E303660,1 MMT 04/12/2016 Add Season Code to Field list exported to Excel in PO detail report[T20160303.0014][Start]
  IF oAriaApplication.ActiveModuleID='PO' 
    lcFields = lcFields + ",POSHDR.[Season]"
  ENDIF
  *! E303660,1 MMT 04/12/2016 Add Season Code to Field list exported to Excel in PO detail report[T20160303.0014][End]
  *! B608101,1 MMT 05/28/2007 Fix bug of Complete date '01/01/1900'    [Start]
  *B612593,1 MMT 07/05/2022 Complete date is printed correctly in Form B and D[T20220628.0001][Start]
  *IF oAriaApplication.ActiveModuleID='MA'
  *B612593,1 MMT 07/05/2022 Complete date is printed correctly in Form B and D[T20220628.0001][End]
 ...
 *! B611572,1 HMS 5/20/2018  Aria 5 - Duplicate Quantities (Active Apparel Inc.)[T20180501.0012][Begin]
...
*!*	           " Left Outer Join UOM UOM on POSLN.cUOMCODE = UOM.cUOMCode "
    lcJoin = " POSHDR POSHDR (index=POSHDR) Inner "+;
           "join POSLN POSLN (index=POSLN) on POSHDR.CBUSDOCU = POSLN.CBUSDOCU and "+;
           "POSHDR.CSTYTYPE = POSLN.CSTYTYPE and "+;
           "POSHDR.PO = POSLN.PO Left Outer join SHPMTHDR SHPMTHDR on POSLN.SHIPNO = SHPMTHDR.SHIPNO  and SHPMTHDR.SHIPNO  <>'' "+;
           " Left Outer Join UOM UOM on POSLN.cUOMCODE = UOM.cUOMCode "       
 ...
 *! B611572,1 HMS 5/20/2018  Aria 5 - Duplicate Quantities (Active Apparel Inc.)[T20180501.0012][Begin]
  ...
  *-IF oAriaApplication.ActiveModuleID='MA' AND (lcRPFormat = 'PODTLC' OR lcRPFormat = 'PODTLD')
  ...
  IF llLocation
    *! B611155,1 MMT 06/16/2016 Purchase order detail report does not filter by line location[T20160608.0017][START]
    *lcJoin = lcJoin+" inner join "+lcSQLLocation+" TmpLoc on TmpLoc.Location=POSHDR.cWareCode "
    lcJoin = lcJoin+" inner join "+lcSQLLocation+" TmpLoc ON (TmpLoc.Location=POSHDR.cWareCode or TmpLoc.Location=POSLN.cWareCode) "
    *! B611155,1 MMT 06/16/2016 Purchase order detail report does not filter by line location[T20160608.0017][End]
  ENDIF
  ...
  *N000682,1 MMT 03/17/2013 Fix issues of Globalization Testing Phase#2[End]
  ...
  IF oAriaApplication.ActiveModuleID = 'PO'
    ...
    SCAN	
      ...
      *! E303660,1 MMT 04/12/2016 Add Season Code to Field list exported to Excel in PO detail report[T20160303.0014][Start]
      REPLACE &lcRPHDRTmp..Season with Style.Season
      *! E303660,1 MMT 04/12/2016 Add Season Code to Field list exported to Excel in PO detail report[T20160303.0014][End]
    ENDSCAN
  ENDIF
...
*	  loOgScroll.laCRParams[1,2] = LANG_FORMAT_A_DETAILED
	  loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FORMAT_A_DETAILED,oAriaApplication.GetHeaderText("LANG_FORMAT_A_DETAILED",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  ELSE
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*	  loOgScroll.laCRParams[1,2] = LANG_FORMAT_A_SUMMARY
	  loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FORMAT_A_SUMMARY,oAriaApplication.GetHeaderText("LANG_FORMAT_A_SUMMARY",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
ELSE
  IF lcRPFormat = 'PODTLB'  	
    IF lcRPSumDet = 'D'
      *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = LANG_FORMAT_B_DETAILED
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FORMAT_B_DETAILED,oAriaApplication.GetHeaderText("LANG_FORMAT_B_DETAILED",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    ELSE
      *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = LANG_FORMAT_B_SUMMARY
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FORMAT_B_SUMMARY,oAriaApplication.GetHeaderText("LANG_FORMAT_B_SUMMARY",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  ELSE
      ...
      IF lcRPSumDet = 'D'
        *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = LANG_FORMAT_C_DETAILED
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FORMAT_C_DETAILED,oAriaApplication.GetHeaderText("LANG_FORMAT_C_DETAILED",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

      ELSE
        *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = LANG_FORMAT_C_SUMMARY
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FORMAT_C_SUMMARY,oAriaApplication.GetHeaderText("LANG_FORMAT_C_SUMMARY",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
      ...
      IF lcRPSumDet = 'D'
        *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = LANG_FORMAT_D_DETAILED
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FORMAT_D_DETAILED,oAriaApplication.GetHeaderText("LANG_FORMAT_D_DETAILED",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

      ELSE
        *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] = LANG_FORMAT_D_SUMMARY
loOgScroll.laCRParams[1,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_FORMAT_D_SUMMARY,oAriaApplication.GetHeaderText("LANG_FORMAT_D_SUMMARY",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*  loOgScroll.laCRParams[6,2] = 'Style Purchase Order Detail'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[6,2] = LANG_STYLE_PURCHASE_ORDER_DETAIL
loOgScroll.laCRParams[6,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_STYLE_PURCHASE_ORDER_DETAIL,oAriaApplication.GetHeaderText("LANG_STYLE_PURCHASE_ORDER_DETAIL",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*  loOgScroll.laCRParams[6,2] = 'Material Purchase Order Detail'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[6,2] = LANG_MATERIAL_PURCHASE_ORDER_DETAIL
loOgScroll.laCRParams[6,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MATERIAL_PURCHASE_ORDER_DETAIL,oAriaApplication.GetHeaderText("LANG_MATERIAL_PURCHASE_ORDER_DETAIL",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
DO CASE
  ...
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[7,2] = LANG_PO_NUMBER
loOgScroll.laCRParams[7,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_PO_NUMBER,oAriaApplication.GetHeaderText("LANG_PO_NUMBER",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
 ...
 *  loOgScroll.laCRParams[7,2] = 'Style'
      *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[7,2] = LANG_STYLE
loOgScroll.laCRParams[7,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_STYLE,oAriaApplication.GetHeaderText("LANG_STYLE",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*   loOgScroll.laCRParams[7,2] = 'Vendor'
      *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[7,2] = LANG_VENDOR
loOgScroll.laCRParams[7,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_VENDOR,oAriaApplication.GetHeaderText("LANG_VENDOR",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*   loOgScroll.laCRParams[7,2] = 'Color'
      *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[7,2] = LANG_COLOR
loOgScroll.laCRParams[7,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_COLOR,oAriaApplication.GetHeaderText("LANG_COLOR",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*   loOgScroll.laCRParams[7,2] = 'Department'
      *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[7,2] = LANG_DEPARTMENT
loOgScroll.laCRParams[7,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DEPARTMENT,oAriaApplication.GetHeaderText("LANG_DEPARTMENT",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*   loOgScroll.laCRParams[7,2] = 'Complete Date'
      *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[7,2] = LANG_COMPLETE_DATE
loOgScroll.laCRParams[7,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_COMPLETE_DATE,oAriaApplication.GetHeaderText("LANG_COMPLETE_DATE",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	    laSortItem[6]= 'Department'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laSortItem[1]= LANG_PO_NUMBER
laSortItem[1]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_PO_NUMBER,oAriaApplication.GetHeaderText("LANG_PO_NUMBER",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laSortItem[2]= LANG_STYLE
laSortItem[2]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_STYLE,oAriaApplication.GetHeaderText("LANG_STYLE",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laSortItem[3]= LANG_VENDOR
laSortItem[3]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_VENDOR,oAriaApplication.GetHeaderText("LANG_VENDOR",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laSortItem[4]= LANG_COMPLETE_DATE
laSortItem[4]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_COMPLETE_DATE,oAriaApplication.GetHeaderText("LANG_COMPLETE_DATE",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laSortItem[5]= LANG_COLOR
laSortItem[5]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_COLOR,oAriaApplication.GetHeaderText("LANG_COLOR",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laSortItem[6]= LANG_DEPARTMENT
laSortItem[6]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DEPARTMENT,oAriaApplication.GetHeaderText("LANG_DEPARTMENT",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[End]
    ...
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laSortItem[2]= LANG_ITEM
laSortItem[2]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ITEM,oAriaApplication.GetHeaderText("LANG_ITEM",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laSortItem[2]=LANG_VENDOR
laSortItem[2]=IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_VENDOR,oAriaApplication.GetHeaderText("LANG_VENDOR",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*laSortItem[3]=LANG_COMPLETE_DATE
laSortItem[3]=IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_COMPLETE_DATE,oAriaApplication.GetHeaderText("LANG_COMPLETE_DATE",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
