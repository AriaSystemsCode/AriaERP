...
#include R:\aria4xp\Reports\IC\icsclrt.h
...
*lcScaleHd = LANG_ONEDIME
lcScaleHd = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ONEDIME,oAriaApplication.GetHeaderText("LANG_ONEDIME",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

ELSE
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcScaleHd = IIF(ScaleHd.nnoofdim=2,LANG_TWO+' ',LANG_THREE+' ') + LANG_DIMES
lcScaleHd = IIF(ScaleHd.nnoofdim=2,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_TWO,oAriaApplication.GetHeaderText("LANG_TWO",AHEADERFILE))+' ',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_THREE,oAriaApplication.GetHeaderText("LANG_THREE",AHEADERFILE))+' ') + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DIMES,oAriaApplication.GetHeaderText("LANG_DIMES",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
