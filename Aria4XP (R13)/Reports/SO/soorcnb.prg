...
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_PRINTING,oAriaApplication.GetHeaderText("LANG_PRINTING",AHEADERFILE)) NOWAIT
...
IF lcMulti = 'Y'
  IF !EMPTY(CUSTOMER.DIST_CTR)
    ...
    *lcDCStore = lcStore + ' DC:' + Customer.Store
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcDCStore = lcStore + LANG_DC + Customer.Store
lcDCStore = lcStore + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DC,oAriaApplication.GetHeaderText("LANG_DC",AHEADERFILE)) + Customer.Store
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
loOgScroll.laCRParams[1,2]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ORDER_CONFIRMATION,oAriaApplication.GetHeaderText("LANG_ORDER_CONFIRMATION",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
