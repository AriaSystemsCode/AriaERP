...
#INCLUDE R:\aria4xp\reports\ap\ap1099f.h
...
*=lfUnLokRec(gfModalGen("QRM40169B00006","DIALOG",LANG_CLEAR))
=lfUnLokRec(gfModalGen("QRM40169B00006","DIALOG",IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_CLEAR,oAriaApplication.GetHeaderText("LANG_CLEAR",AHEADERFILE))))
