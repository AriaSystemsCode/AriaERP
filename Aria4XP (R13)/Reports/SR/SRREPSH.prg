...
*:***************************************************************************
#Include R:\aria4xp\reports\SR\SRREPSH.h
IF llOgFltCh
llDonprnt=.F.
...
*WAIT WINDOW LANG_Sales_commissiom + XSALESREP NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Sales_commissiom,oAriaApplication.GetHeaderText("LANG_Sales_commissiom",AHEADERFILE)) + XSALESREP NOWAIT
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2]= LANG_Salesrep_Commission_Worksheet
loOgScroll.laCRParams[1,2]= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Salesrep_Commission_Worksheet,oAriaApplication.GetHeaderText("LANG_Salesrep_Commission_Worksheet",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
DO CASE
  CASE lcRpSortBy = 'C'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[2,2] = LANG_Cust_PO
loOgScroll.laCRParams[2,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Cust_PO,oAriaApplication.GetHeaderText("LANG_Cust_PO",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  CASE lcRpSortBy = 'O'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[2,2] = LANG_ORDER
loOgScroll.laCRParams[2,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_ORDER,oAriaApplication.GetHeaderText("LANG_ORDER",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  CASE lcRpSortBy = 'I'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[2,2] = LANG_Invoice
loOgScroll.laCRParams[2,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Invoice,oAriaApplication.GetHeaderText("LANG_Invoice",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]

      CASE lcRpSortBy = 'D'
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[2,2] = LANG_DATE
loOgScroll.laCRParams[2,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DATE,oAriaApplication.GetHeaderText("LANG_DATE",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
