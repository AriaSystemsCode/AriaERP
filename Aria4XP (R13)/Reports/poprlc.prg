...
lcEXP = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_EXPIRE,oAriaApplication.GetHeaderText("LANG_EXPIRE",AHEADERFILE))+ DTOC(LC.Expire)
...
*!*	            CHR(13) + NOTEPAD.mNotes
  lcNotes = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_LCNO,oAriaApplication.GetHeaderText("LANG_LCNO",AHEADERFILE))+" " + LC.Clcno + CHR(13) +;
            IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_DATE,oAriaApplication.GetHeaderText("LANG_DATE",AHEADERFILE))+ DTOC(LC.Created) +;
            CHR(13) + lcEXP + CHR(13) +;
            IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_NOTEPAD,oAriaApplication.GetHeaderText("LANG_NOTEPAD",AHEADERFILE))+;
            CHR(13) + NOTEPAD.mNotes
  *N000682,1 MMT 02/06/2013 Globalization changes[End]
RETURN lcNotes
*-- End Of lfPrntNp
