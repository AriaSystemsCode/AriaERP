...
*:Modifications  :
*:****************************************************************
#Include r:\aria4xp\reports\PW\prdstat.h
STORE '' TO lcOrdTkts
...
*loOgScroll.laCRParams[lnI ,2] = LANG_Production
loOgScroll.laCRParams[lnI ,2] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Production,oAriaApplication.GetHeaderText("LANG_Production",AHEADERFILE))
