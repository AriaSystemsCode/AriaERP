...
*=gfModalGen('TRM36107B36000','DIALOG',IIF(llByLoctn OR llByFabLoc,LANG_INLOCATION,''))
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loThermo.lblFirstLabel.Caption = LANG_CALCREQ
loThermo.lblFirstLabel.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_CALCREQ,oAriaApplication.GetHeaderText("LANG_CALCREQ",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
SCAN
  ...
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loThermo.lblSecondLabel.Caption = LANG_STYL +' : '+Style
*B611398, MHM  Error while previewing Material Open to Sell report
*loThermo.lblSecondLabel.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_STYL,oAriaApplication.GetHeaderText("LANG_STYL",AHEADERFILE)) +' : '+Style
loThermo.lblSecondLabel.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_STYLE,oAriaApplication.GetHeaderText("LANG_STYLE",AHEADERFILE)) +' : '+Style
*B611398, MHM  Error while previewing Material Open to Sell report
*N000682,1 11/20/2012 MMT Globlization changes[End]
