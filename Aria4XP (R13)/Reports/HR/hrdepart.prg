...
*:***************************************************************************
#Include r:\aria4xp\reports\hr\hrdepart.h
IF llOgFltCh
...
* N000682 ,1 Thabet Handle globalization issues [END]
  ...
  * N000682 ,1 Thabet Handle globalization issues [Start]
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loOgScroll.laCRParams[1,2] =  LANG_Department_Report
loOgScroll.laCRParams[1,2] =  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Department_Report,oAriaApplication.GetHeaderText("LANG_Department_Report",AHEADERFILE))
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*WAIT WINDOW LANG_Selected + ALLTRIM(STR(RECCOUNT(lcDepartmentCursor))) + LANG_Records NOWAIT
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Selected,oAriaApplication.GetHeaderText("LANG_Selected",AHEADERFILE)) + ALLTRIM(STR(RECCOUNT(lcDepartmentCursor))) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Records,oAriaApplication.GetHeaderText("LANG_Records",AHEADERFILE)) NOWAIT
*N000682,1 11/20/2012 MMT Globlization changes[End]
