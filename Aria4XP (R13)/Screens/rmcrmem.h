...
#DEFINE LANG_CreditMemo_GST_TAX   'Gst Tax'
#DEFINE LANG_RA_NO "R/A #"
#DEFINE LANG_ISSUED "Issued"
#DEFINE LANG_AMOUNT "Amount"
#DEFINE LANG_PIECES "Pieces"
#DEFINE LANG_INVOICE "Invoice"
#DEFINE LANG_ORDER "Order"
#DEFINE LANG_CARTONS "Cartons"
#DEFINE LANG_CUSTPO "Cust P/O"
#DEFINE LANG_RAS "R/As"
#DEFINE LANG_ACCOUNT "Account"
#DEFINE LANG_VOID "Void"
#DEFINE LANG_RETURNAUTH "Return Authorizations"
#DEFINE LANG_RA_COMPLETE 'This R/A is already complete!'
#DEFINE LANG_RMSAVE_SAVING_CREDIT_MEMO "Saving credit memo"       
#DEFINE LANG_RMSAVE_SAVING_CREDIT_MEMO_NO "Saving credit memo # : "
#DEFINE LANG_RMSAVE_RET_STYLE 'Return Style "'
#DEFINE LANG_RMSAVE_ATCOST '" at cost'
#DEFINE LANG_RMRTATH_OPEN 'Open'
#DEFINE LANG_RMRTATH_CANCEL 'Cancel'
#DEFINE LANG_RMRTATH_CANCELLED 'Cancelled'
#DEFINE LANG_RMRTATH_UNCANCEL 'UnCancel'
#DEFINE LANG_RMRTATH_RANO 'R/A#'
#DEFINE LANG_RMRTATH_CREDITNO 'Credit #'
#DEFINE LANG_RMRTATH_AUTH 'Auth.'
#DEFINE LANG_RMRTATH_STORE 'Store'
#DEFINE LANG_RMRTATH_ACCNO 'Acct#'
#DEFINE LANG_RMRTATH_S 'S'
