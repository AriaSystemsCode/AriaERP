...
***            Requesthandler.ini and you can customize operation there.
***
***            [ServerConfig]
***            Virtual=Requesthandler            
***            ScriptMaps=wc,wcs,wcsx,csvs    
...
***
***    Assume: Called from RequesthandlerMain.prg startup code
***            with lcAction parameter:
***            DO RequesthandlerMain with "CONFIG"
***
***            Or launch your Exe from the Windows Command Line:
***            Requesthandler.exe config
***
***            or with a specific IIS site/virtual
***            Requesthandler.exe config "IIS://localhost/w3svc/12/root"
***
...
lcAppName = "Requesthandler"
lcDefaultVirtual = "RequestHandler"
lcScriptMap = "csvs"
...
*** Try to read from Requesthandler.ini [ServerConfig] section
