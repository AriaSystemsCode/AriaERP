...
namespace MarketplaceWebService
{
    ...
    */
    public class MarketplaceWebServiceClient : MarketplaceWebService
    {
        ...
        private const string mwsClientVersion = "2010-03-31";
        ...
        private HttpWebRequest ConfigureWebRequest(String queryParameters)
        {
            string serviceUrl;
                ...
                try
                {
                    ...
                    switch (requestType)
                    {
                        case RequestType.STREAMING:
                            request = ConfigureWebRequest(queryString);
                            break;
                        default:
