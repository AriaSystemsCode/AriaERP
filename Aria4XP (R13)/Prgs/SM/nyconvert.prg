...
*--03 Window.
lcDiamond = ""
*lcExpMdTxt= IIF(SYCNVMDL.lflag,lcDiamond,SPACE(1))+IIF(SYCNVMDL.capp_id='00','SY',SYCNVMDL.capp_id)+'-'+PADR( SYCNVMDL.capp_name,20)+'-'+ PADR(SYCNVMDL.cAutRef,15)+'-'+DTOC(SYCNVMDL.ddate)+'-'+SUBSTR
