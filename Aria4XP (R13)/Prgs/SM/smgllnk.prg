...
*B610383,1 SAB 06/16/2013 Fix GL issues appear at MAG 
*B610500,1 TMI 09/05/2013 correct some problems arose from the globalization code as it is not coded perfectly as per Mariam [T20130815.0012] 
*:************************************************************************
*N000682,1 04/16/2013 RAS Globlization changes[Start]
#INCLUDE R:\ARIA4XP\PRGS\SM\SMGLLNK.H
...
*.BrowseTitle            = LANG_GL_Link_Code
.BrowseTitle            = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GL_Link_Code,loFormSet.GetHeaderText("LANG_GL_Link_Code",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
*B610500,1 TMI 09/05/2013 [Start] correct the brow expression
*.ariaBrFields.edtBrowseFields.Value = "LINK_CODE :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GL_Link_Code,loFormSet.GetHeaderText("LANG_GL_Link_Code",loFormSet.HeaderAlias))+","+;
                                      "LINKTYPE :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Link_Type,loFormSet.GetHeaderText("LANG_Link_Type",loFormSet.HeaderAlias))+","+;
                                      "LINKDESC :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Link_Description,loFormSet.GetHeaderText("LANG_Link_Description",loFormSet.HeaderAlias))+"'"
.ariaBrFields.edtBrowseFields.Value = "LINK_CODE :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GL_Link_Code,loFormSet.GetHeaderText("LANG_GL_Link_Code",loFormSet.HeaderAlias))+"',"+;
                                      "LINKTYPE :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Link_Type,loFormSet.GetHeaderText("LANG_Link_Type",loFormSet.HeaderAlias))+"',"+;
                                      "LINKDESC :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Link_Description,loFormSet.GetHeaderText("LANG_Link_Description",loFormSet.HeaderAlias))+"'"
*B610500,1 TMI 09/05/2013 [End  ]                                         
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.AddProperty('lcTypDesc' , LANG_Description )
loFormSet.AddProperty('lcTypDesc' , IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Description,loFormSet.GetHeaderText("LANG_Description",loFormSet.HeaderAlias)) )
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*-- lcBrTtl variable that hold the browse title
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.AddProperty('lcBrTtl' , LANG_Key_Categories)
loFormSet.AddProperty('lcBrTtl' , IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Key_Categories,loFormSet.GetHeaderText("LANG_Key_Categories",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lfSetColumnsProp(oGrd,'1',"&lcKeyCat..CatgKey"  ,LANG_Category_Key,100)
lfSetColumnsProp(oGrd,'1',"&lcKeyCat..CatgKey"  ,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Category_Key,loFormSet.GetHeaderText("LANG_Category_Key",loFormSet.HeaderAlias)),100)
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lfSetColumnsProp(oGrd,'2',"&lcKeyCat..CatgDesc" ,LANG_Description ,160)
lfSetColumnsProp(oGrd,'2',"&lcKeyCat..CatgDesc" ,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Description,loFormSet.GetHeaderText("LANG_Description",loFormSet.HeaderAlias)) ,160)
*N000682,1 11/20/2012 MMT Globlization changes[End]

*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lfSetColumnsProp(oGrd,'3',"&lcKeyCat..Glacnt" ,LANG_GL_Account   ,100)
lfSetColumnsProp(oGrd,'3',"&lcKeyCat..Glacnt" ,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GL_Account,loFormSet.GetHeaderText("LANG_GL_Account",loFormSet.HeaderAlias))   ,100)
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	  lfSetColumnsProp(oGrd,'4',"&lcKeyCat..GlaccDesc" ,'GL. Description'   ,160)
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*lfSetColumnsProp(oGrd,'4',"&lcKeyCat..GlaccDesc" ,LANG_GL_Description   ,160)
lfSetColumnsProp(oGrd,'4',"&lcKeyCat..GlaccDesc" ,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GL_Description,loFormSet.GetHeaderText("LANG_GL_Description",loFormSet.HeaderAlias))   ,160)
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	  lfSetColumnsProp(oGrd,'4',IIF(!EMPTY(lcDescFld),lcSrc,''),'Description'   ,160)
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*lfSetColumnsProp(oGrd,'4',IIF(!EMPTY(lcDescFld),lcSrc,''),LANG_Description   ,160)
lfSetColumnsProp(oGrd,'4',IIF(!EMPTY(lcDescFld),lcSrc,''),IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Description,loFormSet.GetHeaderText("LANG_Description",loFormSet.HeaderAlias))   ,160)
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF loFormSet.llSetUp
  SELECT(loFormSet.lcKeyCat)
  *B610500,1 TMI 09/05/2013 [Start] set the filter correctly
  *SET FILTER TO LinkType = loFormSet.laData[1]
  lcFlt = "LinkType = '"+loFormSet.laData[1]+"'"
  SET FILTER TO &lcFlt
  *B610500,1 TMI 09/05/2013 [End  ] 
...
*!*	    lnResp = gfModalGen('INM00001B02004','DIALOG','Link Type\Link Code :'+loFormSet.laData[2])
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*lnResp = gfModalGen('INM00001B02004','DIALOG',LANG_Link_Type_Link_Code+loFormSet.laData[2])
lnResp = gfModalGen('INM00001B02004','DIALOG',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Link_Type_Link_Code,loFormSet.GetHeaderText("LANG_Link_Type_Link_Code",loFormSet.HeaderAlias))+loFormSet.laData[2])
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcWTitl  = LANG_Copy_Information_From_GL_Link_code
lcWTitl  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Copy_Information_From_GL_Link_code,loFormSet.GetHeaderText("LANG_Copy_Information_From_GL_Link_code",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 04/16/2013 RAS Globlization changes[Start]
*B610500,1 TMI 09/05/2013 [Start] rewrite the expression to meet the globalization again
...
LOCAL lcH_Type, lcH_Link_Code,lcH_Description
lcH_Type        = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Type,loFormSet.GetHeaderText("LANG_Type",loFormSet.HeaderAlias))
lcH_Link_Code   = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Link_code,loFormSet.GetHeaderText("LANG_Link_code",loFormSet.HeaderAlias))
lcH_Description = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Description,loFormSet.GetHeaderText("LANG_Description",loFormSet.HeaderAlias))
lcBrFields = "Type = IIF(ASCAN(loFormSet.laType,&lcBaseGL..LinkType)>0,loFormSet.laType[ASUBSCRIPT(loFormSet.laType,ASCAN(loFormSet.laType,&lcBaseGL..LinkType),1),1],'') "+;
             ":H='&lcH_Type':15,"+;
             "Link_Code    :H='&lcH_Link_Code',"+;
             "Description=&lcBaseGL..LinkDesc :H='&lcH_Description'"
*B610500,1 TMI 09/05/2013 [End  ] 
*!*	lcFile_Ttl  = 'Link codes'
*lcBrFields = "Type = IIF(ASCAN(loFormSet.laType,&lcBaseGL..LinkType)>0,loFormSet.laType[ASUBSCRIPT(loFormSet.laType,ASCAN(loFormSet.laType,&lcBaseGL..LinkType),1),1],'') :H= IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Type,loFormSet.GetHeaderText("LANG_Type",loFormSet.HeaderAlias)) :15,"+;
             "Link_Code    :H=IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Link_code,loFormSet.GetHeaderText("LANG_Link_code",loFormSet.HeaderAlias)) ,"+;
             *N000682,1 11/20/2012 MMT Globlization changes[Start]
*"Description=&lcBaseGL..LinkDesc :H=LANG_Description"
*"Description=&lcBaseGL..LinkDesc :H=LANG_Description"
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcFile_Ttl  = LANG_Link_codes
lcFile_Ttl  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Link_codes,loFormSet.GetHeaderText("LANG_Link_codes",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcBrFields  = loFormSet.lcCodeFld + ":H=LANG_GL_Account1," + loFormSet.lcDescFld + ":H=LANG_Description"
*B610383,1 SAB 06/16/2013 Fix GL issues appear at MAG [Start]
*lcBrFields  = loFormSet.lcCodeFld + ":H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GL_Account1,loFormSet.GetHeaderText("LANG_GL_Account1",loFormSet.HeaderAlias))+"," + loFormSet.lcDescFld + ":H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Description,loFormSet.GetHeaderText("LANG_Description",loFormSet.HeaderAlias))+"'"
lcBrFields  = loFormSet.lcCodeFld + ":H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GL_Account1,loFormSet.GetHeaderText("LANG_GL_Account1",loFormSet.HeaderAlias))+"'," + loFormSet.lcDescFld + ":H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Description,loFormSet.GetHeaderText("LANG_Description",loFormSet.HeaderAlias))+"'"
*B610383,1 SAB 06/16/2013 Fix GL issues appear at MAG [End]
*N000682,1 11/20/2012 MMT Globlization changes[End]


*N000682,1 11/20/2012 MMT Globlization changes[Start]
*lcFile_Ttl  = LANG_GL_Accounts
lcFile_Ttl  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_GL_Accounts,loFormSet.GetHeaderText("LANG_GL_Accounts",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	      loFormSet.lcTypDesc = 'Description'
      *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.lcTypDesc = LANG_Description
loFormSet.lcTypDesc = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Description,loFormSet.GetHeaderText("LANG_Description",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	      STORE 'Default G/L. link code' TO loFormSet.laData[3],loFormSet.lcTypeDesc
      *N000682,1 11/20/2012 MMT Globlization changes[Start]
*STORE LANG_Default_GL_link_code TO loFormSet.laData[3],loFormSet.lcTypeDesc
STORE IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Default_GL_link_code,loFormSet.GetHeaderText("LANG_Default_GL_link_code",loFormSet.HeaderAlias)) TO loFormSet.laData[3],loFormSet.lcTypeDesc
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
DO CASE
  CASE oAriaApplication.ActiveModuleID = "AR"
    DIMENSION loFormSet.laType[3,2]
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[1,1] = LANG_Customer
loFormSet.laType[1,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Customer,loFormSet.GetHeaderText("LANG_Customer",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    loFormSet.laType[1,2] = "01"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[2,1] = LANG_Sales
loFormSet.laType[2,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Sales,loFormSet.GetHeaderText("LANG_Sales",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    loFormSet.laType[2,2] = "02"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[3,1] = LANG_Select_link_type
loFormSet.laType[3,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Select_link_type,loFormSet.GetHeaderText("LANG_Select_link_type",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  CASE oAriaApplication.ActiveModuleID = "PO"
    DIMENSION loFormSet.laType[2,2]
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[1,1] = LANG_Work_in_process
loFormSet.laType[1,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Work_in_process,loFormSet.GetHeaderText("LANG_Work_in_process",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    loFormSet.laType[1,2] = "05"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[2,1] = LANG_Select_link_type
loFormSet.laType[2,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Select_link_type,loFormSet.GetHeaderText("LANG_Select_link_type",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  CASE oAriaApplication.ActiveModuleID = "MA"
    DIMENSION loFormSet.laType[3,2]
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[1,1] = LANG_Material
loFormSet.laType[1,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Material,loFormSet.GetHeaderText("LANG_Material",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    loFormSet.laType[1,2] = "04"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[2,1] = LANG_Work_in_process
loFormSet.laType[2,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Work_in_process,loFormSet.GetHeaderText("LANG_Work_in_process",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  CASE oAriaApplication.ActiveModuleID = "IC"
    DIMENSION loFormSet.laType[2,2]
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[1,1] = LANG_Style
loFormSet.laType[1,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Style,loFormSet.GetHeaderText("LANG_Style",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*N000682,1 11/20/2012 MMT Globlization changes[End]
    ...
    loFormSet.laType[2,2] = "02"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[3,1] = LANG_Style
loFormSet.laType[3,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Style,loFormSet.GetHeaderText("LANG_Style",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    loFormSet.laType[3,2] = "03"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[4,1] = LANG_Material
loFormSet.laType[4,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Material,loFormSet.GetHeaderText("LANG_Material",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    loFormSet.laType[4,2] = "04"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[5,1] = LANG_Work_in_process
loFormSet.laType[5,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Work_in_process,loFormSet.GetHeaderText("LANG_Work_in_process",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

    loFormSet.laType[5,2] = "05"
    *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laType[6,1] = LANG_Select_link_type
loFormSet.laType[6,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Select_link_type,loFormSet.GetHeaderText("LANG_Select_link_type",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*!*	  loFormSet.laComp[ALEN(loFormSet.laComp,1),1] = 'Select a company'
  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*loFormSet.laComp[ALEN(loFormSet.laComp,1),1] = LANG_Select_a_company
loFormSet.laComp[ALEN(loFormSet.laComp,1),1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_Select_a_company,loFormSet.GetHeaderText("LANG_Select_a_company",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
