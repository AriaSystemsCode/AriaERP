...
*N000682,1 12/11/2012 TMI Globlization changes[Start] define the variable loFormSet as it was used in the check of the language
loFormSet = oFormSet
oFormSet.AriaForm1.cboSelect.ROWSOURCE =""+;
IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_ADJSTCSTSHP,loFormSet.GetHeaderText("LANG_POACF_ADJSTCSTSHP",loFormSet.HeaderAlias))+",1,"+;
IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_ADJBYPO,loFormSet.GetHeaderText("LANG_POACF_ADJBYPO",loFormSet.HeaderAlias))+",2"
oFormSet.AriaForm1.cboSelect.requery()
*N000682,1 12/11/2012 TMI Globlization changes[End  ] 
...
.laPanelObj[1,4] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_REFRESH,loFormSet.GetHeaderText("LANG_POACFRV_REFRESH",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*.laPanelObj[1,5] = LANG_POACFRV_REFRESH
.laPanelObj[1,5] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_REFRESH,loFormSet.GetHeaderText("LANG_POACFRV_REFRESH",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.laPanelObj[2,4] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_FORECAST,loFormSet.GetHeaderText("LANG_POACFRV_FORECAST",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*.laPanelObj[2,5] = LANG_POACFRV_FORECAST
.laPanelObj[2,5] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_FORECAST,loFormSet.GetHeaderText("LANG_POACFRV_FORECAST",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
=gfModalGen('INM00000B00000',.F.,.F.,.F.,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_No_TEMPLATE,loFormSet.GetHeaderText("LANG_POACFRV_No_TEMPLATE",loFormSet.HeaderAlias)) )
*N000682,1 11/20/2012 MMT Globlization changes[End]
  ...
  .lcTitle = IIF(.lcPType = 'M', IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_CUTTKT,loFormSet.GetHeaderText("LANG_POACFRV_CUTTKT",loFormSet.HeaderAlias)),;
                 IIF(.lcPType = 'T', IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_MFGORD,loFormSet.GetHeaderText("LANG_POACFRV_MFGORD",loFormSet.HeaderAlias)),;
                 IIF(.llByShp, IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_SHPMNT,loFormSet.GetHeaderText("LANG_POACFRV_SHPMNT",loFormSet.HeaderAlias)), IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_POORD,loFormSet.GetHeaderText("LANG_POACFRV_POORD",loFormSet.HeaderAlias)))))
  ...
  *--Assign Caption for TktNo and Pieces Labels
  .AriaForm1.lblTktNo.Caption = IIF(.lcPType = 'M', IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_CUTTKTNO,loFormSet.GetHeaderText("LANG_POACFRV_CUTTKTNO",loFormSet.HeaderAlias)),;
                                    IIF(.lcPType = 'T', IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_MFGORDNO,loFormSet.GetHeaderText("LANG_POACFRV_MFGORDNO",loFormSet.HeaderAlias)),;
                                    IIF(.llByShp, IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_SHPMNTNO,loFormSet.GetHeaderText("LANG_POACFRV_SHPMNTNO",loFormSet.HeaderAlias)), IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_POORDNO,loFormSet.GetHeaderText("LANG_POACFRV_POORDNO",loFormSet.HeaderAlias)))))

  *N000682,1 11/20/2012 MMT Globlization changes[Start]
*.AriaForm1.lblBudget.Caption = IIF(.lcPType $ 'MT', LANG_POACFRV_PCSBDG, LANG_POACFRV_ORDPCS)
.AriaForm1.lblBudget.Caption = IIF(.lcPType $ 'MT', IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_PCSBDG,loFormSet.GetHeaderText("LANG_POACFRV_PCSBDG",loFormSet.HeaderAlias)), IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_ORDPCS,loFormSet.GetHeaderText("LANG_POACFRV_ORDPCS",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*E302483,1 MMT 01/03/2008 Convert Shipment Cost sheet program to ARIA4[End]
  ...
  *--Open needed files.
  ...
  IF .lcPType = 'T'
    ...
    .lcBrowFlds = "po       :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_MFGORDNO,loFormSet.GetHeaderText("LANG_POACFRV_MFGORDNO",loFormSet.HeaderAlias))+"',"+;
                  "Style    :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_FABRIC,loFormSet.GetHeaderText("LANG_POACFRV_FABRIC",loFormSet.HeaderAlias))  +"',"+;
                  IIF(lcWareHouse = 'Y', "cWareCode:H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_WARECODE,loFormSet.GetHeaderText("LANG_POACFRV_WARECODE",loFormSet.HeaderAlias))+"',", "")+;
                  "Status   :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STATUS,loFormSet.GetHeaderText("LANG_POACFRV_STATUS",loFormSet.HeaderAlias))  +"',"+;
                  "Entered  :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_ENTERED,loFormSet.GetHeaderText("LANG_POACFRV_ENTERED",loFormSet.HeaderAlias)) +"',"+;
                  "Complete :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_COMPLETE,loFormSet.GetHeaderText("LANG_POACFRV_COMPLETE",loFormSet.HeaderAlias))+"'"
  ...
  ELSE
    ...
    IF .lcPType = 'I'
      IF .llByShp
        .lcBrowFlds = "ShipNo   :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_SHPMNTNO,loFormSet.GetHeaderText("LANG_POACFRV_SHPMNTNO",loFormSet.HeaderAlias)) +"',"+;
                      "Status   :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STATUS,loFormSet.GetHeaderText("LANG_POACFRV_STATUS",loFormSet.HeaderAlias))   +"',"+;
                      "Entered  :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_ENTERED,loFormSet.GetHeaderText("LANG_POACFRV_ENTERED",loFormSet.HeaderAlias))  +"',"+;
                      "Cartons  :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_CARTONS,loFormSet.GetHeaderText("LANG_POACFRV_CARTONS",loFormSet.HeaderAlias))  +"',"+;
                      "AirWayB  :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_AIRWAYB,loFormSet.GetHeaderText("LANG_POACFRV_AIRWAYB",loFormSet.HeaderAlias)) +"',"+;
                      "ETA      :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_ETA,loFormSet.GetHeaderText("LANG_POACFRV_ETA",loFormSet.HeaderAlias))      +"',"+;
                      "TotQtyHDR:H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_INTRANSIT,loFormSet.GetHeaderText("LANG_POACFRV_INTRANSIT",loFormSet.HeaderAlias))+"',"+;
                      "Recv_Stk :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_RECEIVED,loFormSet.GetHeaderText("LANG_POACFRV_RECEIVED",loFormSet.HeaderAlias)) +"',"+;
                      "Recv_Dam :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_DAMAGE,loFormSet.GetHeaderText("LANG_POACFRV_DAMAGE",loFormSet.HeaderAlias))   +"',"+;
                      "Recv_Can :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_CANCELED,loFormSet.GetHeaderText("LANG_POACFRV_CANCELED",loFormSet.HeaderAlias)) +"',"+;
                      "cVessel  :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_CVESSEL,loFormSet.GetHeaderText("LANG_POACFRV_CVESSEL",loFormSet.HeaderAlias)) +"',"+;
                      "Reference:H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_REFERENCE,loFormSet.GetHeaderText("LANG_POACFRV_REFERENCE",loFormSet.HeaderAlias))  +"'"


      ELSE
        .lcBrowFlds = "PO        :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_CUTTKTNO,loFormSet.GetHeaderText("LANG_POACFRV_CUTTKTNO",loFormSet.HeaderAlias))+"',"+;
                      "Status    :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STATUS,loFormSet.GetHeaderText("LANG_POACFRV_STATUS",loFormSet.HeaderAlias))  +"', "+;
                      "Vendor    :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_VENDOR,loFormSet.GetHeaderText("LANG_POACFRV_VENDOR",loFormSet.HeaderAlias))  +"',"+;
                      "lcVnName = ApVendor.cVenComp :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_VENCOMP,loFormSet.GetHeaderText("LANG_POACFRV_VENCOMP",loFormSet.HeaderAlias))+"',"+;
                      "Entered   :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_ENTERED,loFormSet.GetHeaderText("LANG_POACFRV_ENTERED",loFormSet.HeaderAlias)) +"',"+;
                      "Complete  :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_COMPLETE,loFormSet.GetHeaderText("LANG_POACFRV_COMPLETE",loFormSet.HeaderAlias))+"',"+;
                      "nStyOrder :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_TOTQTY,loFormSet.GetHeaderText("LANG_POACFRV_TOTQTY",loFormSet.HeaderAlias))  +"',"+;
                      "POTotal   :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_AMOUNT,loFormSet.GetHeaderText("LANG_POACFRV_AMOUNT",loFormSet.HeaderAlias))  +"',"+;
                      "Receive   :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_REC,loFormSet.GetHeaderText("LANG_POACFRV_REC",loFormSet.HeaderAlias))     +"',"+;
                      "Open      :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_OPEN,loFormSet.GetHeaderText("LANG_POACFRV_OPEN",loFormSet.HeaderAlias))    +"'"
    ...
    ELSE
      .lcBrowFlds = "po       :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_CUTTKTNO,loFormSet.GetHeaderText("LANG_POACFRV_CUTTKTNO",loFormSet.HeaderAlias))+"',"+;
                    "Style    :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STYLE,loFormSet.GetHeaderText("LANG_POACFRV_STYLE",loFormSet.HeaderAlias))   +"',"+;
                    "Status   :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STATUS,loFormSet.GetHeaderText("LANG_POACFRV_STATUS",loFormSet.HeaderAlias))  +"',"+;
                    "Entered  :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_ISSUE,loFormSet.GetHeaderText("LANG_POACFRV_ISSUE",loFormSet.HeaderAlias))   +"',"+;
                    "Complete :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_COMPLETE,loFormSet.GetHeaderText("LANG_POACFRV_COMPLETE",loFormSet.HeaderAlias))+"',"+;
                    "Season   :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_SEASON,loFormSet.GetHeaderText("LANG_POACFRV_SEASON",loFormSet.HeaderAlias))  +"',"+;
                    "cDivision:H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_DIVISION,loFormSet.GetHeaderText("LANG_POACFRV_DIVISION",loFormSet.HeaderAlias))+"',"+;
                    "nStyOrder:H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_BUDGET,loFormSet.GetHeaderText("LANG_POACFRV_BUDGET",loFormSet.HeaderAlias))  +"':P='999999',"+;
                    "Receive  :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_RECEIVED,loFormSet.GetHeaderText("LANG_POACFRV_RECEIVED",loFormSet.HeaderAlias))+"':P='999999',"+;
                    "Damage   :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_DAMAGE,loFormSet.GetHeaderText("LANG_POACFRV_DAMAGE",loFormSet.HeaderAlias))  +"':P='999999',"+;
                    "Open     :H='"+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_OPEN,loFormSet.GetHeaderText("LANG_POACFRV_OPEN",loFormSet.HeaderAlias))    +"':P='999999' "
  ...
  *--Assign SQL Browse Properties
  ...
  .BrowseTitle            = IIF(.llByShp, IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_BROETTLSHP,loFormSet.GetHeaderText("LANG_POACFRV_BROETTLSHP",loFormSet.HeaderAlias)),;
                                IIF(.lcPType = 'I', IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_BROETTLSPO,loFormSet.GetHeaderText("LANG_POACFRV_BROETTLSPO",loFormSet.HeaderAlias)),;
                                    IIF(.lcPType = 'M', IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_BROETTLSCC,loFormSet.GetHeaderText("LANG_POACFRV_BROETTLSCC",loFormSet.HeaderAlias)),;
                            IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_BROETTLMMF,loFormSet.GetHeaderText("LANG_POACFRV_BROETTLMMF",loFormSet.HeaderAlias)))))
...
loFormSet = oFormSet
DEFINE PAD _Option OF (oFormSet.cHostFormName) PROMPT IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_OPTIONS,loFormSet.GetHeaderText("LANG_POACFRV_OPTIONS",loFormSet.HeaderAlias)) KEY ALT+P , ' '
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
DEFINE BAR 1 OF _OPTIONPOP PROMPT IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_REFRESH,loFormSet.GetHeaderText("LANG_POACFRV_REFRESH",loFormSet.HeaderAlias)) SKIP FOR gfFormIsActive(&lcHostFormName) .AND. (_Screen.ActiveForm.Parent.ActiveMode # 'E' OR _Screen.ActiveForm.Parent.llRefresh)
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
DEFINE BAR 2 OF _OPTIONPOP PROMPT IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_FORECAST,loFormSet.GetHeaderText("LANG_POACFRV_FORECAST",loFormSet.HeaderAlias)) SKIP FOR gfFormIsActive(&lcHostFormName) .AND. _Screen.ActiveForm.Parent.ActiveMode == 'S'
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
DEFINE BAR 3 OF _OPTIONPOP PROMPT IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_SHPTOTCST,loFormSet.GetHeaderText("LANG_POACFRV_SHPTOTCST",loFormSet.HeaderAlias)) SKIP FOR gfFormIsActive(&lcHostFormName) .AND. _Screen.ActiveForm.Parent.ActiveMode == 'S'
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF oFormSet.lcPType = 'M'
  IF !(EVALUATE(oFormSet.lcPOSHDR + '.Status') $ 'OA')
    ...
    *=gfModalGen('TRM34086B00000','DIALOG','open or actualizied cut ticket')
     =gfModalGen('TRM34086B00000','DIALOG',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_OPENORACT,oFormSet.GetHeaderText("LANG_POACF_OPENORACT",oFormSet.HeaderAlias)))
  ...
  *E302483,1 MMT 01/03/2008 Convert Shipment Cost sheet program to ARIA4[End]
   ...
   * =gfModalGen('TRM34086B00000','DIALOG','the status open')
    ...
    *=gfModalGen('TRM34086B00000','DIALOG',IIF(oFormSet.lcPType = 'I' AND oFormSet.llByShp,LANG_POACFRV_STATUSOH,LANG_POACFRV_STATUSOPEN))
    =gfModalGen('TRM34086B00000','DIALOG',IIF(oFormSet.lcPType = 'I' AND oFormSet.llByShp,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STATUSOH,loFormSet.GetHeaderText("LANG_POACFRV_STATUSOH",loFormSet.HeaderAlias)),IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STATUSOPEN,loFormSet.GetHeaderText("LANG_POACFRV_STATUSOPEN",loFormSet.HeaderAlias))))
    *N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF oFormSet.llByShp
        ...
        ELSE
          ...
          ELSE
            ...
            *=gfModalGen('TRM34088B00000','DIALOG','P/O :'+lcPo+' of this Shipment')
            =gfModalGen('TRM34088B00000','DIALOG',;
            IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_POSPCOL,oFormSet.GetHeaderText("LANG_POACF_POSPCOL",oFormSet.HeaderAlias))+lcPo+' '+;
            IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_OFSHIP,oFormSet.GetHeaderText("LANG_POACF_OFSHIP",oFormSet.HeaderAlias)))
            *N000682,1 MMT 12/09/2012 Globalization changes[end]
          ENDIF
        ENDIF
      ELSE
  ...
  IF EOF()
    ...
    *=gfModalGen('TRM34088B00000','DIALOG','P/Os of this Shipment')    
    =gfModalGen('TRM34088B00000','DIALOG',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_POOFSHIP,oFormSet.GetHeaderText("LANG_POACF_POOFSHIP",oFormSet.HeaderAlias)))
    *N000682,1 MMT 12/09/2012 Globalization changes[end]
    oFormSet.AriaForm1.LockScreen = .F.
    RETURN .F.
  ENDIF
...
ELSE     && Not by shipment.
  ...
  IF !SEEK('1'+oFormSet.lcTktNo)
    ...
    *=gfModalGen('TRM34088B00000','DIALOG','this ' + oFormSet.lcTitle)
    =gfModalGen('TRM34088B00000','DIALOG',IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_THIS,oFormSet.GetHeaderText("LANG_POACF_THIS",oFormSet.HeaderAlias))+' ' + oFormSet.lcTitle)
    *N000682,1 MMT 12/09/2012 Globalization changes[end]
    oFormSet.AriaForm1.LockScreen = .F.
    RETURN .F.
  ELSE
...
*E302483,1 MMT 01/03/2008 Convert Shipment Cost sheet program to ARIA4[End]
*N000682,1 MMT 12/09/2012 Globalization changes[Start]
WAIT WINDOW IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_STARTUPDATE,oFormSet.GetHeaderText("LANG_POACF_STARTUPDATE",oFormSet.HeaderAlias))  NOWAIT
*N000682,1 MMT 12/09/2012 Globalization changes[end]
SELECT (oFormSet.lcTmpLine)
GO TOP
...
WAIT IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_COLLCOST,oFormSet.GetHeaderText("LANG_POACF_COLLCOST",oFormSet.HeaderAlias)) WINDOW NOWAIT
*N000682,1 MMT 12/09/2012 Globalization changes[end]
...
IF MESSAGEBOX(IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_CONNERRMSG,loFormSet.GetHeaderText("LANG_CONNERRMSG",loFormSet.HeaderAlias)), 5+16, IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_CONNERRTTL,loFormSet.GetHeaderText("LANG_CONNERRTTL",loFormSet.HeaderAlias))) = 2
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(1).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_PON,loFormSet.GetHeaderText("LANG_POACFRV_PON",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_ITM,loFormSet.GetHeaderText("LANG_POACFRV_ITM",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI+1).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_MFG,loFormSet.GetHeaderText("LANG_POACFRV_MFG",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI+2).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_UOM,loFormSet.GetHeaderText("LANG_POACFRV_UOM",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI+3).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_DSC,loFormSet.GetHeaderText("LANG_POACFRV_DSC",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI+4).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_ESTQTY,loFormSet.GetHeaderText("LANG_POACFRV_ESTQTY",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI+5).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_ESTCST,loFormSet.GetHeaderText("LANG_POACFRV_ESTCST",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI+6).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_EXT,loFormSet.GetHeaderText("LANG_POACFRV_EXT",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_QTY,loFormSet.GetHeaderText("LANG_POACFRV_QTY",loFormSet.HeaderAlias)) + oFormSet.loParent.laSessions[lnJ,2]
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI+1).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_CST,loFormSet.GetHeaderText("LANG_POACFRV_CST",loFormSet.HeaderAlias)) + oFormSet.loParent.laSessions[lnJ,2]
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI+2).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_EXT,loFormSet.GetHeaderText("LANG_POACFRV_EXT",loFormSet.HeaderAlias)) + oFormSet.loParent.laSessions[lnJ,2]
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI).Header1.Caption  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_CURQTY,loFormSet.GetHeaderText("LANG_POACFRV_CURQTY",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI).Header1.Caption  = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_CURCST,loFormSet.GetHeaderText("LANG_POACFRV_CURCST",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Columns(lnI).Header1.Caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN" OR TYPE("loFormSet.HeaderAlias")<>'C',LANG_POACFRV_EXT,loFormSet.GetHeaderText("LANG_POACFRV_EXT",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
loFormSet = oFormSet
lcBrTrttl = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_SHPMNT,loFormSet.GetHeaderText("LANG_POACFRV_SHPMNT",loFormSet.HeaderAlias)) + ' ' + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_TOTCST,loFormSet.GetHeaderText("LANG_POACFRV_TOTCST",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.lcTitle = IIF(.llByShp, IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_SHPMNT,loFormSet.GetHeaderText("LANG_POACFRV_SHPMNT",loFormSet.HeaderAlias)), IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_POORD,loFormSet.GetHeaderText("LANG_POACFRV_POORD",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
loFormSet.laCostItem[1,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_ALL_COST,loFormSet.GetHeaderText("LANG_POACFRV_ALL_COST",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
loFormSet.laCostItem[1,1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_NO_COST_ITEM,loFormSet.GetHeaderText("LANG_POACFRV_NO_COST_ITEM",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*	.Column&lcColNo..Header1.caption = LANG_POACFRV_STYLE
	.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STYLE,loFormSet.GetHeaderText("LANG_POACFRV_STYLE",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_CUSTOMER,loFormSet.GetHeaderText("LANG_POACFRV_CUSTOMER",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_PO,loFormSet.GetHeaderText("LANG_POACFRV_PO",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption =  IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_QTYSHP,loFormSet.GetHeaderText("LANG_POACFRV_QTYSHP",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_POPRICE,loFormSet.GetHeaderText("LANG_POACFRV_POPRICE",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_CURR,loFormSet.GetHeaderText("LANG_POACFRV_CURR",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_EXRATE,loFormSet.GetHeaderText("LANG_POACFRV_EXRATE",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_BPRICE,loFormSet.GetHeaderText("LANG_POACFRV_BPRICE",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_SPRICE,loFormSet.GetHeaderText("LANG_POACFRV_SPRICE",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_ROYALPERC,loFormSet.GetHeaderText("LANG_POACFRV_ROYALPERC",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_ROYALATY,loFormSet.GetHeaderText("LANG_POACFRV_ROYALATY",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_TRDDISC,loFormSet.GetHeaderText("LANG_POACFRV_TRDDISC",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_TRADE,loFormSet.GetHeaderText("LANG_POACFRV_TRADE",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STLDISC,loFormSet.GetHeaderText("LANG_POACFRV_STLDISC",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_STLAMNT,loFormSet.GetHeaderText("LANG_POACFRV_STLAMNT",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_DUTYEXRATE,loFormSet.GetHeaderText("LANG_POACFRV_DUTYEXRATE",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*		.Column&lcColNo..Header1.caption = LANG_POACFRV_UNITCOST
		.Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_UNITCOST,loFormSet.GetHeaderText("LANG_POACFRV_UNITCOST",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*	 .Column&lcColNo..Header1.caption = LANG_POACFRV_TOTALCOST
	 .Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_TOTALCOST,loFormSet.GetHeaderText("LANG_POACFRV_TOTALCOST",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*	 .Column&lcColNo..Header1.caption = LANG_POACFRV_TOTUCOST
	 .Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_TOTUCOST,loFormSet.GetHeaderText("LANG_POACFRV_TOTUCOST",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
*	  .Column&lcColNo..Header1.caption = LANG_POACFRV_MRGIN
	  .Column&lcColNo..Header1.caption = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_MRGIN,loFormSet.GetHeaderText("LANG_POACFRV_MRGIN",loFormSet.HeaderAlias))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
=gfModalGen('INM00000B00000',.F.,.F.,.F.,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_NO_AMNT_DIST,loFormSet.GetHeaderText("LANG_POACFRV_NO_AMNT_DIST",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
IF loFormset.laCostItem[lnCostItem,3] > 0  .AND. gfModalGen('INM00000B00006',.F.,.F.,.F.,IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACFRV_REMOVE_DIST,loFormSet.GetHeaderText("LANG_POACFRV_REMOVE_DIST",loFormSet.HeaderAlias)) ) = 1
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
laSource[1] = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_POPRICE,loFormSet.GetHeaderText("LANG_POACF_POPRICE",loFormSet.HeaderAlias))
=gfMover(@laSource,@laTarget,oFormSet.laCostItem[lnCostItem,1]+' '+IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_ISPEROF,loFormSet.GetHeaderText("LANG_POACF_ISPEROF",loFormSet.HeaderAlias)),.T.,'')
*N000682,1 MMT 12/09/2012 Globalization changes[end]
IF !EMPTY(laTarget)
  lcPrcntOf = '0'
  FOR lnI = 1 TO ALEN(laTarget)
    ...
    *IF 'PO Price' $ laTarget[lnI]
    IF IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_POACF_POPRICE,loFormSet.GetHeaderText("LANG_POACF_POPRICE",loFormSet.HeaderAlias)) $ laTarget[lnI]
    *N000682,1 MMT 12/09/2012 Globalization changes[end]
