...
WITH loFormSet
  ...
  *.BrowseTitle            = LANG_MAVMREF_APVENDORS
  .BrowseTitle            = IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MAVMREF_APVENDORS,loFormSet.GetHeaderText("LANG_MAVMREF_APVENDORS",loFormSet.HeaderAlias))
...
=gfModalGen('INM36190B36000', 'DIALOG', ALLTRIM(lcVenCode) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MAVMREF_NOMODIFY,loFormSet.GetHeaderText("LANG_MAVMREF_NOMODIFY",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
=gfModalGen('INM36192B36000', 'DIALOG', ALLTRIM(lcVenCode) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MAVMREF_NOMODIFY,loFormSet.GetHeaderText("LANG_MAVMREF_NOMODIFY",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
=gfModalGen('INM36014B36000', 'DIALOG', IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MAVMREF_PRICE,loFormSet.GetHeaderText("LANG_MAVMREF_PRICE",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
=gfModalGen('INM36014B36000', 'DIALOG', IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MAVMREF_QUANTITY,loFormSet.GetHeaderText("LANG_MAVMREF_QUANTITY",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
...
=gfModalGen('INM36190B36000', 'DIALOG', ALLTRIM(lcVenCode) + IIF(oAriaApplication.oActivelang.cLang_ID = "EN",LANG_MAVMREF_NOREMOVE,loFormSet.GetHeaderText("LANG_MAVMREF_NOREMOVE",loFormSet.HeaderAlias)))
*N000682,1 11/20/2012 MMT Globlization changes[End]
