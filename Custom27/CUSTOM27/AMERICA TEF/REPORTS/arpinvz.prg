...
*:B802751,1 RAMY 12/14/1999 Print the facor name and addresses if factored invoice
*:************************************************************************
    ...
    DO WHILE PRINTFCTR
      ...
      DO CASE
        ...
        CASE FOUND()
          ...
          XFADDR1 = CADDRESS1
          XFADDR2 = CADDRESS2
          XFADDR3 = TRIM(CADDRESS3)+' '+TRIM(CADDRESS4)+' '+TRIM(CADDRESS5)
          IF CADDRESS2 = ' '
            CADDRESS2 = CADDRESS3
            CADDRESS3 = ' '
          ENDIF
...
*** 2
  ...
  *@ 01,71 SAY INVDATE        && MFM 01/02/95.
  @ 01,75 SAY INVDATE        
  *B602953,1 BWA [END]
...
*  @ 03,71 SAY SUBSTR( PDIVISION, 1, 14 )  && MFM 01/02/95.

  *B602953,1 BWA  Modify the field dimension due to the attached form. 
  *@ 03,71 SAY SUBSTR( CDIVISION, 1, 14 )  && MFM 01/02/95.
...
*    @ 07,05 SAY HLINE5  PICTURE "@R "+gcPhnFrmt SIZE 1,16
  ...
  *B602953,1 BWA  Modify the field dimension due to the attached form. 
  *@ 07,71 SAY PIKTKT        && MFM 01/02/95.
  *@ 09,71 SAY APPROVAL      && MFM 01/02/95.
  @ 07,75 SAY PIKTKT
  
  *B802751,1 RAMY Print the factor information [start]
  *@ 09,75 SAY APPROVAL
  ...
  *B500627,1 TMI 04/05/95 (Start) Moving next lines 2 Char. to left.
...
*  @ 16,56 SAY SUBSTR(XSTADDR3,1,29)
  ...
  @ 15,10 SAY XBTADDR2
  @ 15,56 SAY SUBSTR(XSTADDR2,1,25)
  @ 16,10 SAY SUBSTR(XBTADDR3,1,45)
  @ 16,56 SAY SUBSTR(XSTADDR3,1,29)
