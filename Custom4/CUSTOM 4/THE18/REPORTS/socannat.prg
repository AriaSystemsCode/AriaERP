*:************************************************************************
*: Program file  : SOCANNAT.Prg
*: Program desc. : Cancellation report for Nat Nast
*: System        : Aria 4 XP
*: Module        : SO
*: Developer     : Mariam MAzhar [MMT]
*: Date          : 11/23/2008
*: REF           : C201074,1[T20080611.0006]
*:************************************************************************
*: Calls : 
*:    Procedures : ....
...
m.Sz7         = Scale.Sz7
m.Sz8         = Scale.Sz8
m.AMOUNT    = m.PRICE*m.TOTQTY
m.STARTDATE = ORDHDR.START
...
lnFileStru = lnFileStru+1
laFileStru[lnFileStru,1] = 'Amount'
laFileStru[lnFileStru,2] = 'N'
laFileStru[lnFileStru,3] = 10
laFileStru[lnFileStru,4] = 2

lnFileStru = lnFileStru+1
laFileStru[lnFileStru,1] = 'STARTDATE'
