...
*! Date          : 05/21/2014
*! Reference     : C201620,1{T20140430.0015}
*!*******************************************************************************
*
PRIVATE lcPostDExp
...
PRIVATE llPostDChq
llPostDChq = gfOpenTable('PostDChq','POSTDCHQ','SH') 
...
IF lnPayDate > 0
  ...
  *-- If system uses 4 Char. for Century 
  IF "ON" $ SET('CENTURY')
    loogscroll.laOGFxFlt[lnPayDate,6] = '  /  /    |' + DTOC(oAriaApplication.SystemDate)
