...
*! Date      : 05/20/2008
*! Report    : Shipment cost sheet report For GPS
*! Entry     : C200906,[T20061128.0001]
*!*************************************************************
                  ...
                  ENDFOR
               	...
               	REPLACE COST&lcI.Cod WITH BOMLINE.MFGCODE  ;
                      	...
                      	COSTSTAT&lcI WITH BOMLINE.CCOSTSTAT,;
                       	...
                       	COST&lcI.PER WITH IIF('*ROYALT*' $ laCostItem[lnPos  ,2], RoyalPer ,BOMLINE.Npercent)
...
SCAN 
  ...
  IF lnD > 0
    ...
    lnDutable = (NfCost1 &lcPMethod  NDUTYRAT &lcPUnMeth lnNDCURUNIT )*QtyOrg 
