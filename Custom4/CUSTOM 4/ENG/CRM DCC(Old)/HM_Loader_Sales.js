...
if(HM_IsMenu) {
	...
	//document.write("<SCR" + "IPT LANGUAGE='JavaScript1.2' SRC='/" + strPath[1] + "/menu/HM_Arrays_Sales.js' TYPE='text/javascript'></SCR" + "IPT>");
	...
	if(strFolder[1] == "asp" || strPath[1] == "catalog" || strPath[1] == "common" || strPath[1] == "customer" || strPath[1] == "celpdesk" || strPath[1] == "invoice" || strPath[1] == "order" || strPath[1] == "ots" || strPath[1] == "ra"){
		//wwwRoot
		document.write("<SCR" + "IPT LANGUAGE='JavaScript1.2' SRC='/" +  "menu/HM_Arrays_Sales.js' TYPE='text/javascript'></SCR" + "IPT>");
