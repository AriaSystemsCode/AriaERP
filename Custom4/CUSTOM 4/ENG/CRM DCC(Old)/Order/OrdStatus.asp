...
<FORM action="OrdStatusResponse.asp" method=post id=form1 name=form1 onsubmit="return FormCheck(form1)">
	...
	'Else
		'strAppUserVar = Session("Rep")
	'End If
	If Trim(Application(strAppUserVar & "Lvl")) = "O" And InStr(1,Application(strAppUserVar),"CHKORD") <= 0 Then
...
<tr>
	<td>
	  <table border="0" width="95%" cellspacing="0" cellpadding="0" align=center>
			<tr>
			  <td width="100%"><strong>Enter your searching criteria to select the order(s) you want to check or just click the search button for all:</strong></td>
			</tr>
	  </table>
	</tD>
</tr>
 ...
 <TD>
    ...
    <table border="1" bordercolor="#111111" width=95% cellspacing="0" style="border-collapse: collapse" cellpadding="0">
        ...
        <tr>
        	...
        	<td class="light_cell">
				&nbsp;<SELECT id=select1 name=selectStatus style="width:150px">
				<OPTION selected value="ALL">All</OPTION>	
				<OPTION value="O">Open</OPTION>
				<OPTION value="C">Complete</OPTION>
				<OPTION value="H">On Hold</OPTION>
				<OPTION value="B">Reported</OPTION>
