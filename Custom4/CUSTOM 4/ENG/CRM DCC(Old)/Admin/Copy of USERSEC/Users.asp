...
<table bordercolor="#111111" border="0" align=center width=95% style="border-collapse: collapse" cellpadding="0" cellspacing="0">
  <tr>
    <td>
    <form name=frmSelectType method=get>
    <table bordercolor="#111111"  align=center border="1" width=95% style="border-collapse: collapse" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="6" class='Dark_Cell'><div align="right"><a href="Default.asp"><font color="#FFFFFF">Back 
              to users' security page</font></a> </div></td>
        </tr>
        <tr> 
          <td colspan="6" class='Title'><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif"><strong>CRM 
              Users List</strong></font></div></td>
        </tr>
        <tr> 
          <td colspan="1" class='Dark_Cell'>Users Type</td>
          <td colspan="5" class='Light_Cell'>
...
%>
        <tr> 
			  ...
			  %>&nbsp;</font></td>			  
			  <td colspan="1" class='Light_cell'><font color="#ff0000"><%if not IsNull(rsUsers.Fields.Item("profile").Value) then Response.Write "Yes" %>&nbsp;</font></td>
        </tr>
        <% 
