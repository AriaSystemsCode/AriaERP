...
'wal_127343 add Cust PO and UPS[strat]
Session("strLine") = Session("strLine") & " AND CustPO=" & Request("radCustPO")
Session("strLine") = Session("strLine") & " AND UPS=" & Request("radUPS")
'wal_127343 add Cust PO and UPS[end]
Session("strLine") = Session("strLine") & " AND Weight=" & Request("radWeight")
Session("strLine") = Session("strLine") & " AND Carton=" & Request("radCarton")
'wal_ issue# 128815 add Contract ID on setup[start]
Session("strLine") = Session("strLine") & " AND ContID=" & Request("radContID")
...
'wal_130522 add an option to show immedaite OTS rather than OTS+WIP
Session("strLine") = Session("strLine") & " AND ImmOTS=" & Request("radImmOTS")
...
if trim(Session("StateField")) = "" then
	Session("StateField")  = "State"
end if
if trim(Session("ZipField")) = "" then
	Session("ZipField")  = "Zip Code"
end if
if trim(Session("CityField")) = "" then
...
Session("strLine") = Session("strLine") & " AND ContractField=" & Session("ContractField")
