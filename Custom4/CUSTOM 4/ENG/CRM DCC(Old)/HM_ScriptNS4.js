...
* You may use this code for non-commercial purposes only if this entire
...
function HM_f_GetItemHtmlStr(arraystring,srtLink){
	var TempString = arraystring;
	if (HM_FontBold) TempString = TempString.bold();
	if (HM_FontItalic) TempString = TempString.italics();
	
	TempString = "<A HREF=\"" + srtLink + "\" TARGET='_parent'><FONT FACE='" + HM_FontFamily + "' POINT-SIZE=" + HM_FontSize + ">" + TempString + "</FONT></A>";
...
function HM_f_MakeMenu(menucount) {
	...
	while (HM_CurrentMenu.itemCount < HM_CurrentMenu.maxItems) {
		...
		//alert("window." + HM_ItemIDPrefix + menucount + "_" + HM_CurrentMenu.itemCount)
		...
		if(!HM_CurrentItem) {
			...
			//HM_CurrentItem.document.write("soso")
		}
...
function HM_f_ItemSetup(itemidsuffix) {
	...
	var HtmlStrings = HM_f_GetItemHtmlStr(this.dispText,this.linkText);
