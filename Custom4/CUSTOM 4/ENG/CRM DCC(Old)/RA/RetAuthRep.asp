...
<Title>CRM - Return Authorization Request - R.A. # <%=Request("RanoNo")%></Title>
</HEAD>
...
ELSE
	...
	IF Len(trim(session("rep")))>0 THEN
		strSQL = "SELECT Raline.Reason, CodesReason.Cdiscrep AS reasonDisc,Raline.Style, Style.Desc1, Raline.Price, Raline.Qty1, Raline.Qty2, Raline.Qty3, Raline.Qty4, Raline.Qty5, Raline.Qty6, Raline.Qty7, Raline.Qty8, Raline.Totqty, (Raline.Totqty * Raline.Price) AS Amount, Raline.Nopnqty1,Raline.Nopnqty2,Raline.Nopnqty3,Raline.Nopnqty4,Raline.Nopnqty5,Raline.Nopnqty6, Raline.Nopnqty7,Raline.Nopnqty8, Raline.Ntotopnqty, (Raline.Ntotopnqty * Raline.Price) As OpnAmount ,  Scale.Sz1, Scale.Sz2,  Scale.Sz3,  Scale.Sz4, Scale.Sz5, Scale.Sz6, Scale.Sz7, Scale.Sz8,Raline.Rano FROM Raline,Codes AS CodesReason,Style,Scale WHERE Style.Style=Raline.Style AND Scale.Scale=Style.Scale AND Scale.Type='S' AND Raline.Rano='" & session("rsRanoMatch")("Rano") & "' AND Raline.Account='" & Session("customerID") & "'"
	ELSE
		strSQL = "SELECT Raline.Reason, CodesReason.Cdiscrep AS reasonDisc,Raline.Style, Style.Desc1, Raline.Price, Raline.Qty1, Raline.Qty2, Raline.Qty3, Raline.Qty4, Raline.Qty5, Raline.Qty6, Raline.Qty7, Raline.Qty8, Raline.Totqty, (Raline.Totqty * Raline.Price) AS Amount, Raline.Nopnqty1,Raline.Nopnqty2,Raline.Nopnqty3,Raline.Nopnqty4,Raline.Nopnqty5,Raline.Nopnqty6, Raline.Nopnqty7,Raline.Nopnqty8, Raline.Ntotopnqty, (Raline.Ntotopnqty * Raline.Price) As OpnAmount ,  Scale.Sz1, Scale.Sz2,  Scale.Sz3,  Scale.Sz4, Scale.Sz5, Scale.Sz6, Scale.Sz7, Scale.Sz8,Raline.Rano FROM Raline,Codes AS CodesReason,Style,Scale WHERE Style.Style=Raline.Style AND Scale.Scale=Style.Scale AND Scale.Type='S' AND Raline.Rano='" & session("rsRanoMatch")("Rano") & "' AND Raline.Account='" & Session("ID") & "'"
	END IF
	...
	Session("rsRanoDetail").Open strSQL, conn
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
		...
		'session("oRpt").FormulaFields(0)=1
...
<br>
<CENTER>
<a href = "ReturnStatusDetail.asp?RanoNo=<%=Request("RanoNo")%>"><Img src="../Images/<%=Session("Theme")%>/back.gif" border=0></a>
</CENTER>
<br>
</BODY>
</HTML>