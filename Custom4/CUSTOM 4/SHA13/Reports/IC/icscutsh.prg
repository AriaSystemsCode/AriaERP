...
*: Program desc. : Custom Special Cut and Sold Report for SHA13
*: TRACK NO      : C201355.exe ,C201354.122(T20110502.0021)
*: System        : Aria4XP
...
DIMENSION laTempStru[64,18] , laTempTran[1,18] , laTempCust[1,18], laTempsty[1,18],laTemplINE[1,18]
...
laTempStru[63,1] = 'nPrice'
laTempStru[63,2] = 'N'
laTempStru[63,3] = 12
laTempStru[63,4] = 2

laTempStru[64,1] = 'cClrDesc'
laTempStru[64,2] = 'C'
laTempStru[64,3] = 30
laTempStru[64,4] = 0
...
IF  XBYSIZE='Y'
  ...
  loOgScroll.lcOGLastForm ='ICSCUTSH'
  LCRPFORM = 'ICSCUTSH'
ELSE
  ...
  loOgScroll.lcOGLastForm ='ICSCUTHB'
  LCRPFORM ='ICSCUTHB'
ENDIF
...
ELSE
  loOgScroll.laCRParams[7,1] = 'PPRICE'
  loOgScroll.laCRParams[7,2]= IIF(lcRPPrc = 'N',1,IIF(lcRPPrc ='A',2,IIF(lcRPPrc ='B',3,IIF(lcRPPrc ='C',4,5))))
ENDIF
...
lcSylefields= lcSylefields+ " ,PRICEA,PRICEB,PRICEC,nsugretpri"
...
SCAN
  ...
  llHastran=.f.
  m.cClrDesc = gfCodDes(SUBSTR(STYLE,lnClrPo,lnColorLen), "COLOR")
  IF lcRPPrc <> 'N'
    m.nPrice = IIF(lcRPPrc ='A',PRICEA,IIF(lcRPPrc ='B',PRICEB,IIF(lcRPPrc ='C',PRICEC,nsugretpri)))
  ENDIF  
