*:***************************************************************************
*: Program file  : ALPIKTKS
*: Program desc. : MOMENTRENDS ALLOCATION PIKTICKT LOG CUSTOM
*! Date          : 03/09/17
...
*: C201967,1 SARA.O 03/09/2017  Add Special Instructions [T20161207.0004]
*:***************************************************************************
...
* N000682,1 31/12/2012 Thabet  Handle globalization issues [END]
  IF USED(lcTempOrdHdr)
    ...
    * C201967,1 03/09/2017 SARA.O Add Special Instructions [Start]
    *SELECT CORDTYPE,ACCOUNT,ORDER,cCurrCode,Nexrate,NcurrUnit,SHIPVIA,Start,Complete FROM &lcTempOrdhd WHERE .F. into CURSOR &lcTempOrdHdr READWRITE
    SELECT CORDTYPE,ACCOUNT,ORDER,cCurrCode,Nexrate,NcurrUnit,SHIPVIA,SPCINST,Start,Complete FROM &lcTempOrdhd WHERE .F. into CURSOR &lcTempOrdHdr READWRITE
    * C201967,1 03/09/2017 SARA.O Add Special Instructions [End]
...
IF !USED(lcPickTmp)
  IF TYPE("laTempStru[1,1]") $ "UL"
    ...
    * C201967,1 03/09/2017 SARA.O Add Special Instructions [Start]
    =lfAddField("laTempStru","SPCINST","C",15,0)
    * C201967,1 03/09/2017 SARA.O Add Special Instructions [End]
  ENDIF
...
*loDBFOrdhdr   = CreateObject("RemoteTable","Ordhdr","Ordhdr",lcTempOrdhd,SET("DATASESSION"))
  ...
  *SCATTER FIELDS ACCOUNT,ORDER,CORDTYPE,cCurrCode,Nexrate,NcurrUnit,SHIPVIA,Start,Complete MEMO MEMVAR
  SCATTER FIELDS ACCOUNT,ORDER,CORDTYPE,cCurrCode,Nexrate,NcurrUnit,SHIPVIA,SPCINST,Start,Complete MEMO MEMVAR
  * C201967,1 03/09/2017 SARA.O Add Special Instructions [End]
  *: E303473,1 MMT 05/13/2014 Add complete and start dates to Picking ticket log report[End]
...
SCAN FOR &lcScanExp AND Piktkt # '******' .AND. !EMPTY(Piktkt)
  ...
  * C201967,1 03/09/2017 SARA.O Add Special Instructions [Start]
  M.SPCINST=   SUBSTR(gfCodDes(EVAL(LCTEMPORDHDR+'.SPCINST'),'SPCINST'),1,20)
  * C201967,1 03/09/2017 SARA.O Add Special Instructions [End]
