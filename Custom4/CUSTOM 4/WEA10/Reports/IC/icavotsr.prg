...
*: Aria27 Tracking    : C102642 [B606540,1]
*: Aria4 Ticket Number: T20070117.0016
*: Aria4 Tracking     : C200746
*:***************************************************************************
...
*:***************************************************************************
*: Modifications :
*: B608055,1 MMT 04/19/2007 fix bug of wrong style length. T20070117.0016       
*:***************************************************************************
...
*B608055,1 MMT 04/19/2007 fix bug of wrong style length [Start]
*=lfAddField("laPrntTemp","Style"   ,"C",6,0)
=lfAddField("laPrntTemp","Style"   ,"C",7,0)
*B608055,1 MMT 04/19/2007 fix bug of wrong style length [End]
 ...
 *    lcStylText = LEFT(STYLE.STYLE , 6) + SUBSTR(STYLE.STYLE , lnClrPosAv , 4)
  IF lcStylText # LEFT(STYLE.STYLE , 7) + SUBSTR(STYLE.STYLE , lnClrPosAv , 4)
     lcStylText = LEFT(STYLE.STYLE , 7) + SUBSTR(STYLE.STYLE , lnClrPosAv , 4)
*B608055,1 MMT 04/19/2007 fix bug of wrong style length [End]
