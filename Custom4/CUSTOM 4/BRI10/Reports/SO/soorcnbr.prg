...
*! B609600,1 MMT 06/02/2011 Fix bug of change order status to printed after Previewing the custom order confirmation form BR[T20110531.0006]
*:**************************************************************************
...
*!*************************************************************
*: C200990,1 MMH 05/08/2008 add color to the report and also some piks [Start]
*! B609600,1 MMT 06/02/2011 Fix bug of change order status to printed after Previewing the custom order confirmation form BR[Start]
*FUNCTION lfUpdate
FUNCTION lfPFupdate
*! B609600,1 MMT 06/02/2011 Fix bug of change order status to printed after Previewing the custom order confirmation form BR[End]
