*!*  ************************************************************************
*!*  Descrption    : Custom Assortemnt program for BRI10
*!*  Developer     : Mariam Mazhar (MMT)
*!*  Date          : 11/10/2009
*!*  Entry #       : A40 ==> C201202,A27==>C201201[T20090105.0024]
*!*  ************************************************************************
*!* Modifications;
*B609097,1 TMI 11/25/2009 change the function name to not meet the one in SMCODES.PRG to avoide problems [T20090105.0024] 
*C202203,1 MMT 08/20/2018 Convert GLDIST and STYINVJL to SQL
*!*  ************************************************************************
...
IF llGlLink 
  ...
  *C202203,1 MMT 08/20/2018 Convert GLDIST and STYINVJL to SQL[Start]
*!*	  USE
*!*	  SELECT GLDIST  
...
*!*	  ERASE (lcWorkDir+lcTmpGlDt+'.DBF')
  ...
  USE IN (lcTmpGlDt)
  ERASE (lcWorkDir+lcTmpGlDt+'.DBF')
  *C202203,1 MMT 08/20/2018 Convert GLDIST and STYINVJL to SQL[End]
ENDIF
WAIT CLEAR
SELECT STYLE 
=gfTableUpdate()
