...
public class StyleCodeAutoComplete : System.Web.Services.WebService {

    public StyleCodeAutoComplete () {
    ...
    public string[] GetCompletionList(string prefixText, int count)
    {
        ...
        if (size == 1 && xssss.Rows[0]["style"].ToString().TrimEnd() == prefixText.TrimEnd())
        {
            return null;
        }
