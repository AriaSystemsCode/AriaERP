...
/// <summary>
/// Summary description for CustomerCityAutoComplete
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
[System.Web.Script.Services.ScriptService]
public class CustomerCityAutoComplete : System.Web.Services.WebService {

    public CustomerCityAutoComplete () {
    ...
    public string[] GetCompletionList(string prefixText, int count)
    {
        ...
        ((AriaStandardDataType)condition.LeftHandSide).PropertyDataPathDictionary.Add("Value", "City"); // Field
        ...
        if (size == 1 && xssss.Rows[0]["City"].ToString().TrimEnd() == prefixText.TrimEnd())
        {
            return null;
        }
