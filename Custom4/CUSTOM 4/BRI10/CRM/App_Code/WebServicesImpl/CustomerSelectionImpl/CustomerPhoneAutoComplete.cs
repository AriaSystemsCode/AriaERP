...
public class CustomerPhoneAutoComplete : System.Web.Services.WebService
{

    public CustomerPhoneAutoComplete()
    {
    ...
    public string[] GetCompletionList(string prefixText, int count)
    {
        ...
        ((AriaStandardDataType)condition.LeftHandSide).PropertyDataPathDictionary.Add("Value", "Phone"); // Field
        ...
        if (size == 1 && xssss.Rows[0]["Phone"].ToString().TrimEnd() == prefixText.TrimEnd())
        {
            return null;
        }
