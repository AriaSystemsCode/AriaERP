...
public class CustomerNameAutoComplete : System.Web.Services.WebService {

    public CustomerNameAutoComplete () {
    ...
    public string[] GetCompletionList(string prefixText, int count)
    {
        ...
        ((AriaStandardDataType)condition.LeftHandSide).PropertyDataPathDictionary.Add("Value", "Name"); // Field
        ...
        if (size == 1 && xssss.Rows[0]["Name"].ToString().TrimEnd() == prefixText.TrimEnd())
        {
            return null;
        }
