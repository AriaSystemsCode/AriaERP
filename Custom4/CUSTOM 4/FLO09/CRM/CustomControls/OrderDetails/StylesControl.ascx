        ...
        <table style="border: solid 2px #cbd9fe; background-color: #eff3ff; height: 44px" id="TABLE1" language="javascript" >
            ...
            <tr>
                ...
                <td style="height: 29px">
                    <asp:TextBox ID="StyleCode" runat="server" Width="78px" OnTextChanged="StyleCode_Selected" MaxLength="12"></asp:TextBox></td>
                <td style="height: 29px">
                    <asp:Label ID="Label2" runat="server" Text="Color:"></asp:Label></td>
                <td style="height: 29px">
                    <asp:DropDownList ID="ColorCode" runat="server" Width="86px" OnTextChanged="ColorCode_TextChanged" Height="22px" OnSelectedIndexChanged="ColorCode_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                <td style="height: 29px">
                    <asp:Label ID="Label11" runat="server" Text="Size:"></asp:Label></td>
                <td style="width: 10px; height: 29px;" dir="ltr">
                  <asp:DropDownList ID="ScaleCode" runat="server" Width="48px" Height="22px" OnSelectedIndexChanged="ScaleCode_SelectedIndexChanged">
                  </asp:DropDownList>
                </td>
                ...
                <td style="height: 29px">
                    <asp:Button ID="UpdateLineBtn" runat="server" Text="Update Line" Width="75px" Height="24px" OnClientClick = "UpdateOrderLine()"/>
                    <input id="Button11" type="button" value="button" onclick = "UpdateOrderLine(); "/>
                    </td>
                <td style="width: 10px; height: 29px;">
                </td>
                <td style="height: 29px">
