...
*! B609397,1 SMA 08/31/2010 fix bug of stadard fields missing from almnfhst  [T20100106.0003]
*!*****************************************************************************************
...
SCAN
  ...
  IF !FOUND()
    ...
    m.cQty=m.Qty
    *B609397,1 SMA 08/31/2010 fix bug of stadard fields missing from almnfhst  ....[BEGIN]
    m.cAdd_USer = oAriaApplication.User_ID
    m.cAdd_Time = gfGettime()
    m.dAdd_Date = oAriaApplication.SystemDate
    *B609397,1 SMA 08/31/2010 fix bug of stadard fields missing from almnfhst  ....[END]
    GATHER MEMVAR MEMO
  ENDIF
ENDSCAN
SELECT almnfhst
