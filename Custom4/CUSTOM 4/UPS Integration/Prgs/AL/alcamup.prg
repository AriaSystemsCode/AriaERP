...
*:B609843,1 MMT 02/22/2012 Custom export UPS prg (UPS Integ.) export incorrect Shipvia[T20120220.0030]       
*:***************************************************************************
*:
...
*:B609843,1 MMT 02/22/2012 Custom export UPS prg (UPS Integ.) export incorrect Shipvia[Start]
...
ELSE
*:B609843,1 MMT 02/22/2012 Custom export UPS prg (UPS Integ.) export incorrect Shipvia[END]
...
IF loDBFWAREHOUS.SEEK(M.cWarecode)
  ...
  lcWAddr6 = cAddress5
ENDIF
*:B609843,1 MMT 02/22/2012 Custom export UPS prg (UPS Integ.) export incorrect Shipvia[T20120220.0030][Start]
=IIF(EMPTY(M.Store),loDBFCUSTOMER.SEEK('M'+M.Account,'Customer'),loDBFCUSTOMER.SEEK('S'+M.Account+M.Store,'Customer'))
*:B609843,1 MMT 02/22/2012 Custom export UPS prg (UPS Integ.) export incorrect Shipvia[T20120220.0030][END]
STORE '' TO lcUpsCode
