*:***************************************************************************
*: Program file  : SRSPSNI
*: Program desc. : Custom SHIPMENTS BY SALESREP For NIN24
*! Date          : 05/08/2022
...
*E612545,1 MMT 04/28/2022 Automatic emailing of Shipments by Sales Rep. Report [T20220407.0003][End]
	...
	*Date Expression
	...
	ENDIF
  IF lcRpDtFlt ='S'
    lcDatFltr=" INVDATE=CTOD('"+DTOC(oAriaApplication.SystemDate+lnRpDays)+"')"
  ENDIF
	*Collecting the data
	= lfBuildTmp()
	DO lpCollData
...
loOgScroll.lcOGLastForm ='SRSPSNI'
