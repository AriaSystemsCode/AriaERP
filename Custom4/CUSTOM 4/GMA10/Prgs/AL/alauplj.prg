...
*: B610734,1 MMT 06/01/2014 Custom PL template calculates open qty incorrectly[T20131219.0020]
*B610763,1 HES 06/26/2014 Fix the moving cursor issue [GMA R13 Upgrade]
*C201634,1 HES 07/22/2014 Link the carton type in EDIPH to the pack_HDR carton type [GMA Ulta mapping]
*C201849,1 MMT 07/24/2016 Enhance Qty/CTN and unit weight update in Custom PL template[P20160601.0002]
*C201954,1 AHH 02/28/2017 Unable to enter the carton range for a pack when creating a new packing list [T20170208.0074]
*! C201981,1 MMT 03/23/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003]
*! C201981,2 MMT 03/26/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003]
*:************************************************************************
    ...
    *--- and the orde packed.[Begin]
    ...
    OTHERWISE
      ...
      ELSE
        ...
        loFormSet.lnCrtnSeq = IIF(ISNULL(laSq[1]),1,laSq[1])
...
FUNCTION lfActFolder
  ...
  *B610763,1 HES 06/26/2014 Fix the moving cursor issue [START]
  IF loFormSet.ariaForm1.pgfPacking.ActivePage = lnActFolder
    RETURN 
  ENDIF
  *B610763,1 HES 06/26/2014 Fix the moving cursor issue [END  ]
...
FUNCTION lfSelStatus
  ...
  WITH loFormSet.ariaForm1.pgfPacking.DETAIL
    ...
    *C201849,1 MMT 07/24/2016 Enhance Qty/CTN and unit weight update in Custom PL template[P20160601.0002][Start]
    *! C201981,1 MMT 03/23/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003][Start]
    *STORE llDtl2Stat TO  .txtQtyCtn.Enabled ,.txtUnitWeight.Enabled ,.cmdUpdateSel.Enabled 
*    STORE llDtl2Stat TO .cmdCopy.Enabled
    *! C201981,1 MMT 03/23/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003][END]
    *C201849,1 MMT 07/24/2016 Enhance Qty/CTN and unit weight update in Custom PL template[P20160601.0002][End]
  ENDWITH
  SELECT (lnCurAlias)
...
*: B610734,1 MMT 06/01/2014 Custom PL template calculates open qty incorrectly[T20131219.0020][Start]
if !used('CSTPKINF')
  =gfOpenTable('CSTPKINF' ,  'CSTPKINF' , 'SH')
ENDIF
*: B610734,1 MMT 06/01/2014 Custom PL template calculates open qty incorrectly[T20131219.0020][End]
  SELECT Ordline
  gfSetOrder('ORDLINST')
  =gfSEEK('O'+lcOrderNo)
  SCAN REST WHILE CORDTYPE+ORDER+STORE+STYLE+STR(LINENO,6) = 'O'+lcOrderNo
    ...
    *llDefault = .T. &&!SEEK(lcSeekKey,'CSTPKINF')
    =gfSEEK(lcSeekKey,'CSTPKINF')
    llDefault = !gfSEEK(lcSeekKey,'CSTPKINF')    
    *: B610734,1 MMT 06/01/2014 Custom PL template calculates open qty incorrectly[T20131219.0020][End]
    IF llPack
    ...
    IF llAdd
      ...
      *REPLACE Style      WITH IIF(llFrmPikLn,PikLine.Style,OrdLine.Style),;             
        ...
        REPLACE Style      WITH IIF(llFrmPikLn,PikLine.Style,OrdLine.Style),;             
              ...
              OrgStyWgh  WITH Style.nStyWeight,;
              PkStyQty   WITH SPCK_LIN.QTY&lcSz,;
              CtnQty     WITH IIF(llPack , CSTPKINF.NINPACK * SPCK_LIN.QTY&lcSz , CSTPKINF.NINPACK ),; &&mmq
...
*: B610734,1 MMT 06/01/2014 Custom PL template calculates open qty incorrectly[T20131219.0020][Start]
    replace OQty    WITH AvlQty - OrdLine.nPck&lcSz
*: B610734,1 MMT 06/01/2014 Custom PL template calculates open qty incorrectly[T20131219.0020][End]
  ENDFOR
ENDSCAN 
...
FUNCTION lfwDtlBrow
  ...
  *C201849,1 MMT 07/24/2016 Enhance Qty/CTN and unit weight update in Custom PL template[P20160601.0002][Start]
  *! C201981,1 MMT 03/23/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003][Start]
*!*	  loFormSet.ariaForm1.pgfPacking.DETAIL.txtQtyCtn.Value = IIF(loFormSet.llShoPckSu,loFormSet.lnBrCtnQty,EVALUATE(loFormSet.lcSumPck+'.PkCtnQty'))
*!*	  loFormSet.ariaForm1.pgfPacking.DETAIL.txtUnitWeight.Value = loFormSet.lnBrUntWgh 
  *! C201981,1 MMT 03/23/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003][END]
  *C201849,1 MMT 07/24/2016 Enhance Qty/CTN and unit weight update in Custom PL template[P20160601.0002][End]
...
*!*    ENDIF
  ...
  *-- to control showing of Select by pack
  ...
  WITH loFormSet.ariaForm1.pgfPacking.DETAIL
    ...
    *C201849,1 MMT 07/24/2016 Enhance Qty/CTN and unit weight update in Custom PL template[P20160601.0002][Start]
    *! C201981,1 MMT 03/23/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003][Start]
*!*	    STORE IIF(loFormSet.ActiveMode = 'V',.F.,(lnSlected <> 0)) TO .txtQtyCtn.Enabled ,.txtUnitWeight.Enabled ,.cmdUpdateSel.Enabled 
*    STORE loFormSet.ActiveMode <> 'V' TO .cmdCopy.Enabled
    *! C201981,1 MMT 03/23/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003][END]
    *C201849,1 MMT 07/24/2016 Enhance Qty/CTN and unit weight update in Custom PL template[P20160601.0002][End]
...
IF llFound
  *! C201981,2 MMT 03/26/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003][Start] 
  *SCAN FOR lSelect  
  SCAN FOR lSelect AND NCARTON = 0
  *! C201981,2 MMT 03/26/2017 Add pack & copy all to PL template and scope to Auto PL[T20160527.0003][End] 
...
IF _tally > 0 AND !ISNULL(loFormSet.lnCrtnSeq)
...
ENDIF 
*: B610734,1 MMT 06/01/2014 Custom PL template calculates open qty incorrectly[T20131219.0020][Start]
lcOldVal=iif(isnull(oldVal('StyWgh',loFormSet.lcTmpPck)),0,oldVal('StyWgh',loFormSet.lcTmpPck))
*: B610734,1 MMT 06/01/2014 Custom PL template calculates open qty incorrectly[T20131219.0020][End]
...
*C201634,1 HES 07/22/2014 Link the carton type in EDIPH to the pack_HDR carton type [START]
lnCtnTyp = 0
IF loFormSet.llEdiAcc
  STORE IIF(EDIPH.ccrtntype = "S",1,2) TO lnCtnTyp
ELSE 
*C201634,1 HES 07/22/2014 Link the carton type in EDIPH to the pack_HDR carton type [END  ]
...
IF gfSEEK(lcOrder,'TMPL_HDR')
  ...
  gfDELETE() 
ENDIF  
*C201954,1 AHH 02/28/2017 Unable to enter the carton range for a pack when creating a new packing list [T20170208.0074][Begin]
SELECT TMPL_HDR
*C201954,1 AHH 02/28/2017 Unable to enter the carton range for a pack when creating a new packing list [T20170208.0074][End]
=gfSetOrder(lcHdrTag)
...
*!*	*! Developer : Mariam Mazhar
*!*	*! Date      : 07/24/2016
*!*	*! Purpose   : Function to select range of records in grid
*!*	*!*************************************************************
*!*	FUNCTION lfAddregOn
*!*	LPARAMETERS loFormSet,lnCurrentRec, lnLastRec
*!*	LOCAL lcLastAlias
*!*	lcLastAlias = ALIAS()

*!*	*-- Select 
*!*	SELECT(loFormSet.ariaForm1.pgfPacking.Detail.grdDetail.RecordSource)
...
*!*	*--> Seek to current record down and top
*!*	LOCAL lnTemp
*!*	lnTemp = 0
*!*	DO WHILE .T.
*!*	  LOCAL llBOF, llEOF
...
*!*	ENDDO
*!*	  
*!*	*-- Retrun to last position
*!*	GOTO IIF(llDirection, lnLastRec, lnCurrentRec)

*!*	*-- Loop from last record to current record
*!*	SCAN REST
*!*	  REPLACE lSelect WITH .T.
*!*	   
*!*	  *-- Do it reach to last record? 
*!*	  IF (llDirection .AND. RECNO() = lnCurrentRec) .OR. ;
*!*	   (!llDirection .AND. RECNO() = lnLastRec)
*!*	    EXIT
*!*	  ENDIF
*!*	ENDSCAN 
*!*	  
...
*!*	*! Developer : Mariam Mazhar
*!*	*! Date      : 07/24/2016
*!*	*! Purpose   : Function to update selected lines
*!*	*!*************************************************************
*!*	FUNCTION lfUpdateSel
*!*	LPARAMETERS loFormSet
*!*	LOCAL lcLastAlias
*!*	lcLastAlias = ALIAS()
*!*	SELECT(loFormSet.ariaForm1.pgfPacking.Detail.grdDetail.RecordSource)
*!*	lnRecNum = RECNO()
*!*	lnQtyPerCtn = loFormSet.ariaForm1.pgfPacking.Detail.txtQtyCtn.Value
*!*	lnUnitWieght = loFormSet.ariaForm1.pgfPacking.Detail.txtUnitWeight.Value
*!*	*!*	IF loFormSet.llShoPckSu
*!*	*!*	  REPLACE CtnQty WITH lnQtyPerCtn ,;
*!*	*!*	          StyWgh WITH lnUnitWieght FOR lSelect 
*!*	*!*	ELSE
*!*	*!*	  REPLACE PkCtnQty WITH lnQtyPerCtn ,;
*!*	*!*	          PTotWgh WITH lnUnitWieght FOR lSelect 
*!*	*!*	ENDIF  
...
*!*	  DO CASE
*!*	    CASE ALIAS() = lcTmpPck
*!*	      REPLACE StyWgh WITH lnUnitWieght
*!*	      IF EVAL(lcTmpPck+'.LRANGE')=.T.
*!*	        REPLACE DisCtnQty WITH lnQtyPerCtn 
*!*	        REPLACE CtnQty WITH DisCtnQty
*!*	        DIMENSION laCtnSum[1]
*!*	        laCtnSum[1] = 0
*!*	        IF !EMPTY(PACK_ID)
...
*!*	IF BETWEEN(lnRecNum,1,RECCOUNT(loFormSet.ariaForm1.pgfPacking.Detail.grdDetail.RecordSource))
*!*	  GO RECORD lnRecNum IN (loFormSet.ariaForm1.pgfPacking.Detail.grdDetail.RecordSource)
*!*	ENDIF
*!*	IF !EMPTY(lcLastAlias)
*!*	  SELECT(lcLastAlias)
*!*	ENDIF
...
*!*	*! Developer : Mariam Mazhar
*!*	*! Date      : 07/24/2016
*!*	*! Purpose   : Function to check if entered weight is Zero
*!*	*!*************************************************************
*!*	FUNCTION lfvQtyPerCt
*!*	PARAMETERS loFormSet
*!*	IF  loFormSet.ariaForm1.pgfPacking.Detail.txtQtyCtn.Value = 0
*!*	  =gfModalGen('INM00000B00000',.F.,.F.,.F.,'Qty./Ctn. can not be zero.')
*!*	  loFormSet.ariaForm1.pgfPacking.Detail.txtQtyCtn.Value = loFormSet.ariaForm1.pgfPacking.Detail.txtQtyCtn.OldValue  
*!*	  RETURN 0
*!*	ENDIF
*!*	*C201849,1 MMT 07/24/2016 Enhance Qty/CTN and unit weight update in Custom PL template[P20160601.0002][End]
*!*************************************************************
...
*! Developer : Mariam Mazhar
*! Date      : 03/23/2017
*! Purpose   : Function to copy to all 
*!*************************************************************
FUNCTION lfCopyToAll
PARAMETERS loFormSet
lnAlias = SELECT(0)
IF loFormSet.llShoPckSu
  SELECT(loFormSet.lcTmpPck)
  lnRecSel = RECNO()
  lnQtyPerCtn = EVALUATE(loFormSet.lcTmpPck+'.CtnQty')
  lnStyWght = EVALUATE(loFormSet.lcTmpPck+'.StyWgh')
  lnDisCtnQty= EVALUATE(loFormSet.lcTmpPck+'.DisCtnQty')
  LOCATE FOR lSelect 
  IF FOUND()
    REPLACE CtnQty WITH lnQtyPerCtn  ,;
            StyWgh WITH lnStyWght ,;
            DisCtnQty WITH IIF(LRange,DisCtnQty,lnDisCtnQty) FOR lSelect IN (loFormSet.lcTmpPck)  
  ELSE
    REPLACE CtnQty WITH lnQtyPerCtn  ,;
            StyWgh WITH lnStyWght ,;
            DisCtnQty WITH IIF(LRange,DisCtnQty,lnDisCtnQty) FOR NCARTON = 0 IN (loFormSet.lcTmpPck)  
  ENDIF
  IF BETWEEN(lnRecSel,1,RECCOUNT(loFormSet.lcTmpPck))
    GO RECORD lnRecSel IN (loFormSet.lcTmpPck)
  ENDIF
ELSE
  SELECT(loFormSet.lcSumPck)
  lnRecSel = RECNO()
  
  lnQtyPerCtn = EVALUATE(loFormSet.lcSumPck+'.PkCtnQty')
  lnStyWght   = EVALUATE(loFormSet.lcSumPck+'.PTotWgh')
  lnCtnTotQty = EVALUATE(loFormSet.lcSumPck+'.CtnTotQty')
  LOCATE FOR lSelect 
  IF FOUND()
    REPLACE PkCtnQty WITH lnQtyPerCtn  ,;
            PTotWgh WITH lnStyWght,;
            CtnTotQty WITH lnCtnTotQty FOR lSelect IN (loFormSet.lcSumPck)  
  ELSE
    REPLACE PkCtnQty WITH lnQtyPerCtn  ,;
            PTotWgh WITH lnStyWght,;
            CtnTotQty WITH lnCtnTotQty FOR NCARTON = 0 IN (loFormSet.lcSumPck) 
  ENDIF
  
  IF BETWEEN(lnRecSel,1,RECCOUNT(loFormSet.lcSumPck))
    GO RECORD lnRecSel IN (loFormSet.lcSumPck)
  ENDIF
ENDIF
SELECT(lnAlias)
*!*************************************************************
...
IF loFormSet.llShoPckSu
  ...
  LOCATE FOR lSelect 
  IF FOUND()
    REPLACE CtnQty WITH OQty FOR lSelect IN (loFormSet.lcTmpPck)  
  ELSE
    REPLACE CtnQty WITH OQty ALL IN (loFormSet.lcTmpPck)  
  ENDIF
  IF BETWEEN(lnRecSel,1,RECCOUNT(loFormSet.lcTmpPck))
    GO RECORD lnRecSel IN (loFormSet.lcTmpPck)
  ENDIF
ELSE
  ...
  LOCATE FOR lSelect 
  IF FOUND()
    REPLACE CtnTotQty WITH OTotQty FOR lSelect IN (loFormSet.lcSumPck)  
  ELSE
    REPLACE CtnTotQty WITH OTotQty ALL IN (loFormSet.lcSumPck) 
  ENDIF
  IF BETWEEN(lnRecSel,1,RECCOUNT(loFormSet.lcSumPck))
    GO RECORD lnRecSel IN (loFormSet.lcSumPck)
  ENDIF
