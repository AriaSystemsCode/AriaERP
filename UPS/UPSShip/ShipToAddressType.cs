...
// Type: UPS.UPSShip.ShipToAddressType
...
namespace UPS.UPSShip
{
    ...
    [Serializable]
    public class ShipToAddressType : ShipAddressType
    {
      private string residentialAddressIndicatorField;

      public string ResidentialAddressIndicator
      {
        get => this.residentialAddressIndicatorField;
        set => this.residentialAddressIndicatorField = value;
      }
    }
}
