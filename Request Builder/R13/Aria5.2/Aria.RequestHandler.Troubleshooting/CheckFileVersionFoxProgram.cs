...
{
    public class CheckFileVersionFoxProgram : Check
    {
        ...
        public CheckFileVersionFoxProgram(string ProgramName, string ProgramModule, string ProgramPath, string CurrentVersion)
        {
        ...
        {            
            ...
            else if (!File.Exists(AriaVars.cReportsPath + ProgramPath))
            {
                CheckResult = CheckResult.Failed;
                CheckError = "File " + AriaVars.cReportsPath + ProgramPath + " not found";
                return;
            }
            else if (Path.GetExtension(AriaVars.cReportsPath + ProgramPath) != ".FXP")
            {
                CheckResult = CheckResult.Failed;
                CheckError = "File " + AriaVars.cReportsPath + ProgramPath + " is not a Fox Program";
                return;
            }
            ...
            fox.DoCmd("DO GetFileVersion.FXP WITH '" + AriaVars.cReportsPath + ProgramPath + "', '" + cAppDataPath + @"\Temp.txt'");
            fox.Quit();
