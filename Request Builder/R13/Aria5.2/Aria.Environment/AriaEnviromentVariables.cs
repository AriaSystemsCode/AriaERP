...
namespace Aria.Environment
{
    public class AriaEnviromentVariables : MarshalByRefObject
    {
        ...
        public Dictionary<string, string> _cached27DataConnectionString = new Dictionary<string, string>();
        public Dictionary<string, string> _cached04DataConnectionString = new Dictionary<string, string>();
        ...
        //public bool ServerSettingsLoaded { get; set;  }
        ...
        private void ReadServerSettings()
        {
            ...
            // Create from Aria4XP Installation
            if (!File.Exists(Path.Combine(Application.StartupPath, "configuration settings.xml"))) return;

            string xmlFileName = Path.Combine(Application.StartupPath, "configuration settings.xml");
        ...
        private void ReadClientSettings(string clientId)
        {
            ...
            Aria40ClientPath = Aria40ClientPath.Replace(@"\SysFiles", "");
        ...
        // Need to cache ODBC
        public void ReadCompanySettings(string companyId)
        {
            //put a log here to know where the function looks, you can know the problem immediately
            // tarek 22/5/2014
            ...
            OdbcHelper.LoadDataTable(setupDt, setupCmd, this.Aria40ClientPath, "ReadCompanySettings_" + companyId);
            // Need to cache ODBC
        ...
        public string GetAria27CompanyDataConnectionString(string companyID)
        {
            ...
            OdbcHelper.LoadDataTable(row, command, this.Aria40ClientPath, "GetAria27CompanyDataConnectionString_" + companyID);
            // Need to cache ODBC
        ...
        public string GetAria04CompanyDataConnectionString(string companyID)
        {
            ...
            // Need to cache ODBC
            //row.Load(command.ExecuteReader());
            //MessageBox.Show(this.Aria40ClientPath);
            OdbcHelper.LoadDataTable(row, command, this.Aria40ClientPath, "GetAria04CompanyDataConnectionString_" + companyID);
            // Need to cache ODBC
        ...
        public string GetAria04CompanyDataConnectionStringODBC(string companyID)
        {
            ...
            // Need to cache ODBC
            //row.Load(command.ExecuteReader());
            OdbcHelper.LoadDataTable(row, command, this.Aria40ClientPath, "GetAria04CompanyDataConnectionStringODBC_" + companyID);
            // Need to cache ODBC
        ...
        public string ResolveMappedDrive(string path)
        {
            ...
            OdbcHelper.LoadDataTable(sycinst, sycinstCommand, this.Aria40ClientPath, "ResolveMappedDrive");
            // Need to cache ODBC
            ////test
        ...
        {
            File.AppendAllText(path, "Start:" + ClientID + System.Environment.NewLine);
            System.Threading.Thread.Sleep(60 * 1000);
            File.AppendAllText(path, "End:" + ClientID + System.Environment.NewLine);
        }
        ...
        public AriaEnviromentVariables GetInstance()
        {
            return new AriaEnviromentVariables();
        }
    }
