...
namespace Aria.Configuration.Server
{
    public class DatabaseUtilities
    {
        ...
        {
            if (Directory.Exists(Path.Combine(Application.StartupPath, "Databases\\" + subDir)))
            {
                string[] dirs = Directory.GetDirectories(Path.Combine(Application.StartupPath, "Databases\\" + subDir));
