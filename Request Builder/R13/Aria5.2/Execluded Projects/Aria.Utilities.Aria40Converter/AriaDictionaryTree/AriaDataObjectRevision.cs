...
{
    class AriaDataObjectRevision : AriaDictionaryObjectCollection
    {
        public AriaObjectRevision AriaObjectRevision = new AriaObjectRevision();

        public AriaDataObjectRevision(AriaDictionaryObject parent)
            : base(parent)
        {
            ...
            SetAriaDataObjectRevisionSettings((AriaDataObjectSettings)AriaObjectRevision.ObjectRevisionSettings,
                                               ((AriaDataObject)AriaDictionaryObject.GetParent(this, typeof(AriaDataObject))).AriaDataObjectTable);
        }
        ...
        public void SetAriaDataObjectRevisionSettings(AriaDataObjectSettings settings, Table table)
       {
            ...
            settings.FixedFilter = ((AriaDataObject)AriaDictionaryObject.GetParent(this, typeof(AriaDataObject))).FixedFilter;
        }

        public override void CreateChildren()
        {
            this.Children.Add(new AriaDataObjectFields(this));
            this.Children.Add(new AriaDataObjectEvents(this));
