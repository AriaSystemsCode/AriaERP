...
{
    class AriaChildDataObjectField : AriaDictionaryObject
    {
        ...
        public AriaChildDataObjectField(AriaDictionaryObject parent, List<IndexField> indexFields, TableField tableField)
            : base(parent)
        {
            ...
            if (AriaSchema.IsNewObjectExist(((AriaChildDataObject)AriaDictionaryObject.GetParent(this, typeof(AriaChildDataObject))).AriaObject.ObjectName))
            {
                AriaSchema.AddObjectProperty(((AriaChildDataObject)AriaDictionaryObject.GetParent(this, typeof(AriaChildDataObject))).AriaObject.ObjectName, AriaDataObjectProperty.PropertyName, ((AriaFieldSettings)AriaDataObjectProperty.PropertySettings).FieldName);
            }

            if (AriaSchema.IsOrgObjectPropertyExist(((AriaChildDataObject)AriaDictionaryObject.GetParent(this, typeof(AriaChildDataObject))).AriaObject.ObjectName, AriaDataObjectProperty.PropertyName))
            {
                AriaDataObjectProperty.PropertyName = AriaSchema.GetNewObjectPropertyName(((AriaChildDataObject)AriaDictionaryObject.GetParent(this, typeof(AriaChildDataObject))).AriaObject.ObjectName, AriaDataObjectProperty.PropertyName).Trim();
            }
            else
            {
        ...
        public override void Save()
        {
            ...
            if (IndexFields.Where(r => r.FieldName.TrimEnd().ToUpper() == TableField.FieldName.TrimEnd().ToUpper()).Count() > 0 ||
                AriaSchema.IsNewObjectPropertyExist(((AriaChildDataObject)AriaDictionaryObject.GetParent(this, typeof(AriaChildDataObject))).AriaObject.ObjectName, AriaDataObjectProperty.PropertyName))
            {
                ...
                objectDictionary.SaveAriaObjectProperty(new AriaDbConnection("Aria", ""),
                                                        ...
                                                        ((AriaChildDataObject)AriaDictionaryObject.GetParent(this, typeof(AriaChildDataObject))).AriaObject.ActiveRevision,
