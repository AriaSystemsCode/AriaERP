...
namespace Aria.EnterpriseServices.RequestHandler.Proxy
{
    ...
    public class AriaRequestProxy : MarshalByRefObject
    {
        ...
        public int GetRequestStatus(string guid, string clientId)
        {
            ...
            command.Parameters.Add(new AriaDbParameter("RequestID", new Guid(guid.Trim())));
            ...
            {
                return (int)((AriaRequest)dataProvider.GetObjectList(command, typeof(AriaRequest))[0]).Status;
            }
        }
