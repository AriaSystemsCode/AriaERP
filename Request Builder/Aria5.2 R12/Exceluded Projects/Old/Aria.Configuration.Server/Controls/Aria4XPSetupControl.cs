...
namespace Aria.Configuration.Server.Controls
{
    ...
    /// </summary>
    public partial class Aria4XPSetupControl : UserControl
    {
        ...
        public Aria4XPSetupControl(Button ownButton, ToolStripProgressBar progressBar)
        {
            InitializeComponent();
        ...
        private void buttonBrowse_Click(object sender, EventArgs e)
        {
            ...
            {
                this.textBoxAria4XPSharedPath.Text = this.folderBrowserDialogAria4XPSharedPath.SelectedPath;
        ...
        private void buttonChangeAccount_Click(object sender, EventArgs e)
        {
            ...
            {                
                try
                {
                    username = textBoxServiceUserName.Text;
