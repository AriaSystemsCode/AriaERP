...
{
    class AriaServerOptionGridOption : AriaDictionaryObject
    {
        public OptionGridVariable OptionGridVariable;

        public AriaObjectProperty AriaDataObjectProperty = new AriaObjectProperty();

        public AriaServerOptionGridOption(AriaDictionaryObject parent, OptionGridVariable optionGridVariable)
            : base(parent)
        {
            OptionGridVariable = optionGridVariable;

            AriaDataObjectProperty.PropertyName = optionGridVariable.Head.RemoveSpecialChar();
