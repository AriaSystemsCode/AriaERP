...
{
    class AriaReportObject : AriaDictionaryObjectCollection
    {
        public AriaObject AriaObject = new AriaObject();
        public OptionGrid AriaReportObjectOptionGrid;

        public AriaReportObject(AriaDictionaryObject parent, OptionGrid optionGrid)
            : base(parent)
        {
            AriaReportObjectOptionGrid = optionGrid;
            AriaReportObjectOptionGrid.ReportID = optionGrid.ReportID.Trim();
            ...
            AriaObject.ObjectType = AriaObjectTypes.Report;
        }
        ...
        {
            this.Children.Add(new AriaReportObjectRevisions(this));
            this.Children.Add(new AriaReportOptionGridObject(this, AriaReportObjectOptionGrid));
            base.CreateChildren();
        } 
    }
}
