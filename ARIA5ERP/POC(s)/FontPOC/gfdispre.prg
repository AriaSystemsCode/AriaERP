...
* MAH FONT
local loPreview1, loListener

do (_ReportPreview) with loPreview1  


loPreview1.TopForm = .T.

loListener = newobject('_ReportListener', "C:\Program Files (x86)\Microsoft Visual FoxPro 9\" + 'ffc\_ReportListener.vcx')


loListener.ListenerType = 1 && preview

loListener.OutputType = 1
loListener.PreviewContainer = loPreview1
loListener.PreviewContainer.ToolbarIsVisible = .T.
loListener.PreviewContainer.TextOnToolbar = .F.
loListener.PreviewContainer.ZoomLevel        = GetZoomLevel()
loListener.PreviewContainer.TopForm = .t.

WAIT WINDOW "Font Scale"
WAIT WINDOW oAriaApplication.FontScale
* MAH FONT
    ...
    IF lcOGPlatForm = 'WINDOW' OR lcOGPlatForm = 'MAC'
      ...
      IF oAriaApplication.glHeader
        ...
        ELSE
          ...
          * MAH FONT
          REPORT FORM (lcOGRprtNam) TO PRINTER PROMPT PREVIEW WINDOW (lcWindName) &lcCriteria. object loListener
          * MAH FONT
...
* MAH FONT
          REPORT FORM (lcOGRprtNam) TO PRINTER PROMPT PREVIEW  WINDOW (lcWindName) PLAIN &lcCriteria. object loListener
* MAH FONT          
      ...
      *-- Print to File ... BEGIN
      PRINTJOB
        IF oAriaApplication.glHeader
          ...
          ELSE
          * MAH FONT
            REPORT FORM (lcOGRprtNam) TO PRINTER  NOCONSOLE NOEJECT &lcCriteria. object loListener
            * MAH FONT
        ...
        ELSE
          ...
          ELSE
          * MAH FONT
            REPORT FORM (lcOGRprtNam) TO PRINTER  NOEJECT NOCONSOLE PLAIN &lcCriteria. object loListener
            * MAH FONT
      ...
      PRINTJOB
        IF oAriaApplication.glHeader
          ...
          ELSE
            IF _PEJECT = 'NONE'
            * MAH FONT
              REPORT FORM (lcOGRprtNam) TO PRINTER PROMPT NOCONSOLE NOEJECT &lcCriteria. object loListener
              * MAH FONT

            ELSE
            * MAH FONT
              REPORT FORM (lcOGRprtNam) TO PRINTER PROMPT NOCONSOLE &lcCriteria. object loListener
              * MAH FONT
        ...
        ELSE
          ...
          ELSE
            ...
            IF _PEJECT = 'NONE'
            * MAH FONT
              REPORT FORM (lcOGRprtNam) TO PRINTER PROMPT NOEJECT NOCONSOLE PLAIN &lcCriteria. object loListener
              * MAH FONT

            ELSE
            * MAH FONT
              REPORT FORM (lcOGRprtNam) TO PRINTER PROMPT NOCONSOLE PLAIN &lcCriteria. object loListener
              * MAH FONT
...
DO CASE
CASE oAriaApplication.FontScale > 0 .AND. oAriaApplication.FontScale <= 0.1
  RETURN 1

CASE oAriaApplication.FontScale > 0.1 .AND. oAriaApplication.FontScale <= 0.25
  RETURN 2

CASE oAriaApplication.FontScale > 0.25 .AND. oAriaApplication.FontScale <= 0.50
  RETURN 3

CASE oAriaApplication.FontScale > 0.50 .AND. oAriaApplication.FontScale <= 0.75
  RETURN 4

CASE oAriaApplication.FontScale > 0.75 .AND. oAriaApplication.FontScale <= 1.00
  RETURN 5

CASE oAriaApplication.FontScale > 1.00 .AND. oAriaApplication.FontScale <= 1.50
  RETURN 6

CASE oAriaApplication.FontScale > 1.50 .AND. oAriaApplication.FontScale <= 2.00
  RETURN 7

CASE oAriaApplication.FontScale > 2.00 .AND. oAriaApplication.FontScale <= 3.00
  RETURN 8

CASE oAriaApplication.FontScale > 3.00 .AND. oAriaApplication.FontScale <= 5.00
  RETURN 9
