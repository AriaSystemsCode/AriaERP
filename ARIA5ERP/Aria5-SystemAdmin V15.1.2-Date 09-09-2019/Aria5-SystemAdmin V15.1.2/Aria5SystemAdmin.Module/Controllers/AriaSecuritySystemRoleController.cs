...
namespace Aria5SystemAdmin.Module.Controllers
{
    ...
    public partial class AriaSecuritySystemRoleController : ViewController
    {
        private AriaSecuritySystemUser user;
        private string userName;
        private List<SecuritySystemRole> rolesList;
        public AriaSecuritySystemRoleController()
        {
            InitializeComponent();
        ...
        protected override void OnActivated()
        {
            ...
            if (View is DetailView)
            {
                ...
                user = (View.CurrentObject as AriaSecuritySystemRole).Session.FindObject<AriaSecuritySystemUser>(criteria);

                if (((DetailView)View).ViewEditMode == ViewEditMode.Edit)
                {
                    (View.CurrentObject as AriaSecuritySystemRole).Account = user.Account;
                }
            }
            ...
            //    //Frame.GetController<ChangePasswordController>().Actions["ChangePassword"].Enabled.SetItemValue("Disable", false);
