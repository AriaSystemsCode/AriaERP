...
namespace Aria5SystemAdmin.Module
{
    ...
    public class CustomEditorAriaObjectEventParameterSettings : ASPxPropertyEditor
    {
        ...
        public CustomEditorAriaObjectEventParameterSettings(Type objectType, IModelMemberViewItem info)
        ...
        protected override WebControl CreateEditModeControlCore()
        {
            ...
            try
            {
                ...
                {
                    ColumnType = ((AriaObjectEventParameterSetting)this.CurrentObject).DataType.ToString().ToUpper().TrimEnd();
                    PropertyValueOver = this.PropertyValue.ToString();

                    width = int.Parse(((AriaObjectEventParameterSetting)this.CurrentObject).Width.ToString());
                    decimalPlaces = int.Parse(((AriaObjectEventParameterSetting)this.CurrentObject).DecimalPlaces.ToString());

                    if (((AriaObjectEventParameterSetting)this.CurrentObject).Validvalues != null)
                    { ValidValues = ((AriaObjectEventParameterSetting)this.CurrentObject).Validvalues.ToString().Split(','); };

                    if (((AriaObjectEventParameterSetting)this.CurrentObject).Format != null)
                    { Format = ((AriaObjectEventParameterSetting)this.CurrentObject).Format.ToString().TrimEnd(); };
                }
