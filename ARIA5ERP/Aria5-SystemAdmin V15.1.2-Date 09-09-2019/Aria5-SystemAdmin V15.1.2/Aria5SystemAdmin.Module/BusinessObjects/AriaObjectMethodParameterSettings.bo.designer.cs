...
{
  [DefaultClassOptions]
  public partial class AriaObjectMethodParameterSettings : DevExpress.Persistent.BaseImpl.BaseObject
  {
    private Aria5SystemAdmin.Module.BusinessObjects.SettingType _settingType;
    private Aria5SystemAdmin.Module.BusinessObjects.AriaObjectMethodParameter _ariaObjectMethodParameter;
    public AriaObjectMethodParameterSettings(DevExpress.Xpo.Session session)
      : base(session)
    {
    }
    [DevExpress.Xpo.AssociationAttribute("AriaObjectMethodParameterSettingses-AriaObjectMethodParameter")]
    public Aria5SystemAdmin.Module.BusinessObjects.AriaObjectMethodParameter AriaObjectMethodParameter
    {
      get
      {
        return _ariaObjectMethodParameter;
      }
      set
      {
        SetPropertyValue("AriaObjectMethodParameter", ref _ariaObjectMethodParameter, value);
      }
    }
    ...
    [ModelDefault("PropertyEditorType", "Aria5SystemAdmin.Module.CustomEditorAriaObjectMehtodParameterSettings")]
    ...
    protected override void OnSaving()
    {
      ...
      {
        // this.AriaObjectMethodParameter.AriaObjectMethod.AriaObject.IncrementRevision();
        this.AriaObjectMethodParameter.AriaObjectMethod.Before_Save();
      }
      ;
      base.OnSaving();
    }
