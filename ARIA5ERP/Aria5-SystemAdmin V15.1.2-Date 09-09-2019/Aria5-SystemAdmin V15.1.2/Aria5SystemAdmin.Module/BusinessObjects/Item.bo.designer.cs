...
{
  [DefaultClassOptions]
  [RelatedEntity("Aria5-Windows8Xaml-Item")]
  [DivisionAttribute(true)]
  public partial class Item : Aria5SystemAdmin.Module.BusinessObjects.Entity
  {
    private System.Double _price;
    private System.String _name;
    public Item(DevExpress.Xpo.Session session)
      : base(session)
    {
    }
