...
namespace Aria5SystemAdmin.Module.BusinessObjects
{
       ...
       [Serializable]
  [DefaultClassOptions]
  [RelatedEntity("Aria5-SystemAdmin-AriaObjectMethodParameterSetting")]

  public partial class AriaObjectMethodParameterSetting : DevExpress.Persistent.BaseImpl.BaseObject
  {
    ...
    public AriaObjectMethodParameterSetting(DevExpress.Xpo.Session session)
      : base(session)
    {
    }

    public AriaObjectMethodParameterSetting()
    {
    }
 [XmlIgnore]
