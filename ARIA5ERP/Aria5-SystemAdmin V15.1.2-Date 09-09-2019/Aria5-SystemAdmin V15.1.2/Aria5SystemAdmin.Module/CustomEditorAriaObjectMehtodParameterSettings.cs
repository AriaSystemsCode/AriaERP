...
namespace Aria5SystemAdmin.Module
{
    ...
    public class CustomEditorAriaObjectMehtodParameterSettings : ASPxPropertyEditor
    {
        ...
        public CustomEditorAriaObjectMehtodParameterSettings(Type objectType, IModelMemberViewItem info)
        ...
        protected override WebControl CreateEditModeControlCore()
        {
            ...
            try
            {
                ...
                {
                    ColumnType = ((AriaObjectMethodParameterSetting)this.CurrentObject).DataType.ToString().ToUpper().TrimEnd();
                    PropertyValueOver = this.PropertyValue.ToString();

                    width = int.Parse(((AriaObjectMethodParameterSetting)this.CurrentObject).Width.ToString());
                    decimalPlaces = int.Parse(((AriaObjectMethodParameterSetting)this.CurrentObject).DecimalPlaces.ToString());

                    if (((AriaObjectMethodParameterSetting)this.CurrentObject).Validvalues != null)
                    { ValidValues = ((AriaObjectMethodParameterSetting)this.CurrentObject).Validvalues.ToString().Split(','); };

                    if (((AriaObjectMethodParameterSetting)this.CurrentObject).Format != null)
                    { Format = ((AriaObjectMethodParameterSetting)this.CurrentObject).Format.ToString().TrimEnd(); };
                }
