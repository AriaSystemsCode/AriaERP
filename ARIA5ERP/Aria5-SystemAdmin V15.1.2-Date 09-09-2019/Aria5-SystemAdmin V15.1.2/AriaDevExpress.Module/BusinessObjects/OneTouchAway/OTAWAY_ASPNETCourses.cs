...
namespace AriaDevExpress.Module.BusinessObjects.OneTouchAway
{
    ...
    public class OTAWAYASPNETCourses : XPLiteObject
    {
        int fCourseID;
        [Key(true)]
        ...
        public OTAWAYASPNETCourses(Session session) : base(session) { }
        public OTAWAYASPNETCourses() : base(Session.DefaultSession) { }
