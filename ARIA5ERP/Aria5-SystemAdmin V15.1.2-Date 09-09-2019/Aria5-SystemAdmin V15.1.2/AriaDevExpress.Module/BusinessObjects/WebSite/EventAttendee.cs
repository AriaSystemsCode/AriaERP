...
{
    public class EventAttendee : XPLiteObject
    {
        Event fEventID;
        [Association("EventAttendeeee")]
        [DisplayName("Title")]
        public Event EventID
        {
            get { return fEventID; }
            set { SetPropertyValue<Event>("EventID", ref fEventID, value); }
        }
        ...
        public EventAttendee(Session session) : base(session) { }
        public EventAttendee() : base(Session.DefaultSession) { }
