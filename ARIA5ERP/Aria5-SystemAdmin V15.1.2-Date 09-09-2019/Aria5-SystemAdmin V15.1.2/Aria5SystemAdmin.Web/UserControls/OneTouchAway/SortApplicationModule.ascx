<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SortApplicationModule.ascx.cs" Inherits="AriaDevExpress.Web.UserControls.OneTouchAway.SortApplicationModule" %>
<table width="100%">
    <tr>
        <td width="30%">&nbsp;</td>
...
<asp:LinqDataSource ID="ApplicationLinqDataSource" runat="server" ContextTypeName="AriaDevExpress.Module.OneTouchAwayDataContext.OTAWAYAriaOnlineDataContext" EntityTypeName="" OrderBy="AppRank" Select="new (AppModID, ShortDesc, ToolTip, AppRank)" TableName="OTAWAYApplicationModules" Where="ParentID == null" />
