<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SortCategory.ascx.cs"
    Inherits="AriaDevExpress.Web.UserControls.OneTouchAway.Sort" %>
<style>
    body
    {
        font-size: 13px;
...
<asp:LinqDataSource ID="CategoryLinqDataSource" runat="server" ContextTypeName="AriaDevExpress.Module.OneTouchAwayDataContext.OTAWAYAriaOnlineDataContext" EntityTypeName="" Select="new (Category_ID, Category_Desc)" TableName="OTAWAYCategories" />
<asp:LinqDataSource ID="NonSelectedLinqDataSource" OnSelecting="NonSelectedLinqDataSource_Selecting" runat="server" ContextTypeName="AriaDevExpress.Module.OneTouchAwayDataContext.OTAWAYAriaOnlineDataContext" EntityTypeName="" OrderBy="VisibleRank" Select="new (Article_ID, VisibleRank, Title)" TableName="OTAWAYArticles" Where="Category_ID == null">
    <WhereParameters>
        <asp:ControlParameter ControlID="CategoryDropDownList" Name="Category_ID" PropertyName="SelectedItem.Value" Type="Int32" />
    </WhereParameters>
</asp:LinqDataSource>
<asp:LinqDataSource ID="SelectedLinqDataSource" runat="server" ContextTypeName="AriaDevExpress.Module.OneTouchAwayDataContext.OTAWAYAriaOnlineDataContext" EntityTypeName="" OrderBy="VisibleRank" Select="new (Article_ID, VisibleRank, Title)" TableName="OTAWAYArticles" Where="Category_ID == Convert.ToInt32(@Category_ID)">
    <WhereParameters>
        <asp:ControlParameter ControlID="CategoryDropDownList" Name="Category_ID" PropertyName="SelectedItem.Value" Type="Int32" />
    </WhereParameters>
</asp:LinqDataSource>
