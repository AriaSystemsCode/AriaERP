<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SortAppModule.ascx.cs" Inherits="AriaDevExpress.Web.UserControls.OneTouchAway.SortAppModule" %>
...
<asp:LinqDataSource ID="ApplicationsDataSource" runat="server" ContextTypeName="AriaDevExpress.Module.OneTouchAwayDataContext.OTAWAYAriaOnlineDataContext" EntityTypeName="" Select="new (AppModID, ShortDesc, ToolTip)" TableName="OTAWAYApplicationModules" Where="ParentID == null">
</asp:LinqDataSource>
<asp:LinqDataSource ID="SelectedDataSource" runat="server" ContextTypeName="AriaDevExpress.Module.OneTouchAwayDataContext.OTAWAYAriaOnlineDataContext" EntityTypeName="" OrderBy="AppRank" Select="new (AppModID, ShortDesc, ToolTip)" TableName="OTAWAYApplicationModules" Where="ParentID ==  Convert.ToInt32(@ParentID)">
    <WhereParameters>
        <asp:ControlParameter ControlID="ddlApplicationModule" PropertyName="SelectedItem.Value" Name="ParentID" Type="Int32" />
    </WhereParameters>
</asp:LinqDataSource>
<asp:LinqDataSource ID="AllModuleDataSource" runat="server" ContextTypeName="AriaDevExpress.Module.OneTouchAwayDataContext.OTAWAYAriaOnlineDataContext" EntityTypeName="" Select="new (AppModID, ShortDesc, ToolTip)" TableName="OTAWAYApplicationModules" Where="ParentID != Convert.ToInt32(@ParentID) || ParentID == null" OnSelecting="AllModuleDataSource_Selecting">
    <WhereParameters>
        <asp:ControlParameter ControlID="ddlApplicationModule" PropertyName="SelectedItem.Value" Name="ParentID" Type="Int32" />
    </WhereParameters>
</asp:LinqDataSource>
