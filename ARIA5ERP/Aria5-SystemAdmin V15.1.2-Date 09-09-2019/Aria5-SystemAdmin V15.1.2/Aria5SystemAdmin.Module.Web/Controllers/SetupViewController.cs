...
//       {
//           int Count = ((DevExpress.Web.ASPxGridView)(((ListView)View).Editor.Control)).Columns.Count;

//           ((DevExpress.Web.ASPxGridView)(((ListView)View).Editor.Control)).Columns[Count-2].Visible = false;
...
//       {
//           ((DevExpress.Web.ASPxGridView)(((ListView)View).Editor.Control)).Init += new EventHandler(SetupViewController_Init);

//           ((DevExpress.Web.ASPxGridView)(((ListView)View).Editor.Control)).ClientSideEvents.Init = "function(s,e){s.RowClick.ClearHandlers();}";
//       }
