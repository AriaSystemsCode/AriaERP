...
{
    public partial class SortCategoryWindow : WindowController
    {
        ...
        private static Type nonPersistentObjectType = typeof(SortCategory);
        public SortCategoryWindow()
        {
            TargetWindowType = WindowType.Main;
            showCustomFormActionCore = new SingleChoiceAction(this, "Show FormSortCategory", PredefinedCategory.View);
