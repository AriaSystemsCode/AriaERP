...
{
    public partial class Applications : WindowController
    {
        ...
        private static Type nonPersistentObjectType = typeof(MR_Application);
        public Applications()
        {
            TargetWindowType = WindowType.Main;
            showCustomFormActionCore = new SingleChoiceAction(this, "Show Formmmmmm", PredefinedCategory.View);
