...
{
    public partial class EmailSettingWindow : WindowController
    {
        ...
        private static Type nonPersistentObjectType = typeof(EmailSettingClass);
        public EmailSettingWindow()
        {
            TargetWindowType = WindowType.Main;
            showCustomFormActionCore = new SingleChoiceAction(this, "Show Formm", PredefinedCategory.View);
