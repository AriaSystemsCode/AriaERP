...
{
    public partial class RsortApplications : WindowController
    {
        ...
        private static Type nonPersistentObjectType = typeof(SortApp);
        public RsortApplications()
        {
            TargetWindowType = WindowType.Main;
            showCustomFormActionCore = new SingleChoiceAction(this, "Show FormApplications", PredefinedCategory.View);
