...
{
    public partial class OTAWAYEmailSettingWindow : WindowController
    {
        ...
        private static Type nonPersistentObjectType = typeof(OTAWAYEmailSettingClass);
        public OTAWAYEmailSettingWindow()
        {
            TargetWindowType = WindowType.Main;
            showCustomFormActionCore = new SingleChoiceAction(this, "OTAWAYShow Formm", PredefinedCategory.View);
