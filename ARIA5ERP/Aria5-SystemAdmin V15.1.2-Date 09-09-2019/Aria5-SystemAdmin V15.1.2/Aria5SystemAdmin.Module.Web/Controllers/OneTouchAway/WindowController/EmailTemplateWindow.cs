...
{
    public partial class OTAWAYEmailTemplateWindow : WindowController
    {
        ...
        private static Type nonPersistentObjectType = typeof(OTAWAYEmailTemplateClass);
        public OTAWAYEmailTemplateWindow()
        {
            TargetWindowType = WindowType.Main;
            showCustomFormActionCore = new SingleChoiceAction(this, "OTAWAYShow Form", PredefinedCategory.View);
