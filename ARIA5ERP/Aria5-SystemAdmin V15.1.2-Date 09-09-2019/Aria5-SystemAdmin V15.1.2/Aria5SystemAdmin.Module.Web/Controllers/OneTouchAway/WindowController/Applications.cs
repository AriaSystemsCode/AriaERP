...
{
    public partial class OTAWAYApplications : WindowController
    {
        ...
        private static Type nonPersistentObjectType = typeof(OTAWAYMR_Application);
        public OTAWAYApplications()
        {
            TargetWindowType = WindowType.Main;
            showCustomFormActionCore = new SingleChoiceAction(this, "OTAWAYShow Formmmmmm", PredefinedCategory.View);
