...
{
    public partial class OTAWAYSortCategoryWindow : WindowController
    {
        ...
        private static Type nonPersistentObjectType = typeof(OTAWAYSortCategory);
        public OTAWAYSortCategoryWindow()
        {
            TargetWindowType = WindowType.Main;
            showCustomFormActionCore = new SingleChoiceAction(this, "OTAWAYShow FormSortCategory", PredefinedCategory.View);
