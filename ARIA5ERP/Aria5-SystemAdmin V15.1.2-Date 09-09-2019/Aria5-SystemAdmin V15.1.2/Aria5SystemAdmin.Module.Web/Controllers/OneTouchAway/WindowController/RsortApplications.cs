...
{
    public partial class OTAWAYRsortApplications : WindowController
    {
        ...
        private static Type nonPersistentObjectType = typeof(OTAWAYSortApp);
        public OTAWAYRsortApplications()
        {
            TargetWindowType = WindowType.Main;
            showCustomFormActionCore = new SingleChoiceAction(this, "OTAWAYShow FormApplications", PredefinedCategory.View);
        ...
        private void PopulateSingleChoiceActionItemsFrom(SingleChoiceAction sourceSingleChoiceAction)
        {
            ...
            if (sourceSingleChoiceAction.Items.Count > 0)
            {
                ...
                {
                    if (sourceItem.Data != null && ((ViewShortcut)sourceItem.Data).ViewId == nonPersistentObjectType.Name + "_DetailView")
                    {
        ...
        public virtual void ShowCustomNonModalForm()
        {
        }
        public virtual void ShowCustomModalForm()
        {
        }
    }
}
